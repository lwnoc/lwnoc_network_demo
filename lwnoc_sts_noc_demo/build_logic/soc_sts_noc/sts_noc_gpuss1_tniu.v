//[UHDL]Content Start [md5:2f8ba87c4753a377d86daeafb941e7db]
module sts_noc_gpuss1_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_gpu_ss1_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_gpu_ss1_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:2f8ba87c4753a377d86daeafb941e7db]
