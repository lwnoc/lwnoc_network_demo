//[UHDL]Content Start [md5:4da07f4d94d6742872e237e3a11b4a68]
module sts_noc_camera_ss_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_camera_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_camera_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:4da07f4d94d6742872e237e3a11b4a68]
