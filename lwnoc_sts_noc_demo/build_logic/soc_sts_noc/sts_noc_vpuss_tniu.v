//[UHDL]Content Start [md5:0e569615fd6a97128a668ae1db5b8489]
module sts_noc_vpuss_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_vpu_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_vpu_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:0e569615fd6a97128a668ae1db5b8489]
