module soc_sts_iniu_soc_sts_iniu_wrap
    import soc_sts_iniu_lwnoc_sts_pack::*;
#(
    parameter int unsigned SOC_STS_NODE_NUM = 2,
    parameter int unsigned SOC_STS_ADDR_MAP_ENTRY_NUM = 48,
    parameter logic [SOC_STS_ADDR_MAP_ENTRY_NUM*AXI_ADDR_WIDTH-1:0] SOC_STS_ADDR_MAP_BASE_TABLE = '0,
    parameter logic [SOC_STS_ADDR_MAP_ENTRY_NUM*AXI_ADDR_WIDTH-1:0] SOC_STS_ADDR_MAP_MASK_TABLE = '0,
    parameter logic [SOC_STS_ADDR_MAP_ENTRY_NUM*TGT_ID_WIDTH-1:0] SOC_STS_ADDR_MAP_TGT_ID_TABLE = '0,
    parameter logic [TGT_ID_WIDTH-1:0] SOC_STS_ADDR_MAP_DEFAULT_TGT_ID = '1
)
(
    input   logic                       clk_src,
    input   logic                       clk_dst,
    ...
    soc_sts_iniu_sts_iniu_top #(
        .NODE_NUM                (SOC_STS_NODE_NUM),
        .ADDR_MAP_ENTRY_NUM      (SOC_STS_ADDR_MAP_ENTRY_NUM),
        .ADDR_MAP_BASE_TABLE     (SOC_STS_ADDR_MAP_BASE_TABLE),
        .ADDR_MAP_MASK_TABLE     (SOC_STS_ADDR_MAP_MASK_TABLE),
        .ADDR_MAP_TGT_ID_TABLE   (SOC_STS_ADDR_MAP_TGT_ID_TABLE),
        .ADDR_MAP_DEFAULT_TGT_ID (SOC_STS_ADDR_MAP_DEFAULT_TGT_ID)
    ) u_sts_iniu_top (
        .clk_src             (clk_src),
        .clk_dst             (clk_dst),
        .rstn_src            (rstn_src),
