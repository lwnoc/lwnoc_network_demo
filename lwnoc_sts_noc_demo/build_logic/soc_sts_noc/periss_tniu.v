//[UHDL]Content Start [md5:09b3fec035388676b49782537bcc48f0]
module periss_tniu (
	input          clk_src                                        ,
	input          rstn_src                                       ,
	input          clk_dst                                        ,
	...
	//module inst.
	peri_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
		...
		.hw_dbg_sel_in(),
		.hw_dbg_sel_out());
	peri_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:09b3fec035388676b49782537bcc48f0]
