module soc_sts_tniu1_soc_sts_tniu1_wrap
    import soc_sts_tniu1_lwnoc_sts_pack::*;
#(
    parameter int unsigned SOC_STS_APB_ADDR_WIDTH = 32,
    parameter logic [TGT_ID_WIDTH-1:0] SOC_STS_LOCAL_RSC_TGT_ID = '0,
    parameter logic [TGT_ID_WIDTH-1:0] SOC_STS_LOCAL_REGBANK_TGT_ID = '0,
    parameter int unsigned SOC_STS_SYS_APB_MASTER_NUM = 10,
    parameter logic [SOC_STS_SYS_APB_MASTER_NUM*TGT_ID_WIDTH-1:0] SOC_STS_SYS_APB_ROUTE_BASE = '0,
    parameter logic [SOC_STS_SYS_APB_MASTER_NUM*TGT_ID_WIDTH-1:0] SOC_STS_SYS_APB_ROUTE_MASK = '0
)
(
    input   logic                    clk_src,
    input   logic                    clk_dst,
    ...
    soc_sts_tniu1_sts_tniu_top #(
        .DBG_DATA_WIDTH        (32),
        .DBG_TIMESTAMP_WIDTH   (64),
        .APB_ADDR_WIDTH        (SOC_STS_APB_ADDR_WIDTH),
        .LOCAL_RSC_TGT_ID      (SOC_STS_LOCAL_RSC_TGT_ID),
        .LOCAL_REGBANK_TGT_ID  (SOC_STS_LOCAL_REGBANK_TGT_ID),
        .SYS_APB_MASTER_NUM    (SOC_STS_SYS_APB_MASTER_NUM),
        .SYS_APB_ROUTE_BASE    (SOC_STS_SYS_APB_ROUTE_BASE),
        .SYS_APB_ROUTE_MASK    (SOC_STS_SYS_APB_ROUTE_MASK)
    ) u_sts_tniu_top (
        .clk_src            (clk_dst),
        .clk_dst            (clk_src),
