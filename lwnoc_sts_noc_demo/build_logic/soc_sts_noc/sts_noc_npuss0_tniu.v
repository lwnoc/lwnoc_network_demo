//[UHDL]Content Start [md5:c2b2eba16df06fb0dc0e91d25944b5d0]
module sts_noc_npuss0_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_npu_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_npu_ss0_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:c2b2eba16df06fb0dc0e91d25944b5d0]
