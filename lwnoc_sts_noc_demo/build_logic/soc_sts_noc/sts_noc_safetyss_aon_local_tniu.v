//[UHDL]Content Start [md5:ff0e20ab4a97e80afde3e84370d6eb8e]
module sts_noc_safetyss_aon_local_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_aon_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_aon_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:ff0e20ab4a97e80afde3e84370d6eb8e]
