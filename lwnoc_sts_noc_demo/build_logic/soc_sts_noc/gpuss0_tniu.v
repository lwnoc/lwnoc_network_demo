//[UHDL]Content Start [md5:7d0a2ad64d44500580a501e1b9a862de]
module gpuss0_tniu (
	input          clk_src                                        ,
	input          rstn_src                                       ,
	input          clk_dst                                        ,
	...
	//module inst.
	gpu_ss0_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
		...
		.hw_dbg_sel_in(),
		.hw_dbg_sel_out());
	gpu_ss0_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:7d0a2ad64d44500580a501e1b9a862de]
