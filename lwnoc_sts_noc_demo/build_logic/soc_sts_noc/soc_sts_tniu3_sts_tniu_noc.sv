module soc_sts_tniu3_sts_tniu_noc
import soc_sts_tniu3_lwnoc_sts_pack::*;
#(
    ...
    soc_sts_tniu3_sts_tniu_noc_dec2 #(
        .WIDTH(REQ_PLD_WIDTH)
    ) u_tniu_noc_req_dec2 (
    ...
    soc_sts_tniu3_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    soc_sts_tniu3_sts_tniu_apb_dec #(
    ...
    soc_sts_tniu3_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
