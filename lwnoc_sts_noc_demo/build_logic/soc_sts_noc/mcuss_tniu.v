//[UHDL]Content Start [md5:92f2bfb957d90f9289b990422df67d48]
module mcuss_tniu (
	input          clk_src                                        ,
	input          rstn_src                                       ,
	input          clk_dst                                        ,
	...
	//module inst.
	mcu_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
		...
		.hw_dbg_sel_in(),
		.hw_dbg_sel_out());
	mcu_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:92f2bfb957d90f9289b990422df67d48]
