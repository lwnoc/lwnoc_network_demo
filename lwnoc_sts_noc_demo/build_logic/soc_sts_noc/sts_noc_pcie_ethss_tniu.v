//[UHDL]Content Start [md5:20ca8863cfa6e1fea8daadc26a50ff57]
module sts_noc_pcie_ethss_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_pcie_eth_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_pcie_eth_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:20ca8863cfa6e1fea8daadc26a50ff57]
