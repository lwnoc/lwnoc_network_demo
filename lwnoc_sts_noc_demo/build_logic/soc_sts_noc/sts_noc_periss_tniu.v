//[UHDL]Content Start [md5:a4220635991cc3a0f9ebbbe70e8044f1]
module sts_noc_periss_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_peri_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_peri_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:a4220635991cc3a0f9ebbbe70e8044f1]
