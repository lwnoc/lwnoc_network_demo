//[UHDL]Content Start [md5:92dac69ac92aab2a0bbd4d15d6d41426]
module npuss4_tniu (
	input          clk_src                                        ,
	input          rstn_src                                       ,
	input          clk_dst                                        ,
	...
	//module inst.
	npu_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
		...
		.hw_dbg_sel_in(),
		.hw_dbg_sel_out());
	npu_ss4_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:92dac69ac92aab2a0bbd4d15d6d41426]
