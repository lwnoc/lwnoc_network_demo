//[UHDL]Content Start [md5:7d5dde237f609485ecb77d15ac7e51a9]
module sts_noc_usb_dpss_tniu (
	input          clk_src                                                ,
	input          rstn_src                                               ,
	input          clk_dst                                                ,
	input          rstn_dst                                               ,
	...
	//module inst.
	sts_noc_usb_dpss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
	...
	sts_noc_usb_dpss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:7d5dde237f609485ecb77d15ac7e51a9]
