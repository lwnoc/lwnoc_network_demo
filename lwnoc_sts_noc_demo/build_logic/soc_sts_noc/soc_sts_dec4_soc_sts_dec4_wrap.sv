module soc_sts_dec4_soc_sts_dec4_wrap
    import soc_sts_dec4_lwnoc_sts_pack::*;
#(
    parameter int unsigned SOC_STS_DEC_SLAVE_NUM = 4,
    parameter logic [SOC_STS_DEC_SLAVE_NUM*TGT_ID_WIDTH-1:0] SOC_STS_ROUTE_BASE = '0,
    parameter logic [SOC_STS_DEC_SLAVE_NUM*TGT_ID_WIDTH-1:0] SOC_STS_ROUTE_MASK = '0,
    parameter int unsigned SOC_STS_DBG_TIMESTAMP_WIDTH = 1,
    parameter int unsigned SOC_STS_DBG_DATA_WIDTH = 1
)
(
    input   logic       clk,
    input   logic       rst_n,
    ...
    soc_sts_dec4_sts_noc_dec_node #(
        .SLAVE_NUM           (SOC_STS_DEC_SLAVE_NUM),
        .ROUTE_BASE          (SOC_STS_ROUTE_BASE),
        .ROUTE_MASK          (SOC_STS_ROUTE_MASK),
        .DBG_TIMESTAMP_WIDTH (SOC_STS_DBG_TIMESTAMP_WIDTH),
        .DBG_DATA_WIDTH      (SOC_STS_DBG_DATA_WIDTH)
    ) u_sts_noc_dec_node (
        .clk                (clk),
        .rst_n              (rst_n),
