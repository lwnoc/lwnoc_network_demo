//[UHDL]Content Start [md5:15695890397439a9eec02aa58fdb072e]
module cpuss_tniu (
	input          clk_src                                        ,
	input          rstn_src                                       ,
	input          clk_dst                                        ,
	...
	//module inst.
	cpu_ss_tniu_sts_tniu_sys sys_side (
		.clk_dst(clk_dst),
		...
		.hw_dbg_sel_in(),
		.hw_dbg_sel_out());
	cpu_ss_tniu_sts_tniu_noc noc_side (
		.clk_src(clk_src),
		.rstn_src(rstn_src),
...
//[UHDL]Content End [md5:15695890397439a9eec02aa58fdb072e]
