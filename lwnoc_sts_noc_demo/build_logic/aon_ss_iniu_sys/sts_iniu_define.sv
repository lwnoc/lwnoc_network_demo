...
`ifndef STS_INIU_REQ_FIFO_DEPTH
    `define STS_INIU_REQ_FIFO_DEPTH 4
`endif
`ifndef STS_INIU_RSP_FIFO_DEPTH
    `define STS_INIU_RSP_FIFO_DEPTH 4
`endif
...
`endif
`ifndef STS_INIU_ADDR_MAP_START_TABLE
    `define STS_INIU_ADDR_MAP_START_TABLE '0
`endif
`ifndef STS_INIU_ADDR_MAP_END_TABLE
    `define STS_INIU_ADDR_MAP_END_TABLE '0
`endif
...
`endif
`ifndef STS_INIU_ADDR_MASK_BITS
    `define STS_INIU_ADDR_MASK_BITS 1
`endif

`ifndef STS_RESERVE_WIDTH
