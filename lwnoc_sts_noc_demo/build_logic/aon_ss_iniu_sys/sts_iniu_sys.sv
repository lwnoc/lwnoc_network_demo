...
#(
    ...
    parameter logic [ADDR_MAP_ENTRY_NUM*AXI_ADDR_WIDTH-1:0] ADDR_MAP_BASE_TABLE = `STS_INIU_ADDR_MAP_BASE_TABLE,
    parameter logic [ADDR_MAP_ENTRY_NUM*AXI_ADDR_WIDTH-1:0] ADDR_MAP_MASK_TABLE = `STS_INIU_ADDR_MAP_MASK_TABLE,
