...
#(
    ...
    parameter integer unsigned NODE_NUM            = `STS_INIU_NODE_NUM,
    parameter integer unsigned SAFETY_TIMEOUT_CYCLES = `STS_INIU_SAFETY_TIMEOUT_CYCLES,
    parameter integer unsigned ADDR_MAP_ENTRY_NUM  = `STS_INIU_ADDR_MAP_ENTRY_NUM,
    parameter logic [ADDR_MAP_ENTRY_NUM*AXI_ADDR_WIDTH-1:0] ADDR_MAP_START_TABLE = `STS_INIU_ADDR_MAP_START_TABLE,
    parameter logic [ADDR_MAP_ENTRY_NUM*AXI_ADDR_WIDTH-1:0] ADDR_MAP_END_TABLE   = `STS_INIU_ADDR_MAP_END_TABLE,
    parameter logic [ADDR_MAP_ENTRY_NUM*TGT_ID_WIDTH-1:0]   ADDR_MAP_TGT_ID_TABLE = `STS_INIU_ADDR_MAP_TGT_ID_TABLE,
    parameter logic [TGT_ID_WIDTH-1:0]                      ADDR_MAP_DEFAULT_TGT_ID = `STS_INIU_ADDR_MAP_DEFAULT_TGT_ID,
