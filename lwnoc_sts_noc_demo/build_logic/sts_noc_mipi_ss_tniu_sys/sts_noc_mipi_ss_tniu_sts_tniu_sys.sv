module sts_noc_mipi_ss_tniu_sts_tniu_sys
...
#(
    ...
    sts_noc_mipi_ss_tniu_RegSpaceBase_cfg_reg_bank_table_sys u_regbank_sts_tniu_sys (
        .clk                      (clk_dst                     ),
        .rst_n                    (rstn_dst                    ),
    ...
    sts_noc_mipi_ss_tniu_sts_tniu_apb u_sts_tniu_sys_reg_apb (
        .clk            (clk_dst          ),
        .rst_n          (rstn_dst         ),
    ...
    sts_noc_mipi_ss_tniu_sts_tniu_apb u_sts_tniu_sys_ext_apb (
        .clk            (clk_dst          ),
        .rst_n          (rstn_dst         ),
