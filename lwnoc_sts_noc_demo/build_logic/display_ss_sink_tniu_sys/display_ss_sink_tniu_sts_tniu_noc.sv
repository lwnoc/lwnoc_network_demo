module display_ss_sink_tniu_sts_tniu_noc
...
#(
    ...
    display_ss_sink_tniu_sts_tniu_noc_dec2 #(
        .WIDTH(REQ_PLD_WIDTH)
    ) u_tniu_noc_req_dec2 (
    ...
    display_ss_sink_tniu_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    display_ss_sink_tniu_sts_tniu_apb_dec #(
    ...
    display_ss_sink_tniu_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
    ...
    display_ss_sink_tniu_cti_handle #(
        .SYNC_STAGE(SYNC_STAGE)
