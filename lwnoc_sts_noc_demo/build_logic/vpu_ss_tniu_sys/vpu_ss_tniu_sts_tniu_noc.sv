module vpu_ss_tniu_sts_tniu_noc
import vpu_ss_tniu_lwnoc_sts_pack::*;
#(
    ...
    vpu_ss_tniu_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    vpu_ss_tniu_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
