...
`define STS_TNIU_LOCAL_CTI_TGT_ID 9'hCF
`define STS_TNIU_LOCAL_REGBANK_TGT_ID 9'h8F
`define STS_TNIU_LOCAL_RSC_TGT_ID 9'h8F
...
`define STS_TNIU_SYS_APB_ROUTE_BASE 9'hF
