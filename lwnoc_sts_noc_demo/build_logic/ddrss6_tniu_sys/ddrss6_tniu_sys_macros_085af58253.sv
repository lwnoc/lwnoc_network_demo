...
`define STS_TNIU_LOCAL_CTI_TGT_ID 9'hD1
`define STS_TNIU_LOCAL_REGBANK_TGT_ID 9'h91
`define STS_TNIU_LOCAL_RSC_TGT_ID 9'h91
...
`define STS_TNIU_SYS_APB_ROUTE_BASE 9'h11
