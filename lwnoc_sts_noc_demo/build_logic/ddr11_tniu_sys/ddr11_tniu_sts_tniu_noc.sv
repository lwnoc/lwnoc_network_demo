module ddr11_tniu_sts_tniu_noc
import ddr11_tniu_lwnoc_sts_pack::*;
#(
    ...
    ddr11_tniu_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    ddr11_tniu_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
