module camera_ss_tniu_sts_tniu_noc
import camera_ss_tniu_lwnoc_sts_pack::*;
#(
    ...
    camera_ss_tniu_sts_tniu_noc_dec2 #(
        .WIDTH(REQ_PLD_WIDTH)
    ) u_tniu_noc_req_dec2 (
    ...
    camera_ss_tniu_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    camera_ss_tniu_sts_tniu_apb_dec #(
    ...
    camera_ss_tniu_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
