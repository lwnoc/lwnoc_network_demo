module sts_demo_tniu2_sts_tniu_noc
...
#(
    ...
    sts_demo_tniu2_sts_tniu_noc_dec2 #(
        .WIDTH(REQ_PLD_WIDTH)
    ) u_tniu_noc_req_dec2 (
    ...
    sts_demo_tniu2_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    sts_demo_tniu2_sts_tniu_apb_dec #(
    ...
    sts_demo_tniu2_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
