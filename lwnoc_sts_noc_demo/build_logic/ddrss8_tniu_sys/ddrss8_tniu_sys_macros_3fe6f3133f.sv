...
`define STS_AXI_BID_WIDTH 8
`define STS_AXI_DATA_WIDTH 32
`define STS_AXI_RID_WIDTH 8
`define STS_AXI_SIZE_WIDTH 3
`define STS_AXI_STRB_WIDTH 4
...
`define STS_TNIU_LOCAL_CTI_TGT_ID 9'hD3
`define STS_TNIU_LOCAL_REGBANK_TGT_ID 9'h93
`define STS_TNIU_LOCAL_RSC_TGT_ID 9'h93
`define STS_TNIU_REQ_FIFO_DEPTH 16
`define STS_TNIU_RSP_FIFO_DEPTH 16
`define STS_TNIU_SYNC_STAGE 2
`define STS_TNIU_SYS_APB_MASTER_NUM 1
`define STS_TNIU_SYS_APB_ROUTE_BASE 9'h13
`define STS_TNIU_SYS_APB_ROUTE_MASK 9'h1FF
