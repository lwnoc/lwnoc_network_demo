module sts_noc_ddr_ss_tniu_sts_tniu_sys
import sts_noc_ddr_ss_tniu_lwnoc_sts_pack::*;
#(
    parameter integer unsigned DBG_TIMESTAMP_WIDTH = `sts_noc_ddr_ss_tniu_STS_TNIU_DBG_TIMESTAMP_WIDTH,
    parameter integer unsigned DBG_DATA_WIDTH      = `sts_noc_ddr_ss_tniu_STS_TNIU_DBG_DATA_WIDTH,
    parameter integer unsigned APB_ADDR_WIDTH      = `sts_noc_ddr_ss_tniu_STS_TNIU_APB_ADDR_WIDTH,
    parameter integer unsigned SYNC_STAGE           = `sts_noc_ddr_ss_tniu_STS_TNIU_SYNC_STAGE,
    parameter integer unsigned ASYNC_FIFO_DEPTH     = `sts_noc_ddr_ss_tniu_STS_TNIU_ASYNC_FIFO_DEPTH,
    parameter integer unsigned  ERR_INT_CNT_WIDTH = `sts_noc_ddr_ss_tniu_STS_TNIU_ERR_INT_CNT_WIDTH,
    ...
    sts_noc_ddr_ss_tniu_RegSpaceBase_cfg_reg_bank_table_sys u_regbank_sts_tniu_sys (
        .clk                      (clk_dst                     ),
        .rst_n                    (rstn_dst                    ),
    ...
    sts_noc_ddr_ss_tniu_sts_tniu_apb u_sts_tniu_sys_reg_apb (
        .clk            (clk_dst          ),
        .rst_n          (rstn_dst         ),
    ...
    sts_noc_ddr_ss_tniu_sts_tniu_apb u_sts_tniu_sys_ext_apb (
        .clk            (clk_dst          ),
        .rst_n          (rstn_dst         ),
