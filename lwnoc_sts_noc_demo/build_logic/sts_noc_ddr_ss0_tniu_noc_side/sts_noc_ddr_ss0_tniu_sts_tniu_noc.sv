module sts_noc_ddr_ss0_tniu_sts_tniu_noc
import sts_noc_ddr_ss0_tniu_lwnoc_sts_pack::*;
#(
    parameter integer unsigned DBG_TIMESTAMP_WIDTH  = `sts_noc_ddr_ss0_tniu_STS_TNIU_DBG_TIMESTAMP_WIDTH,
    parameter integer unsigned DBG_DATA_WIDTH       = `sts_noc_ddr_ss0_tniu_STS_TNIU_DBG_DATA_WIDTH,
    parameter integer unsigned APB_ADDR_WIDTH       = `sts_noc_ddr_ss0_tniu_STS_TNIU_APB_ADDR_WIDTH,
    parameter integer unsigned SYNC_STAGE           = `sts_noc_ddr_ss0_tniu_STS_TNIU_SYNC_STAGE,
    parameter integer unsigned ASYNC_FIFO_DEPTH     = `sts_noc_ddr_ss0_tniu_STS_TNIU_ASYNC_FIFO_DEPTH,
    parameter integer unsigned FIFO_DEPTH           = `sts_noc_ddr_ss0_tniu_STS_TNIU_FIFO_DEPTH,
    parameter integer unsigned TGT_TYPE_WIDTH       = `sts_noc_ddr_ss0_tniu_STS_TNIU_TGT_TYPE_WIDTH,
    parameter logic [TGT_TYPE_WIDTH-1:0] LOCAL_APB_TGT_TYPE = `sts_noc_ddr_ss0_tniu_STS_TNIU_LOCAL_APB_TGT_TYPE,
    parameter logic [TGT_ID_WIDTH-1:0]   LOCAL_INIU_CTI_TGT_ID = `sts_noc_ddr_ss0_tniu_STS_TNIU_LOCAL_INIU_CTI_TGT_ID,
    parameter logic [TGT_ID_WIDTH-1:0]   LOCAL_INIU_CTI_TGT_MASK = `sts_noc_ddr_ss0_tniu_STS_TNIU_LOCAL_INIU_CTI_TGT_MASK,
    parameter logic [TGT_ID_WIDTH-1:0]   LOCAL_REGBANK_TGT_ID = `sts_noc_ddr_ss0_tniu_STS_TNIU_LOCAL_REGBANK_TGT_ID,
    parameter logic [TGT_ID_WIDTH-1:0]   LOCAL_REGBANK_TGT_MASK = `sts_noc_ddr_ss0_tniu_STS_TNIU_LOCAL_REGBANK_TGT_MASK,
    parameter logic [TGT_ID_WIDTH-1:0]   LOCAL_CTI_TGT_ID = `sts_noc_ddr_ss0_tniu_STS_TNIU_LOCAL_CTI_TGT_ID,
    parameter logic [TGT_ID_WIDTH-1:0]   LOCAL_CTI_TGT_MASK = `sts_noc_ddr_ss0_tniu_STS_TNIU_LOCAL_CTI_TGT_MASK,
    parameter logic                      HAS_INIU_CTI_APB   = `sts_noc_ddr_ss0_tniu_STS_TNIU_HAS_INIU_CTI_APB,
    parameter integer unsigned  ERR_INT_CNT_WIDTH = `sts_noc_ddr_ss0_tniu_STS_TNIU_ERR_INT_CNT_WIDTH,
    ...
    sts_noc_ddr_ss0_tniu_sts_tniu_noc_dec2 #(
        .WIDTH(REQ_PLD_WIDTH)
    ) u_tniu_noc_req_dec2 (
    ...
    sts_noc_ddr_ss0_tniu_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    sts_noc_ddr_ss0_tniu_sts_tniu_apb_dec #(
    ...
    sts_noc_ddr_ss0_tniu_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
