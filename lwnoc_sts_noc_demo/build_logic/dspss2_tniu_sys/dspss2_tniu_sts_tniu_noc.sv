module dspss2_tniu_sts_tniu_noc
import dspss2_tniu_lwnoc_sts_pack::*;
#(
    ...
    dspss2_tniu_sts_tniu_apb u_sts_tniu_apb_noc (
        .clk        (clk_src),
        .rst_n      (rstn_src),
    ...
    dspss2_tniu_RegSpaceBase_cfg_reg_bank_table u_regbank_sts_tniu (
        .clk            (clk_src        ),
        .rst_n          (rstn_src       ),
