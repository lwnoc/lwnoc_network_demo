module dspss_tniu_sts_tniu_sys
import dspss_tniu_lwnoc_sts_pack::*;
#(
    ...
    dspss_tniu_sts_tniu_apb u_sts_tniu_apb_sys (
        .clk            (clk_dst          ),
        .rst_n          (rstn_dst         ),
