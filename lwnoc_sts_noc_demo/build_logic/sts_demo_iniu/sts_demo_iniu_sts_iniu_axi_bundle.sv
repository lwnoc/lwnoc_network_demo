module sts_demo_iniu_sts_iniu_axi_bundle
...
(
    ...
    output wire sts_iniu_axi_aw_chnl        m_aw_pld,

    output  logic                           m_w_vld ,
    input   logic                           m_w_rdy ,
    output wire sts_iniu_axi_w_chnl         m_w_pld ,
    ...
    output wire sts_iniu_axi_ar_chnl        m_ar_pld,
...
assign m_aw_pld.awprot  = s_awprot  ;
...
assign m_ar_pld.arprot  = s_arprot  ;
assign m_ar_pld.arqos   = s_arqos   ;
assign m_ar_pld.aruser  = s_aruser  ;

assign s_rvalid         = m_r_vld;
assign m_r_rdy          = s_rready;
assign s_rid            = m_r_pld.rid    ;
assign s_rdata          = m_r_pld.rdata  ;
assign s_rresp          = m_r_pld.rresp  ;
assign s_rlast          = m_r_pld.rlast  ;
