...
localparam integer unsigned CTM_TRIG_WIDTH   = `STS_CTM_TRIG_WIDTH;
localparam integer unsigned CHANNEL_TOTAL_WIDTH = CTI_CHANNEL_WIDTH + CTM_TRIG_WIDTH;

localparam integer unsigned RESERVE_WIDTH = `STS_RESERVE_WIDTH;
