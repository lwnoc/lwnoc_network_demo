module sts_demo_tniu0_sts_demo_tniu0_wrap
...
(
    ...
    localparam logic [`sts_demo_tniu0_STS_DEMO_SYS_APB_MASTER_NUM*TGT_ID_WIDTH-1:0] SYS_APB_ROUTE_BASE = `sts_demo_tniu0_STS_DEMO_SYS_APB_ROUTE_BASE;
    localparam logic [`sts_demo_tniu0_STS_DEMO_SYS_APB_MASTER_NUM*TGT_ID_WIDTH-1:0] SYS_APB_ROUTE_MASK = `sts_demo_tniu0_STS_DEMO_SYS_APB_ROUTE_MASK;

    sts_demo_tniu0_sts_tniu_top #(
        .APB_ADDR_WIDTH        (`sts_demo_tniu0_STS_DEMO_APB_ADDR_WIDTH),
        .LOCAL_RSC_TGT_ID      (`sts_demo_tniu0_STS_DEMO_LOCAL_RSC_TGT_ID),
        .LOCAL_REGBANK_TGT_ID  (`sts_demo_tniu0_STS_DEMO_LOCAL_REGBANK_TGT_ID),
        .SYS_APB_MASTER_NUM    (`sts_demo_tniu0_STS_DEMO_SYS_APB_MASTER_NUM),
