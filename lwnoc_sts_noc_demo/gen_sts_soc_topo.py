...
from _project_env import THIS_DIR

from StsSocTopo import STS_SOC_TOP_WRAP_ID, StsSocLogicTopo, StsSocTopWrapTopo
from StsTemplate import (
    STS_SOC_PUBLISH_ENV_DIRS,
)
...
def main():
    ...
    PUBLISH_FILELIST.write_text(
        ...
        f"-f {FILELIST_PREFIX}/{STS_SOC_TOP_WRAP_ID}/filelist.f\n"
    )
    ...
    print(f"Aggregation wrapper: {BUILD_DIR / STS_SOC_TOP_WRAP_ID}")
