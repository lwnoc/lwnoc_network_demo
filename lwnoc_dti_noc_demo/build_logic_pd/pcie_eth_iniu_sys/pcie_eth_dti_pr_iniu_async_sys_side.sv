module pcie_eth_dti_pr_iniu_async_sys_side
    ...
    lwnoc_pchannel_state_t pstate__typed;
    lwnoc_pchannel_active_t pactive__typed;
    lwnoc_lp_req_signal_t lp_hub_rx_req__typed;
    lwnoc_lp_req_signal_t lp_hub_tx_req__typed;

    assign pstate__typed = lwnoc_pchannel_state_t'(pstate);
    assign pactive = pactive__typed;
    ...
    assign v_stage_2_hub_rx_req[3]   = lp_hub_rx_req__typed;
    ...
    assign lp_hub_tx_req__typed             = v_stage_2_hub_tx_req[3];
    // lp iniu
    lwnoc_lp_iniu u_lwnoc_lp_iniu(
        ...
        .preq         (preq               ),
        .pstate__typed       (pstate__typed             ),
        .pactive__typed      (pactive__typed            ),
        .paccept      (paccept            ),
        .pdeny        (pdeny              )
    );
    // lp hub 3t
