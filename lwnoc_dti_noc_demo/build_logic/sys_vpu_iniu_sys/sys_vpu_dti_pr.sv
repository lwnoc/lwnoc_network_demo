...
#(
    ...
    logic [((TBU_NUM > 1) ? $clog2(TBU_NUM) : 1)-1:0] entry_reset_id;
    ...
    logic [((TBU_NUM > 1) ? $clog2(TBU_NUM) : 1)-1:0] allocate_id;
    logic                                allocate_vld        ;
    ...
    generate
        for (genvar i=0; i<TBU_NUM; i++) begin: rob_entry
            sys_vpu_dti_pr_rob_state_entry #(
                .TBU_NUM             (TBU_NUM             ),
