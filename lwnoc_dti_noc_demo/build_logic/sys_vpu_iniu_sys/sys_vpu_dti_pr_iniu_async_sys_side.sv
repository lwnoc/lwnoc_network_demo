module sys_vpu_dti_pr_iniu_async_sys_side
    import sys_vpu_lwnoc_lp_define_package::*;
    import sys_vpu_lwnoc_lp_struct_package::*;
    import sys_vpu_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `sys_vpu_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `sys_vpu_TRANSACTION_MAX_NUM,
