module sys_npu_dti_pr_iniu_async_sys_side
    import sys_npu_lwnoc_lp_define_package::*;
    import sys_npu_lwnoc_lp_struct_package::*;
    import sys_npu_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `sys_npu_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `sys_npu_TRANSACTION_MAX_NUM,
