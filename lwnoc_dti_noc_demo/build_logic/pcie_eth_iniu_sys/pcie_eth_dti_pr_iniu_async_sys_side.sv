module pcie_eth_dti_pr_iniu_async_sys_side
    ...
    #(
        ...
        localparam integer unsigned PSTATE_WIDTH = $bits(lwnoc_lp_define_package::lwnoc_pchannel_state_t),
        localparam integer unsigned PACTIVE_WIDTH = $bits(lwnoc_lp_define_package::lwnoc_pchannel_active_t),
    ...
    input  logic                                        preq                         ,
    input  logic    [PSTATE_WIDTH-1:0]                  pstate                       ,
    output logic    [PACTIVE_WIDTH-1:0]                 pactive                      ,
    ...
    typedef lwnoc_lp_define_package::lwnoc_pchannel_active_t lwnoc_pchannel_active_t;
    typedef lwnoc_lp_define_package::lwnoc_pchannel_state_t lwnoc_pchannel_state_t;
    typedef lwnoc_lp_struct_package::lwnoc_lp_req_signal_t lwnoc_lp_req_signal_t;

    lwnoc_pchannel_state_t                              pstate_t                     ;
    lwnoc_pchannel_active_t                             pactive_t                    ;
    ...
    assign pstate_t                = lwnoc_pchannel_state_t'(pstate);
    assign pactive                 = pactive_t;
    ...
    assign v_stage_2_hub_rx_req[3]   = lp_hub_rx_req_t;
    ...
    assign lp_hub_tx_req_t           = v_stage_2_hub_tx_req[3];
    // lp iniu
