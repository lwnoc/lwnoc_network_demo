module dti_sw_left3_dti_switch_3i1o_wrap (
    input   logic           clk,
    input   logic           rst_n,
    ...
    logic [2:0]        iniu_rsp_threshold_unused;
    ...
    dti_sw_left3_dti_noc_switch #(
        .NUM_INIU      (3),
        .NUM_TNIU      (1),
        .TID_WIDTH     (6),
        .PAYLOAD_WIDTH (90),
        .TNIU_DECMIN   ({32'd`dti_sw_left3_DTI_TNIU_MIN}),
        .TNIU_DECMAX   ({32'd`dti_sw_left3_DTI_TNIU_MAX}),
        .INIU_DECMIN   ({32'd`dti_sw_left3_DTI_INIU2_MIN, 32'd`dti_sw_left3_DTI_INIU1_MIN, 32'd`dti_sw_left3_DTI_INIU0_MIN}),
        .INIU_DECMAX   ({32'd`dti_sw_left3_DTI_INIU2_MAX, 32'd`dti_sw_left3_DTI_INIU1_MAX, 32'd`dti_sw_left3_DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
