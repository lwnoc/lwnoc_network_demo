module mipi0_dti_pr_iniu_async_sys_side
    import mipi0_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM = `mipi0_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM = `mipi0_TRANSACTION_MAX_NUM,
