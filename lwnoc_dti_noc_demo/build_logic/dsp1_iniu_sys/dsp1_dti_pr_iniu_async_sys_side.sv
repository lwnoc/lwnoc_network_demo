module dsp1_dti_pr_iniu_async_sys_side
    import dsp1_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM = `dsp1_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM = `dsp1_TRANSACTION_MAX_NUM,
