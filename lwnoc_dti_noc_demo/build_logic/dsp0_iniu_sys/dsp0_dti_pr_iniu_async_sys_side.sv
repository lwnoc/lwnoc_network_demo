module dsp0_dti_pr_iniu_async_sys_side
    import dsp0_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM = `dsp0_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM = `dsp0_TRANSACTION_MAX_NUM,
