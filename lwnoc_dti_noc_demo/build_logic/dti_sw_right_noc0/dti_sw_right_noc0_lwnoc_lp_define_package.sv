`ifndef dti_sw_right_noc0_LWNOC_LP_DEFINE_PACKAGE_SV
`define dti_sw_right_noc0_LWNOC_LP_DEFINE_PACKAGE_SV


package dti_sw_right_noc0_lwnoc_lp_define_package;
