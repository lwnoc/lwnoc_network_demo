module noc_tbu1_dti_pr_iniu_async_sys_side
    import noc_tbu1_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM = `noc_tbu1_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM = `noc_tbu1_TRANSACTION_MAX_NUM,
