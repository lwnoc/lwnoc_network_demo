module mipi1_dti_pr_iniu_async_sys_side
    import mipi1_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM = `mipi1_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM = `mipi1_TRANSACTION_MAX_NUM,
