module noc_tbu0_dti_pr_iniu_async_sys_side
    import noc_tbu0_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM = `noc_tbu0_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM = `noc_tbu0_TRANSACTION_MAX_NUM,
