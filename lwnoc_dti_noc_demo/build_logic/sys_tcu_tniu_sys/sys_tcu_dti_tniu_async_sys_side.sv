module sys_tcu_dti_tniu_async_sys_side
    import sys_tcu_dti_tniu_pack::*;
#(
    ...
    assign v_stage_1_hub_rx_req[3] = lp_hub_rx_req_t;
    ...
    assign lp_hub_tx_req_t         = v_stage_1_hub_tx_req[3];
    ...
    // CONV
    //=================================================
    sys_tcu_gnpd_to_dti_conv u_gnpd_to_dti_conv (
    .req_valid             (req_valid     ),
    .req_ready             (req_ready     ),
