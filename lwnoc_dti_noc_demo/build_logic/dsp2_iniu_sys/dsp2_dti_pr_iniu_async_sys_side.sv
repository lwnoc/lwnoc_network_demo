module dsp2_dti_pr_iniu_async_sys_side
    import dsp2_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM = `dsp2_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM = `dsp2_TRANSACTION_MAX_NUM,
