//[UHDL]Content Start [md5:da30faf9c3fd0801945535f6e2af50a7]
module tcu_tniu_node (
	...
	wire [9:0]   top_side_TO_sys_side_SIG_req_wptr_async     ;
	wire [104:0] top_side_TO_sys_side_SIG_req_pld_sync       ;
	wire [9:0]   top_side_TO_sys_side_SIG_rsp_rptr_async     ;
	wire [9:0]   top_side_TO_sys_side_SIG_rsp_rptr_sync      ;
	wire [8:0]   top_side_TO_sys_side_SIG_lp_hub_tx_req      ;
	wire [5:0]   top_ext_tieoff_TO_top_side_SIG_req_tgtid    ;
	wire         top_ext_tieoff_TO_top_side_SIG_req_qos      ;
	wire [9:0]   sys_side_TO_top_side_SIG_req_rptr_async     ;
	wire [9:0]   sys_side_TO_top_side_SIG_req_rptr_sync      ;
	wire         top_ext_tieoff_TO_top_side_SIG_rsp_threshold;
	wire [9:0]   sys_side_TO_top_side_SIG_rsp_wptr_async     ;
	wire [104:0] sys_side_TO_top_side_SIG_rsp_pld_sync       ;
	wire [8:0]   sys_side_TO_top_side_SIG_lp_hub_tx_req      ;
	wire         top_side_TO_top_ext_tieoff_SIG_req_threshold;
	wire         top_side_TO_top_ext_tieoff_SIG_rsp_qos      ;
	wire [5:0]   top_side_TO_top_ext_tieoff_SIG_rsp_tgtid    ;
	...
	sys_tcu_dti_tniu_async_sys_side sys_side (
		...
		.req_wptr_async(top_side_TO_sys_side_SIG_req_wptr_async),
		.req_rptr_async(sys_side_TO_top_side_SIG_req_rptr_async),
		.req_rptr_sync(sys_side_TO_top_side_SIG_req_rptr_sync),
		.req_pld_sync(top_side_TO_sys_side_SIG_req_pld_sync),
		.rsp_wptr_async(sys_side_TO_top_side_SIG_rsp_wptr_async),
		.rsp_rptr_async(top_side_TO_sys_side_SIG_rsp_rptr_async),
		.rsp_rptr_sync(top_side_TO_sys_side_SIG_rsp_rptr_sync),
		.rsp_pld_sync(sys_side_TO_top_side_SIG_rsp_pld_sync),
	...
	dti_tniu_top_dti_tniu_async_top_side top_side (
		...
		.req_tgtid(top_ext_tieoff_TO_top_side_SIG_req_tgtid),
		.req_qos(top_ext_tieoff_TO_top_side_SIG_req_qos),
		.req_threshold(top_side_TO_top_ext_tieoff_SIG_req_threshold),
		...
		.rsp_qos(top_side_TO_top_ext_tieoff_SIG_rsp_qos),
		.rsp_threshold(top_ext_tieoff_TO_top_side_SIG_rsp_threshold),
	...
	DtiTniuTopExtTieoffComponent top_ext_tieoff (
		.req_qos(top_ext_tieoff_TO_top_side_SIG_req_qos),
		.req_threshold(top_side_TO_top_ext_tieoff_SIG_req_threshold),
		.req_tgtid(top_ext_tieoff_TO_top_side_SIG_req_tgtid),
		.rsp_qos(top_side_TO_top_ext_tieoff_SIG_rsp_qos),
...
//[UHDL]Content End [md5:da30faf9c3fd0801945535f6e2af50a7]
