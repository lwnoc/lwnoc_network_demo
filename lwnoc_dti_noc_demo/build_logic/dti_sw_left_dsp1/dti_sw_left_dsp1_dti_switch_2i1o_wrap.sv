module dti_sw_left_dsp1_dti_switch_2i1o_wrap (
    ...
    dti_sw_left_dsp1_dti_noc_switch #(
        ...
        .TID_WIDTH     (6),
        .PAYLOAD_WIDTH (90),
        .TNIU_DECMIN   ({32'd`dti_sw_left_dsp1_DTI_TNIU_MIN}),
        .TNIU_DECMAX   ({32'd`dti_sw_left_dsp1_DTI_TNIU_MAX}),
        .INIU_DECMIN   ({32'd`dti_sw_left_dsp1_DTI_INIU1_MIN, 32'd`dti_sw_left_dsp1_DTI_INIU0_MIN}),
        .INIU_DECMAX   ({32'd`dti_sw_left_dsp1_DTI_INIU1_MAX, 32'd`dti_sw_left_dsp1_DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
