module dti_sw_left3_dti_switch_3i1o_wrap (
    ...
    dti_sw_left3_dti_noc_switch #(
        ...
        .INIU_DECMIN   ({32'd`DTI_INIU2_MIN, 32'd`dti_sw_left3_DTI_INIU1_MIN, 32'd`dti_sw_left3_DTI_INIU0_MIN}),
        .INIU_DECMAX   ({32'd`DTI_INIU2_MAX, 32'd`dti_sw_left3_DTI_INIU1_MAX, 32'd`dti_sw_left3_DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
