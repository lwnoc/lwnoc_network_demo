module `_PREFIX_(dti_switch_3i1o_wrap) (
    ...
    `_PREFIX_(dti_noc_switch) #(
        ...
        .TID_WIDTH     (6),
        .PAYLOAD_WIDTH (90),
        .TNIU_DECMIN   ({32'd`DTI_TNIU_MIN}),
        .TNIU_DECMAX   ({32'd`DTI_TNIU_MAX}),
        .INIU_DECMIN   ({32'd`DTI_INIU2_MIN, 32'd`DTI_INIU1_MIN, 32'd`DTI_INIU0_MIN}),
        .INIU_DECMAX   ({32'd`DTI_INIU2_MAX, 32'd`DTI_INIU1_MAX, 32'd`DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
