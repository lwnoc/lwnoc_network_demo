//[UHDL]Content Start [md5:eae52eece5e6ee01b57c16cbfc0e285d]
module ucie_ss1_tniu (
	input           clk_sys_clk                                                  ,
	...
	input  [9:0]    ucie_ss1_tniu_top_timeout_val_porting_timeout_val            ,
	input  [12:0]   ucie_ss1_tniu_top_lp_hub_porting_lp_hub_rx_req               ,
	output [12:0]   ucie_ss1_tniu_top_lp_hub_porting_lp_hub_tx_req               ,
	input  [7:0]    ucie_ss1_tniu_sys_tniu_tgt_id_porting_tniu_tgt_id            ,
	output [4095:0] ucie_ss1_tniu_sys_v_interrupt_porting_v_interrupt            ,
	output [127:0]  ucie_ss1_tniu_sys_v_merge_interrupt_porting_v_merge_interrupt,
	input  [31:0]   ucie_ss1_tniu_sys_apb_porting_p_addr                         ,
	input           ucie_ss1_tniu_sys_apb_porting_p_enable                       ,
	output [31:0]   ucie_ss1_tniu_sys_apb_porting_p_rdata                        ,
	output          ucie_ss1_tniu_sys_apb_porting_p_ready                        ,
	input           ucie_ss1_tniu_sys_apb_porting_p_sel                          ,
	output          ucie_ss1_tniu_sys_apb_porting_p_slverr                       ,
	input  [31:0]   ucie_ss1_tniu_sys_apb_porting_p_wdata                        ,
	input           ucie_ss1_tniu_sys_apb_porting_p_write                        ,
	input  [9:0]    ucie_ss1_tniu_sys_timeout_val_porting_timeout_val            );
	...
	tniu_top (
		...
		.timeout_val(ucie_ss1_tniu_top_timeout_val_porting_timeout_val),
		.lp_hub_rx_req(ucie_ss1_tniu_top_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(ucie_ss1_tniu_top_lp_hub_porting_lp_hub_tx_req),
		...
		.req_threshold());
	ucie_ss1_tniu_interrupt_tniu_aync_sys_side #(
	...
	tniu_sys (
		...
		.tniu_tgt_id(ucie_ss1_tniu_sys_tniu_tgt_id_porting_tniu_tgt_id),
		.v_interrupt(ucie_ss1_tniu_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(ucie_ss1_tniu_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(ucie_ss1_tniu_sys_apb_porting_p_addr),
		.p_sel(ucie_ss1_tniu_sys_apb_porting_p_sel),
		.p_enable(ucie_ss1_tniu_sys_apb_porting_p_enable),
		.p_write(ucie_ss1_tniu_sys_apb_porting_p_write),
		.p_wdata(ucie_ss1_tniu_sys_apb_porting_p_wdata),
		.p_ready(ucie_ss1_tniu_sys_apb_porting_p_ready),
		.p_rdata(ucie_ss1_tniu_sys_apb_porting_p_rdata),
		.p_slverr(ucie_ss1_tniu_sys_apb_porting_p_slverr),
		.wptr_async(tniu_top_TO_tniu_sys_SIG_wptr_async),
		.rptr_async(tniu_sys_TO_tniu_top_SIG_rptr_async),
		.rptr_sync(tniu_sys_TO_tniu_top_SIG_rptr_sync),
		.pld_sync(tniu_top_TO_tniu_sys_SIG_pld_sync),
		.timeout_val(ucie_ss1_tniu_sys_timeout_val_porting_timeout_val),
...
//[UHDL]Content End [md5:eae52eece5e6ee01b57c16cbfc0e285d]
