//[UHDL]Content Start [md5:25ecd1fe6dffe459997a374ab4ab509b]
module ddr6_iniu (
	input           clk_sys_clk                                  ,
	...
	input  [4095:0] ddr6_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    ddr6_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   ddr6_iniu_sys_apb_porting_p_addr             ,
	input           ddr6_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   ddr6_iniu_sys_apb_porting_p_rdata            ,
	output          ddr6_iniu_sys_apb_porting_p_ready            ,
	input           ddr6_iniu_sys_apb_porting_p_sel              ,
	output          ddr6_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   ddr6_iniu_sys_apb_porting_p_wdata            ,
	input           ddr6_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    ddr6_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   ddr6_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   ddr6_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	ddr6_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(ddr6_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(ddr6_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(ddr6_iniu_sys_apb_porting_p_addr),
		.p_sel(ddr6_iniu_sys_apb_porting_p_sel),
		.p_enable(ddr6_iniu_sys_apb_porting_p_enable),
		.p_write(ddr6_iniu_sys_apb_porting_p_write),
		.p_wdata(ddr6_iniu_sys_apb_porting_p_wdata),
		.p_ready(ddr6_iniu_sys_apb_porting_p_ready),
		.p_rdata(ddr6_iniu_sys_apb_porting_p_rdata),
		.p_slverr(ddr6_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(ddr6_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(ddr6_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(ddr6_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:25ecd1fe6dffe459997a374ab4ab509b]
