//[UHDL]Content Start [md5:efe16a90d12031003ab9b8c99cc2fbe2]
module ddr10_iniu (
	input           clk_sys_clk                                   ,
	...
	input  [4095:0] ddr10_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    ddr10_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   ddr10_iniu_sys_apb_porting_p_addr             ,
	input           ddr10_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   ddr10_iniu_sys_apb_porting_p_rdata            ,
	output          ddr10_iniu_sys_apb_porting_p_ready            ,
	input           ddr10_iniu_sys_apb_porting_p_sel              ,
	output          ddr10_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   ddr10_iniu_sys_apb_porting_p_wdata            ,
	input           ddr10_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    ddr10_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   ddr10_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   ddr10_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	ddr10_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(ddr10_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(ddr10_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(ddr10_iniu_sys_apb_porting_p_addr),
		.p_sel(ddr10_iniu_sys_apb_porting_p_sel),
		.p_enable(ddr10_iniu_sys_apb_porting_p_enable),
		.p_write(ddr10_iniu_sys_apb_porting_p_write),
		.p_wdata(ddr10_iniu_sys_apb_porting_p_wdata),
		.p_ready(ddr10_iniu_sys_apb_porting_p_ready),
		.p_rdata(ddr10_iniu_sys_apb_porting_p_rdata),
		.p_slverr(ddr10_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(ddr10_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(ddr10_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(ddr10_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:efe16a90d12031003ab9b8c99cc2fbe2]
