//[UHDL]Content Start [md5:5f380851f705095c41e419b19ecbdbbf]
module mipi_ss_iniu (
	input           clk_sys_clk                                     ,
	...
	input  [4095:0] mipi_ss_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    mipi_ss_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   mipi_ss_iniu_sys_apb_porting_p_addr             ,
	input           mipi_ss_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   mipi_ss_iniu_sys_apb_porting_p_rdata            ,
	output          mipi_ss_iniu_sys_apb_porting_p_ready            ,
	input           mipi_ss_iniu_sys_apb_porting_p_sel              ,
	output          mipi_ss_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   mipi_ss_iniu_sys_apb_porting_p_wdata            ,
	input           mipi_ss_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    mipi_ss_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   mipi_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   mipi_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	mipi_ss_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(mipi_ss_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(mipi_ss_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(mipi_ss_iniu_sys_apb_porting_p_addr),
		.p_sel(mipi_ss_iniu_sys_apb_porting_p_sel),
		.p_enable(mipi_ss_iniu_sys_apb_porting_p_enable),
		.p_write(mipi_ss_iniu_sys_apb_porting_p_write),
		.p_wdata(mipi_ss_iniu_sys_apb_porting_p_wdata),
		.p_ready(mipi_ss_iniu_sys_apb_porting_p_ready),
		.p_rdata(mipi_ss_iniu_sys_apb_porting_p_rdata),
		.p_slverr(mipi_ss_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(mipi_ss_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(mipi_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(mipi_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:5f380851f705095c41e419b19ecbdbbf]
