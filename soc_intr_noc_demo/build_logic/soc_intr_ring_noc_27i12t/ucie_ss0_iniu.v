//[UHDL]Content Start [md5:9329eac5fa3fa0df1e983c4134938108]
module ucie_ss0_iniu (
	input           clk_sys_clk                                      ,
	...
	input  [4095:0] ucie_ss0_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    ucie_ss0_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   ucie_ss0_iniu_sys_apb_porting_p_addr             ,
	input           ucie_ss0_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   ucie_ss0_iniu_sys_apb_porting_p_rdata            ,
	output          ucie_ss0_iniu_sys_apb_porting_p_ready            ,
	input           ucie_ss0_iniu_sys_apb_porting_p_sel              ,
	output          ucie_ss0_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   ucie_ss0_iniu_sys_apb_porting_p_wdata            ,
	input           ucie_ss0_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    ucie_ss0_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   ucie_ss0_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   ucie_ss0_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	ucie_ss0_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(ucie_ss0_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(ucie_ss0_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(ucie_ss0_iniu_sys_apb_porting_p_addr),
		.p_sel(ucie_ss0_iniu_sys_apb_porting_p_sel),
		.p_enable(ucie_ss0_iniu_sys_apb_porting_p_enable),
		.p_write(ucie_ss0_iniu_sys_apb_porting_p_write),
		.p_wdata(ucie_ss0_iniu_sys_apb_porting_p_wdata),
		.p_ready(ucie_ss0_iniu_sys_apb_porting_p_ready),
		.p_rdata(ucie_ss0_iniu_sys_apb_porting_p_rdata),
		.p_slverr(ucie_ss0_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(ucie_ss0_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(ucie_ss0_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(ucie_ss0_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:9329eac5fa3fa0df1e983c4134938108]
