//[UHDL]Content Start [md5:0ca8a90918829f455dd79033c5fef655]
module gpu_ss1_iniu (
	input           clk_sys_clk                                     ,
	...
	input  [4095:0] gpu_ss1_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    gpu_ss1_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   gpu_ss1_iniu_sys_apb_porting_p_addr             ,
	input           gpu_ss1_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   gpu_ss1_iniu_sys_apb_porting_p_rdata            ,
	output          gpu_ss1_iniu_sys_apb_porting_p_ready            ,
	input           gpu_ss1_iniu_sys_apb_porting_p_sel              ,
	output          gpu_ss1_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   gpu_ss1_iniu_sys_apb_porting_p_wdata            ,
	input           gpu_ss1_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    gpu_ss1_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   gpu_ss1_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   gpu_ss1_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	gpu_ss1_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(gpu_ss1_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(gpu_ss1_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(gpu_ss1_iniu_sys_apb_porting_p_addr),
		.p_sel(gpu_ss1_iniu_sys_apb_porting_p_sel),
		.p_enable(gpu_ss1_iniu_sys_apb_porting_p_enable),
		.p_write(gpu_ss1_iniu_sys_apb_porting_p_write),
		.p_wdata(gpu_ss1_iniu_sys_apb_porting_p_wdata),
		.p_ready(gpu_ss1_iniu_sys_apb_porting_p_ready),
		.p_rdata(gpu_ss1_iniu_sys_apb_porting_p_rdata),
		.p_slverr(gpu_ss1_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(gpu_ss1_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(gpu_ss1_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(gpu_ss1_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:0ca8a90918829f455dd79033c5fef655]
