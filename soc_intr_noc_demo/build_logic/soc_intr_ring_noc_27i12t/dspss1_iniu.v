//[UHDL]Content Start [md5:ee0abc7d97d3f0f5d5d545d8bc9717fa]
module dspss1_iniu (
	input           clk_sys_clk                                    ,
	...
	input  [4095:0] dspss1_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    dspss1_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   dspss1_iniu_sys_apb_porting_p_addr             ,
	input           dspss1_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   dspss1_iniu_sys_apb_porting_p_rdata            ,
	output          dspss1_iniu_sys_apb_porting_p_ready            ,
	input           dspss1_iniu_sys_apb_porting_p_sel              ,
	output          dspss1_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   dspss1_iniu_sys_apb_porting_p_wdata            ,
	input           dspss1_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    dspss1_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   dspss1_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   dspss1_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	dspss1_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(dspss1_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(dspss1_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(dspss1_iniu_sys_apb_porting_p_addr),
		.p_sel(dspss1_iniu_sys_apb_porting_p_sel),
		.p_enable(dspss1_iniu_sys_apb_porting_p_enable),
		.p_write(dspss1_iniu_sys_apb_porting_p_write),
		.p_wdata(dspss1_iniu_sys_apb_porting_p_wdata),
		.p_ready(dspss1_iniu_sys_apb_porting_p_ready),
		.p_rdata(dspss1_iniu_sys_apb_porting_p_rdata),
		.p_slverr(dspss1_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(dspss1_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(dspss1_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(dspss1_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:ee0abc7d97d3f0f5d5d545d8bc9717fa]
