//[UHDL]Content Start [md5:fb450f51f4baaadd5de3322c4eb5d77a]
module dp_ss_iniu (
	input           clk_sys_clk                                   ,
	...
	input  [4095:0] dp_ss_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    dp_ss_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   dp_ss_iniu_sys_apb_porting_p_addr             ,
	input           dp_ss_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   dp_ss_iniu_sys_apb_porting_p_rdata            ,
	output          dp_ss_iniu_sys_apb_porting_p_ready            ,
	input           dp_ss_iniu_sys_apb_porting_p_sel              ,
	output          dp_ss_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   dp_ss_iniu_sys_apb_porting_p_wdata            ,
	input           dp_ss_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    dp_ss_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   dp_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   dp_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	dp_ss_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(dp_ss_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(dp_ss_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(dp_ss_iniu_sys_apb_porting_p_addr),
		.p_sel(dp_ss_iniu_sys_apb_porting_p_sel),
		.p_enable(dp_ss_iniu_sys_apb_porting_p_enable),
		.p_write(dp_ss_iniu_sys_apb_porting_p_write),
		.p_wdata(dp_ss_iniu_sys_apb_porting_p_wdata),
		.p_ready(dp_ss_iniu_sys_apb_porting_p_ready),
		.p_rdata(dp_ss_iniu_sys_apb_porting_p_rdata),
		.p_slverr(dp_ss_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(dp_ss_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(dp_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(dp_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:fb450f51f4baaadd5de3322c4eb5d77a]
