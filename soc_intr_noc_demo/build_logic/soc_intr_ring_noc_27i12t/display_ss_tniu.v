//[UHDL]Content Start [md5:02baa3cd1fb57aa25ad7bfca5d4c56e5]
module display_ss_tniu (
	input           clk_sys_clk                                                    ,
	...
	input  [9:0]    display_ss_tniu_top_timeout_val_porting_timeout_val            ,
	input  [12:0]   display_ss_tniu_top_lp_hub_porting_lp_hub_rx_req               ,
	output [12:0]   display_ss_tniu_top_lp_hub_porting_lp_hub_tx_req               ,
	input  [7:0]    display_ss_tniu_sys_tniu_tgt_id_porting_tniu_tgt_id            ,
	output [4095:0] display_ss_tniu_sys_v_interrupt_porting_v_interrupt            ,
	output [127:0]  display_ss_tniu_sys_v_merge_interrupt_porting_v_merge_interrupt,
	input  [31:0]   display_ss_tniu_sys_apb_porting_p_addr                         ,
	input           display_ss_tniu_sys_apb_porting_p_enable                       ,
	output [31:0]   display_ss_tniu_sys_apb_porting_p_rdata                        ,
	output          display_ss_tniu_sys_apb_porting_p_ready                        ,
	input           display_ss_tniu_sys_apb_porting_p_sel                          ,
	output          display_ss_tniu_sys_apb_porting_p_slverr                       ,
	input  [31:0]   display_ss_tniu_sys_apb_porting_p_wdata                        ,
	input           display_ss_tniu_sys_apb_porting_p_write                        ,
	input  [9:0]    display_ss_tniu_sys_timeout_val_porting_timeout_val            );
	...
	tniu_top (
		...
		.timeout_val(display_ss_tniu_top_timeout_val_porting_timeout_val),
		.lp_hub_rx_req(display_ss_tniu_top_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(display_ss_tniu_top_lp_hub_porting_lp_hub_tx_req),
		...
		.req_threshold());
	display_ss_tniu_interrupt_tniu_aync_sys_side #(
	...
	tniu_sys (
		...
		.tniu_tgt_id(display_ss_tniu_sys_tniu_tgt_id_porting_tniu_tgt_id),
		.v_interrupt(display_ss_tniu_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(display_ss_tniu_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(display_ss_tniu_sys_apb_porting_p_addr),
		.p_sel(display_ss_tniu_sys_apb_porting_p_sel),
		.p_enable(display_ss_tniu_sys_apb_porting_p_enable),
		.p_write(display_ss_tniu_sys_apb_porting_p_write),
		.p_wdata(display_ss_tniu_sys_apb_porting_p_wdata),
		.p_ready(display_ss_tniu_sys_apb_porting_p_ready),
		.p_rdata(display_ss_tniu_sys_apb_porting_p_rdata),
		.p_slverr(display_ss_tniu_sys_apb_porting_p_slverr),
		.wptr_async(tniu_top_TO_tniu_sys_SIG_wptr_async),
		.rptr_async(tniu_sys_TO_tniu_top_SIG_rptr_async),
		.rptr_sync(tniu_sys_TO_tniu_top_SIG_rptr_sync),
		.pld_sync(tniu_top_TO_tniu_sys_SIG_pld_sync),
		.timeout_val(display_ss_tniu_sys_timeout_val_porting_timeout_val),
	...
	display_ss_tniu_ring ring_wrap (
		.clk(clk_noc),
		.rst_n(rst_noc_n),
...
//[UHDL]Content End [md5:02baa3cd1fb57aa25ad7bfca5d4c56e5]
