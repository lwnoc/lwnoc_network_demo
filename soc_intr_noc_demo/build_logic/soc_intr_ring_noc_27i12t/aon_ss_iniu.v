//[UHDL]Content Start [md5:a8bcc1a15ae8a2b17835ba6382cccc21]
module aon_ss_iniu (
	input           clk_sys_clk                                    ,
	...
	input  [4095:0] aon_ss_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    aon_ss_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   aon_ss_iniu_sys_apb_porting_p_addr             ,
	input           aon_ss_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   aon_ss_iniu_sys_apb_porting_p_rdata            ,
	output          aon_ss_iniu_sys_apb_porting_p_ready            ,
	input           aon_ss_iniu_sys_apb_porting_p_sel              ,
	output          aon_ss_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   aon_ss_iniu_sys_apb_porting_p_wdata            ,
	input           aon_ss_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    aon_ss_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   aon_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   aon_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	aon_ss_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.iniu_src_id(aon_ss_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(aon_ss_iniu_sys_apb_porting_p_addr),
		.p_sel(aon_ss_iniu_sys_apb_porting_p_sel),
		.p_enable(aon_ss_iniu_sys_apb_porting_p_enable),
		.p_write(aon_ss_iniu_sys_apb_porting_p_write),
		.p_wdata(aon_ss_iniu_sys_apb_porting_p_wdata),
		.p_ready(aon_ss_iniu_sys_apb_porting_p_ready),
		.p_rdata(aon_ss_iniu_sys_apb_porting_p_rdata),
		.p_slverr(aon_ss_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(aon_ss_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(aon_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(aon_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:a8bcc1a15ae8a2b17835ba6382cccc21]
