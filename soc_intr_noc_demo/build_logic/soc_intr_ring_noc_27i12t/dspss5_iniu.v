//[UHDL]Content Start [md5:e1058341997aa34bd237183e136cf0f8]
module dspss5_iniu (
	input           clk_sys_clk                                    ,
	...
	input  [4095:0] dspss5_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    dspss5_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   dspss5_iniu_sys_apb_porting_p_addr             ,
	input           dspss5_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   dspss5_iniu_sys_apb_porting_p_rdata            ,
	output          dspss5_iniu_sys_apb_porting_p_ready            ,
	input           dspss5_iniu_sys_apb_porting_p_sel              ,
	output          dspss5_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   dspss5_iniu_sys_apb_porting_p_wdata            ,
	input           dspss5_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    dspss5_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   dspss5_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   dspss5_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	dspss5_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(dspss5_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(dspss5_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(dspss5_iniu_sys_apb_porting_p_addr),
		.p_sel(dspss5_iniu_sys_apb_porting_p_sel),
		.p_enable(dspss5_iniu_sys_apb_porting_p_enable),
		.p_write(dspss5_iniu_sys_apb_porting_p_write),
		.p_wdata(dspss5_iniu_sys_apb_porting_p_wdata),
		.p_ready(dspss5_iniu_sys_apb_porting_p_ready),
		.p_rdata(dspss5_iniu_sys_apb_porting_p_rdata),
		.p_slverr(dspss5_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(dspss5_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(dspss5_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(dspss5_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:e1058341997aa34bd237183e136cf0f8]
