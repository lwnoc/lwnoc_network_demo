//[UHDL]Content Start [md5:ac60fa19641817cc0ea5c89eeff90fe7]
module camera_ss_iniu (
	input           clk_sys_clk                                       ,
	...
	input  [4095:0] camera_ss_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    camera_ss_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   camera_ss_iniu_sys_apb_porting_p_addr             ,
	input           camera_ss_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   camera_ss_iniu_sys_apb_porting_p_rdata            ,
	output          camera_ss_iniu_sys_apb_porting_p_ready            ,
	input           camera_ss_iniu_sys_apb_porting_p_sel              ,
	output          camera_ss_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   camera_ss_iniu_sys_apb_porting_p_wdata            ,
	input           camera_ss_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    camera_ss_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   camera_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   camera_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	camera_ss_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(camera_ss_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(camera_ss_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(camera_ss_iniu_sys_apb_porting_p_addr),
		.p_sel(camera_ss_iniu_sys_apb_porting_p_sel),
		.p_enable(camera_ss_iniu_sys_apb_porting_p_enable),
		.p_write(camera_ss_iniu_sys_apb_porting_p_write),
		.p_wdata(camera_ss_iniu_sys_apb_porting_p_wdata),
		.p_ready(camera_ss_iniu_sys_apb_porting_p_ready),
		.p_rdata(camera_ss_iniu_sys_apb_porting_p_rdata),
		.p_slverr(camera_ss_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(camera_ss_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(camera_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(camera_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:ac60fa19641817cc0ea5c89eeff90fe7]
