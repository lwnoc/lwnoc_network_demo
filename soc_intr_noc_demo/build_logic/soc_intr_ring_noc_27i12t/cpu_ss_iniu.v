//[UHDL]Content Start [md5:281566f0fd409ff63b8b6f9f9497c710]
module cpu_ss_iniu (
	input           clk_sys_clk                                    ,
	...
	input  [4095:0] cpu_ss_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    cpu_ss_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   cpu_ss_iniu_sys_apb_porting_p_addr             ,
	input           cpu_ss_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   cpu_ss_iniu_sys_apb_porting_p_rdata            ,
	output          cpu_ss_iniu_sys_apb_porting_p_ready            ,
	input           cpu_ss_iniu_sys_apb_porting_p_sel              ,
	output          cpu_ss_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   cpu_ss_iniu_sys_apb_porting_p_wdata            ,
	input           cpu_ss_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    cpu_ss_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   cpu_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   cpu_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	cpu_ss_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(cpu_ss_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(cpu_ss_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(cpu_ss_iniu_sys_apb_porting_p_addr),
		.p_sel(cpu_ss_iniu_sys_apb_porting_p_sel),
		.p_enable(cpu_ss_iniu_sys_apb_porting_p_enable),
		.p_write(cpu_ss_iniu_sys_apb_porting_p_write),
		.p_wdata(cpu_ss_iniu_sys_apb_porting_p_wdata),
		.p_ready(cpu_ss_iniu_sys_apb_porting_p_ready),
		.p_rdata(cpu_ss_iniu_sys_apb_porting_p_rdata),
		.p_slverr(cpu_ss_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(cpu_ss_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(cpu_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(cpu_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:281566f0fd409ff63b8b6f9f9497c710]
