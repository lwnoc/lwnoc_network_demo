//[UHDL]Content Start [md5:9969f52c0cc11344c9019c8b44cfe968]
module vpu_ss_iniu (
	input           clk_sys_clk                                    ,
	...
	input  [4095:0] vpu_ss_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    vpu_ss_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   vpu_ss_iniu_sys_apb_porting_p_addr             ,
	input           vpu_ss_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   vpu_ss_iniu_sys_apb_porting_p_rdata            ,
	output          vpu_ss_iniu_sys_apb_porting_p_ready            ,
	input           vpu_ss_iniu_sys_apb_porting_p_sel              ,
	output          vpu_ss_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   vpu_ss_iniu_sys_apb_porting_p_wdata            ,
	input           vpu_ss_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    vpu_ss_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   vpu_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   vpu_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	vpu_ss_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(vpu_ss_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(vpu_ss_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(vpu_ss_iniu_sys_apb_porting_p_addr),
		.p_sel(vpu_ss_iniu_sys_apb_porting_p_sel),
		.p_enable(vpu_ss_iniu_sys_apb_porting_p_enable),
		.p_write(vpu_ss_iniu_sys_apb_porting_p_write),
		.p_wdata(vpu_ss_iniu_sys_apb_porting_p_wdata),
		.p_ready(vpu_ss_iniu_sys_apb_porting_p_ready),
		.p_rdata(vpu_ss_iniu_sys_apb_porting_p_rdata),
		.p_slverr(vpu_ss_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(vpu_ss_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(vpu_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(vpu_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req));
...
//[UHDL]Content End [md5:9969f52c0cc11344c9019c8b44cfe968]
