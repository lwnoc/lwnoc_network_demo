//[UHDL]Content Start [md5:c46481bc8c109bf866c82c4ff6a133d9]
module pcie_eth_ss_iniu (
	input           clk_sys_clk                                         ,
	...
	input  [4095:0] pcie_eth_ss_iniu_sys_v_interrupt_porting_v_interrupt,
	input  [7:0]    pcie_eth_ss_iniu_sys_iniu_src_id_porting_iniu_src_id,
	input  [31:0]   pcie_eth_ss_iniu_sys_apb_porting_p_addr             ,
	input           pcie_eth_ss_iniu_sys_apb_porting_p_enable           ,
	output [31:0]   pcie_eth_ss_iniu_sys_apb_porting_p_rdata            ,
	output          pcie_eth_ss_iniu_sys_apb_porting_p_ready            ,
	input           pcie_eth_ss_iniu_sys_apb_porting_p_sel              ,
	output          pcie_eth_ss_iniu_sys_apb_porting_p_slverr           ,
	input  [31:0]   pcie_eth_ss_iniu_sys_apb_porting_p_wdata            ,
	input           pcie_eth_ss_iniu_sys_apb_porting_p_write            ,
	input  [9:0]    pcie_eth_ss_iniu_sys_timeout_val_porting_timeout_val,
	input  [12:0]   pcie_eth_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req   ,
	output [12:0]   pcie_eth_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req   );
	...
	//module inst.
	pcie_eth_ss_iniu_interrupt_iniu_aync_sys_side #(
	...
	iniu_sys (
		...
		.v_interrupt(pcie_eth_ss_iniu_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(pcie_eth_ss_iniu_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(pcie_eth_ss_iniu_sys_apb_porting_p_addr),
		.p_sel(pcie_eth_ss_iniu_sys_apb_porting_p_sel),
		.p_enable(pcie_eth_ss_iniu_sys_apb_porting_p_enable),
		.p_write(pcie_eth_ss_iniu_sys_apb_porting_p_write),
		.p_wdata(pcie_eth_ss_iniu_sys_apb_porting_p_wdata),
		.p_ready(pcie_eth_ss_iniu_sys_apb_porting_p_ready),
		.p_rdata(pcie_eth_ss_iniu_sys_apb_porting_p_rdata),
		.p_slverr(pcie_eth_ss_iniu_sys_apb_porting_p_slverr),
		...
		.timeout_val(pcie_eth_ss_iniu_sys_timeout_val_porting_timeout_val),
		...
		.lp_hub_rx_req(pcie_eth_ss_iniu_sys_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(pcie_eth_ss_iniu_sys_lp_hub_porting_lp_hub_tx_req));
	...
	iniu_top (
		...
		.req_threshold(1'b0));
	pcie_eth_ss_iniu_ring ring_wrap (
		.clk(clk_noc),
		.rst_n(rst_noc_n),
...
//[UHDL]Content End [md5:c46481bc8c109bf866c82c4ff6a133d9]
