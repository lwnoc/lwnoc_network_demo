module intr_tniu_sys_interrupt_tniu_aync_sys_side
...
#(
    ...
    output lwnoc_lp_req_signal_t                    m_niu_lp_hub_rx_req             ,
    input  lwnoc_lp_req_signal_t                    m_niu_lp_hub_tx_req
...
//===========================================================================
    ...
    lwnoc_lp_tniu_func_tniu #(
        ...
        .rx_req             (m_niu_lp_hub_tx_req        ),
        .tx_req             (m_niu_lp_hub_rx_req        ),
...
//===========================================================================
    ...
    generate
        if(INTERRUPT_NUM==4096)begin
            intr_tniu_sys_spram_4096x20 u_sp_4096_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            intr_tniu_sys_spram_2048x20 u_sp_2048_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            intr_tniu_sys_spram_1024x20 u_sp_1024_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            intr_tniu_sys_spram_512x20 u_sp_512_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            intr_tniu_sys_spram_256x20 u_sp_256_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            intr_tniu_sys_spram_128x20 u_sp_128_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
