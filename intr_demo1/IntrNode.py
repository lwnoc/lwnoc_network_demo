...
class IntrIniuTopNode(UhdlComponentNode):
    ...
    def __init__(self, id: str):
        ...
        # req_* except threshold map to the ring inject port.
        self.add_interface("local_tx",   r"req_(valid|ready|payload|srcid|tgtid|qos|last)$")
...
class IntrTniuTopNode(UhdlComponentNode):
    ...
    def __init__(self, id: str):
        ...
        # s_async_master_hub_rx_req + s_async_master_hub_tx_req (cross-domain LP)
        self.add_interface("lp_async",   r"s_async_master_hub")
        # req_* except threshold map to the ring eject port.
        self.add_interface("local_rx",   r"req_(valid|ready|payload|srcid|tgtid|qos|last)$")
...
class IntrIniuNode(UhdlWrapperNode):
    ...
    def __init__(self, id: str, sys_cfg=intr_iniu_sys_config):
        ...
        self.add_interface("nring_in_if")
        self.add_interface("nring_out_if")
        self.add_interface("v_interrupt")
        self.add_interface("iniu_src_id")
        ...
        connect(self.iniu_top.local_tx, self.ring_wrap.local_tx)
        ...
        # Explicitly expose only the intended system-facing interfaces.
        connect(self.iniu_sys.v_interrupt, self.v_interrupt)
        connect(self.iniu_sys.iniu_src_id, self.iniu_src_id)
        connect(self.iniu_sys.apb, self.apb)
        connect(self.iniu_sys.timeout_val, self.timeout_val)
        connect(self.iniu_sys.lp_hub, self.lp_hub)
...
class IntrTniuNode(UhdlWrapperNode):
    ...
    def __init__(self, id: str, sys_cfg=intr_tniu_sys_config):
        ...
        self.add_interface("nring_in_if")
        self.add_interface("nring_out_if")
        self.add_interface("tniu_tgt_id")
        self.add_interface("v_interrupt")
        self.add_interface("v_merge_interrupt")
        self.add_interface("apb")
        self.add_interface("timeout_val")
        self.add_interface("lp_hub")
        ...
        # Ring eject → TNIU top
        connect(self.ring_wrap.local_rx, self.tniu_top.local_rx)
        ...
        # Explicitly expose only the intended system-facing interfaces.
        connect(self.tniu_sys.tniu_tgt_id, self.tniu_tgt_id)
        connect(self.tniu_sys.v_interrupt, self.v_interrupt)
        connect(self.tniu_sys.v_merge_interrupt, self.v_merge_interrupt)
        connect(self.tniu_sys.apb, self.apb)
        connect(self.tniu_sys.timeout_val, self.timeout_val)
