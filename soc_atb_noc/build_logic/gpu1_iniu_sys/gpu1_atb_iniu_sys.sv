module gpu1_atb_iniu_sys
import gpu1_lw_atb_noc_pack::*;
import lwnoc_lp_define_package::*;
import lwnoc_lp_struct_package::*;
#(
    parameter integer unsigned FIFO_DEPTH     = `gpu1_ATB_INIU_FIFO_DEPTH,
    parameter integer unsigned AUTO_CLEAR_EN  = `gpu1_ATB_INIU_AUTO_CLEAR_EN,
    parameter integer unsigned SYNC_STAGE     = `gpu1_ATB_INIU_SYNC_STAGE,
    parameter integer unsigned SYNC_BUF_DEPTH = `gpu1_ATB_INIU_SYNC_BUF_DEPTH,
    ...
    gpu1_flush_partial_reset u_flush_partial_reset (
        .clk            (clk_atb_s          ),
        .rst_n          (rstn_atb_s         ),
        .s_atvalid      (s_atvalid          ),
        .s_atready      (s_atready          ),
