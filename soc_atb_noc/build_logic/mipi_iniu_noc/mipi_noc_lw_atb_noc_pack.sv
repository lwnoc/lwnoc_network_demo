package mipi_noc_lw_atb_noc_pack;
    import lwnoc_lp_struct_package::*;
    import lwnoc_lp_define_package::*;

    localparam integer unsigned ATB_DATA_WIDTH  = `mipi_noc_ATB_DATA_WIDTH;
    localparam integer unsigned ATB_ID_WIDTH    = `mipi_noc_ATB_ID_WIDTH;
    localparam integer unsigned ATB_BYTES_WIDTH = `mipi_noc_ATB_BYTES_WIDTH;
    localparam integer unsigned ATB_PLD_WIDTH   = `mipi_noc_ATB_PLD_WIDTH;
...
endpackage : mipi_noc_lw_atb_noc_pack;
