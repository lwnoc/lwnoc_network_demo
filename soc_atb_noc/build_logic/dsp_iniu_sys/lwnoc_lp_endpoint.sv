...
(
    ...
    assign endpoint_stop_view = (~rx_req_sync.stg1_req_or) && (~rx_req_sync.stg1_ack_or) &&
                                (~rx_req_sync.stg2_req_or) && (~rx_req_sync.stg2_ack_or);
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            tx_req_cdc <= lwnoc_lp_req_signal_t'{
                ...
                stg1_ack_or : rx_req_sync.stg1_req_or,
                stg1_ack_and: rx_req_sync.stg1_req_or,
                stg2_req_or : rx_req_sync.stg2_req_or,
                stg2_req_and: rx_req_sync.stg2_req_or,
                stg2_ack_or : rx_req_sync.stg2_req_or,
                stg2_ack_and: rx_req_sync.stg2_req_or,
                state       : endpoint_stop_view ? LP_LEVEL0_NOP : rx_req_sync.state,
                stg1_dack_and: 1'b0,
                stg1_dack_or : 1'b0
            };
        end
            ...
            tx_req_cdc <= lwnoc_lp_req_signal_t'{
                stg1_req_or : rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg1_req_and,
                stg1_req_and: rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg1_req_and,
                stg1_ack_or : rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg1_req_and,
                stg1_ack_and: rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg1_req_and,
                stg2_req_or : rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg2_req_and,
                stg2_req_and: rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg2_req_and,
                stg2_ack_or : rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg2_req_and,
                stg2_ack_and: rx_req_sync.stg1_dack_or ? 1'b1 : rx_req_sync.stg2_req_and,
                state       : (rx_req_sync.stg1_dack_or || endpoint_stop_view) ? LP_LEVEL0_NOP : rx_req_sync.state,
                stg1_dack_and: rx_req_sync.stg1_dack_or,
                stg1_dack_or : rx_req_sync.stg1_dack_or
            };
        end
    end
