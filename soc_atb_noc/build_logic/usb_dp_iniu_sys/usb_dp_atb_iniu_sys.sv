module usb_dp_atb_iniu_sys
import usb_dp_lw_atb_noc_pack::*;
import lwnoc_lp_define_package::*;
import lwnoc_lp_struct_package::*;
#(
    parameter integer unsigned FIFO_DEPTH     = `usb_dp_ATB_INIU_FIFO_DEPTH,
    parameter integer unsigned AUTO_CLEAR_EN  = `usb_dp_ATB_INIU_AUTO_CLEAR_EN,
    parameter integer unsigned SYNC_STAGE     = `usb_dp_ATB_INIU_SYNC_STAGE,
    parameter integer unsigned SYNC_BUF_DEPTH = `usb_dp_ATB_INIU_SYNC_BUF_DEPTH,
    ...
    output  logic [ATB_AFIFO_W:0]       pld_sync,
    ...
    usb_dp_flush_partial_reset u_flush_partial_reset (
        .clk            (clk_atb_s          ),
        .rst_n          (rstn_atb_s         ),
        .s_atvalid      (s_atvalid          ),
        .s_atready      (s_atready          ),
