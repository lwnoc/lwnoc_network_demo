 ...
 *  Each terminal exchanges stage1, stage2, and stg1_dack signals with the other two.
 *  The hub instantiates three subhubs, one per terminal, to aggregate and route
 *  requests and stage1 deny-revert handshakes between terminals for low-power network-on-chip operation.
 * -----
