...
// STG1_ACK BOX
//===========================================================================
assign tx_req.stg1_ack_or  = v_rx_req[0].stg1_ack_or  | v_rx_req[1].stg1_ack_or;
assign tx_req.stg1_ack_and = v_rx_req[0].stg1_ack_and & v_rx_req[1].stg1_ack_and;

//===========================================================================
// STG2_ACK BOX
//===========================================================================
assign tx_req.stg2_ack_or  = v_rx_req[0].stg2_ack_or  | v_rx_req[1].stg2_ack_or;
assign tx_req.stg2_ack_and = v_rx_req[0].stg2_ack_and & v_rx_req[1].stg2_ack_and;

//===========================================================================
// STG1_DACK BOX
//===========================================================================
assign tx_req.stg1_dack_and = v_rx_req[0].stg1_dack_and & v_rx_req[1].stg1_dack_and;
assign tx_req.stg1_dack_or  = v_rx_req[0].stg1_dack_or  | v_rx_req[1].stg1_dack_or;
