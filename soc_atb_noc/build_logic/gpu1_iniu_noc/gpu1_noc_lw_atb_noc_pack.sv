package gpu1_noc_lw_atb_noc_pack;
    import lwnoc_lp_struct_package::*;
    import lwnoc_lp_define_package::*;

    localparam integer unsigned ATB_DATA_WIDTH  = `gpu1_noc_ATB_DATA_WIDTH;
    localparam integer unsigned ATB_ID_WIDTH    = `gpu1_noc_ATB_ID_WIDTH;
    localparam integer unsigned ATB_BYTES_WIDTH = `gpu1_noc_ATB_BYTES_WIDTH;
    localparam integer unsigned ATB_PLD_WIDTH   = `gpu1_noc_ATB_PLD_WIDTH;
...
endpackage : gpu1_noc_lw_atb_noc_pack;
