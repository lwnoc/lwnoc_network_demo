module display_noc_niu_atb_slv
...
#(
    ...
    localparam integer unsigned ATB_PLD_WIDTH = ATB_TRANS_WIDTH
    ...
    logic [ATB_AFIFO_W-1:0]     atb_afifo_pld_ecc;
    ...
    fcip_ecc_enc #(.DATA_WIDTH(ATB_PLD_WIDTH)) u_atb_afifo_ecc_enc (
        .data       (atb_afifo_pld),
        .encode_data(atb_afifo_pld_ecc)
    );
