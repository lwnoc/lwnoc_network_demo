module display_noc_atb_niu_packer
...
#(
    ...
    assign flag_ctrl_hs = atvalid_d && s_atready_tmp;
    assign s_atready    = !atvalid_d || s_atready_tmp;
    assign s_at_hs      = s_atvalid && s_atready;
    ...
    always_ff @(posedge clk_atb_s or negedge rstn_atb_s) begin
        if (!rstn_atb_s) begin
            ...
            case ({s_at_hs, flag_ctrl_hs})
                2'b10,
                2'b11: atvalid_d <= 1'b1;
                2'b01: atvalid_d <= 1'b0;
                default: atvalid_d <= atvalid_d;
            endcase
    ...
    display_noc_flag_ctrl u_flag_ctrl (
        .clk                (clk_atb_s          ),
        .rst_n               (rstn_atb_s         ),
        .s_atvalid          (atvalid_d          ),
