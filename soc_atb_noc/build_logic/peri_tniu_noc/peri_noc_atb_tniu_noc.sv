module peri_noc_atb_tniu_noc
import peri_noc_lw_atb_noc_pack::*;
import lwnoc_lp_define_package::*;
import lwnoc_lp_struct_package::*;
#(
    parameter integer unsigned FIFO_DEPTH   = `peri_noc_ATB_TNIU_FIFO_DEPTH,
    parameter integer unsigned AUTO_CLEAR_EN= `peri_noc_ATB_TNIU_AUTO_CLEAR_EN,
    parameter integer unsigned SYNC_STAGE   = `peri_noc_ATB_TNIU_SYNC_STAGE,
...
peri_noc_flush_dummy_mst u_flush_dummy_mst (
    .clk        (clk_atb_s      ),
    .rst_n      (rstn_atb_s     ),
    .s_atvalid  (s_atvalid      ),
    .s_atready  (s_atready      ),
...
peri_noc_trace_data_default_slv u_trace_data_default_slv (
    .clk        (clk_atb_s      ),
    .rst_n      (rstn_atb_s     ),
