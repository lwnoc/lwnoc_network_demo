module cpu_noc_atb_iniu_noc
import cpu_noc_lw_atb_noc_pack::*;
import lwnoc_lp_define_package::*;
import lwnoc_lp_struct_package::*;
#(
    parameter integer unsigned FIFO_DEPTH        = `cpu_noc_ATB_INIU_FIFO_DEPTH,
    parameter integer unsigned AUTO_CLEAR_EN     = `cpu_noc_ATB_INIU_AUTO_CLEAR_EN,
    parameter integer unsigned SYNC_STAGE        = `cpu_noc_ATB_INIU_SYNC_STAGE,
    parameter integer unsigned ERR_INT_CNT_WIDTH = `cpu_noc_ATB_INIU_ERR_INT_CNT_WIDTH,
    ...
    cpu_noc_flush_dummy_mst u_flush_unpacker (
        .clk        (clk_atb_m          ),
        .rst_n      (rstn_atb_m         ),
    ...
    cpu_noc_flush_default_slv u_flush_default_slv (
        .clk        (clk_atb_m      ),
        .rst_n      (rstn_atb_m     ),
