//[UHDL]Content Start [md5:a4e6ee4358d36b04556371288f73bdec]
module dsp_ss5_node (
	...
	output [1:0]   dsp_ss5_sys_node_pchnl_ctrl_porting_pactive      ,
	output         dsp_ss5_sys_node_pchnl_ctrl_porting_pdeny        ,
	input          dsp_ss5_sys_node_pchnl_ctrl_porting_preq         ,
	input  [1:0]   dsp_ss5_sys_node_pchnl_ctrl_porting_pstate       ,
	output         dsp_ss5_top_wrap_m_chan_porting_m_chan_m_afready ,
	input          dsp_ss5_top_wrap_m_chan_porting_m_chan_m_afvalid ,
	output [3:0]   dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atbytes ,
	output [127:0] dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atdata  ,
	output [6:0]   dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atid    ,
	input          dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atready ,
	output         dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atvalid ,
	output         dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atwakeup,
	input          dsp_ss5_top_wrap_m_chan_porting_m_chan_m_syncreq );
	...
	dsp_ss5_top_wrap top_side (
		.clk_clk_atb_m(clk_noc),
		.rst_n_rstn_atb_m(rst_noc_n),
		.m_chan_m_afready(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_afready),
		.m_chan_m_afvalid(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_afvalid),
		.m_chan_m_atbytes(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atbytes),
		.m_chan_m_atdata(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atdata),
		.m_chan_m_atid(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atid),
		.m_chan_m_atready(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atready),
		.m_chan_m_atvalid(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atvalid),
		.m_chan_m_atwakeup(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_atwakeup),
		.m_chan_m_syncreq(dsp_ss5_top_wrap_m_chan_porting_m_chan_m_syncreq),
...
//[UHDL]Content End [md5:a4e6ee4358d36b04556371288f73bdec]
