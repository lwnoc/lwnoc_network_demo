//[UHDL]Content Start [md5:4eecd3b30ac478a7a2ed90372606ddd4]
module dsp_ss2_node
	...
	input                                                   dsp_ss2_sys_node_flush_req_porting_flush_req        ,
	output                                                  dsp_ss2_sys_node_pchnl_ctrl_porting_paccept         ,
	output lwnoc_lp_define_package::lwnoc_pchannel_active_t dsp_ss2_sys_node_pchnl_ctrl_porting_pactive         ,
	output                                                  dsp_ss2_sys_node_pchnl_ctrl_porting_pdeny           ,
	input                                                   dsp_ss2_sys_node_pchnl_ctrl_porting_preq            ,
	input  lwnoc_lp_define_package::lwnoc_pchannel_state_t  dsp_ss2_sys_node_pchnl_ctrl_porting_pstate          ,
	input                                                   dsp_ss2_sys_node_syncreq_level_porting_syncreq_level,
	input  [9:0]                                            dsp_ss2_sys_node_timeout_val_porting_timeout_val    ,
	...
	atb_iniu_sys sys_side (
		...
		.flush_req(dsp_ss2_sys_node_flush_req_porting_flush_req),
		...
		.syncreq_level(dsp_ss2_sys_node_syncreq_level_porting_syncreq_level),
		...
		.timeout_val(dsp_ss2_sys_node_timeout_val_porting_timeout_val));
...
//[UHDL]Content End [md5:4eecd3b30ac478a7a2ed90372606ddd4]
