// atb_funnel_bridge_10to1.sv — 10-to-1 ATB round-robin bridge wrapper.
// Wraps atb_funnel_bridge #10 with individually-named per-channel ports
// for UHDL Bundle connect compatibility.

module atb_funnel_bridge_10to1 #(
    ...
    logic [10-1:0] s_atvalids;
    logic [10-1:0] s_atreadys;
    logic [10-1:0][ATB_ID_WIDTH-1:0] s_atids;
    logic [10-1:0][ATB_DATA_WIDTH-1:0] s_atdatas;
    logic [10-1:0][3:0] s_atbytess;
    logic [10-1:0] s_afreadys;
    logic [10-1:0] s_afvalids;
    logic [10-1:0] s_syncreqs;
    logic [10-1:0] s_atwakeup_ins;
