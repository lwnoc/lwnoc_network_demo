// atb_funnel_bridge_6to1.sv — 6-to-1 ATB round-robin bridge wrapper.
// Wraps atb_funnel_bridge #6 with individually-named per-channel ports
// for UHDL Bundle connect compatibility.

module atb_funnel_bridge_6to1 #(
    ...
    logic [6-1:0] s_atvalids;
    logic [6-1:0] s_atreadys;
    logic [6-1:0][ATB_ID_WIDTH-1:0] s_atids;
    logic [6-1:0][ATB_DATA_WIDTH-1:0] s_atdatas;
    logic [6-1:0][3:0] s_atbytess;
    logic [6-1:0] s_afreadys;
    logic [6-1:0] s_afvalids;
    logic [6-1:0] s_syncreqs;
    logic [6-1:0] s_atwakeup_ins;
