// atb_funnel_ingress_aggregator_3to1.sv — 3-to-1 per-channel ATB aggregator.

module atb_funnel_ingress_aggregator_3to1 #(
    ...
    output logic [3-1:0] atvalids,
    output logic [3-1:0] afreadys,
    output logic [3-1:0][ATB_ID_WIDTH-1:0] atids,
    output logic [3-1:0][ATB_DATA_WIDTH-1:0] atdatas,
    output logic [3-1:0][3:0] atbytess,
    input  logic [3-1:0] atreadys,
    input  logic [3-1:0] afvalids,
    input  logic [3-1:0] syncreqs
);
    genvar i;
    generate for(i=0;i<3;i++) begin:g
    ...
    generate for(i=0;i<3;i++) begin:u
