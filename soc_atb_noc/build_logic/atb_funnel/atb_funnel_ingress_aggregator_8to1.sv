// atb_funnel_ingress_aggregator_8to1.sv — 8-to-1 per-channel ATB aggregator.

module atb_funnel_ingress_aggregator_8to1 #(
    ...
    output logic [8-1:0] atvalids,
    output logic [8-1:0] afreadys,
    output logic [8-1:0][ATB_ID_WIDTH-1:0] atids,
    output logic [8-1:0][ATB_DATA_WIDTH-1:0] atdatas,
    output logic [8-1:0][3:0] atbytess,
    input  logic [8-1:0] atreadys,
    input  logic [8-1:0] afvalids,
    input  logic [8-1:0] syncreqs
);
    genvar i;
    ...
    generate for(i=0;i<8;i++) begin:u
