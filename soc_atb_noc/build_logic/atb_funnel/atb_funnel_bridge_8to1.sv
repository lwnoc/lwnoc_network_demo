// atb_funnel_bridge_8to1.sv — 8-to-1 ATB round-robin bridge wrapper.
// Wraps atb_funnel_bridge #8 with individually-named per-channel ports
// for UHDL Bundle connect compatibility.

module atb_funnel_bridge_8to1 #(
    ...
    logic [8-1:0] s_atvalids;
    logic [8-1:0] s_atreadys;
    logic [8-1:0][ATB_ID_WIDTH-1:0] s_atids;
    logic [8-1:0][ATB_DATA_WIDTH-1:0] s_atdatas;
    logic [8-1:0][3:0] s_atbytess;
    logic [8-1:0] s_afreadys;
    logic [8-1:0] s_afvalids;
    logic [8-1:0] s_syncreqs;
    logic [8-1:0] s_atwakeup_ins;
