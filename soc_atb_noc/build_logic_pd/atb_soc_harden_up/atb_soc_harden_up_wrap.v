...
module atb_soc_harden_up_wrap (
  ...
  atb_soc_harden_dn_wrap u_atb_soc_harden_dn_wrap (
    ...
    .camera_ss_clk_sys(camera_ss_clk_sys),
    .camera_ss_rst_sys_n(camera_ss_rst_sys_n),
    ...
    .mipi_ss_clk_sys(mipi_ss_clk_sys),
    .mipi_ss_rst_sys_n(mipi_ss_rst_sys_n),
    ...
    .debug_tniu_ss_clk_sys(debug_tniu_ss_clk_sys),
    .debug_tniu_ss_rst_sys_n(debug_tniu_ss_rst_sys_n),
