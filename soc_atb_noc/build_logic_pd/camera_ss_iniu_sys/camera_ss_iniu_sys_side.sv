module camera_ss_iniu_sys_side #(
...
// Real-subIP anchored wrapper: iniu sys-side ingress + iniu noc-side egress.
  ...
  camera_ss_atb_iniu_sys #(.FIFO_DEPTH(FIFO_DEPTH)) u_real_iniu_sys (
    .clk_atb_s(clk),
    .rstn_atb_s(rst_n),
  ...
  camera_ss_atb_iniu_noc #(.FIFO_DEPTH(FIFO_DEPTH)) u_real_iniu_noc (
    .clk_atb_m(clk),
    .rstn_atb_m(rst_n),
