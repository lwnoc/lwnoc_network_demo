module debug_tniu_ss_atb_tniu_noc
...
debug_tniu_ss_flush_dummy_mst u_flush_dummy_mst (
    .clk        (clk_atb_s      ),
    .rst_n      (rstn_atb_s     ),
    .s_atvalid  (s_atvalid      ),
    .s_atready  (s_atready      ),
...
debug_tniu_ss_trace_data_default_slv u_trace_data_default_slv (
    .clk        (clk_atb_s      ),
    .rst_n      (rstn_atb_s     ),
