module top_nouvm;
    ...
    always @(posedge clk_src) begin
        ...
        if (enable_trace && rstn_src && u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_vld) begin
            $display("[%0t] TNIU0 local req vld=%0b rdy=%0b opcode=%0b addr=0x%08h data=0x%08h strb=0x%0h tgt=0x%0h psel_pre=%0b penable_pre=%0b psel_reg=%0b pready_reg=%0b rsp_apb_vld=%0b out_rsp_vld=%0b", $time,
                u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_vld,
                u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_rdy,
                u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_pld.cmn.opcode,
                u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_pld.req.addr,
                u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_pld.req.data,
                u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_pld.req.strb,
                u_dut.u_tniu0.u_sts_tniu_noc.req_apb_tniu_pld.cmn.tgt_id,
                u_dut.u_tniu0.u_sts_tniu_noc.psel_pre_dec,
                u_dut.u_tniu0.u_sts_tniu_noc.penable_pre_dec,
                u_dut.u_tniu0.u_sts_tniu_noc.psel_reg,
                u_dut.u_tniu0.u_sts_tniu_noc.pready_reg,
                u_dut.u_tniu0.u_sts_tniu_noc.rsp_apb_tniu_vld,
                u_dut.tniu0_rsp_vld);
        end
        if (enable_trace && rstn_src && (u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.psel ||
                                         u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.rsp_pending ||
                                         u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.fifo_in_rsp_vld)) begin
            $display("[%0t] TNIU0 APB state fifo_out_vld=%0b fifo_out_rdy=%0b psel=%0b penable=%0b pwrite=%0b paddr=0x%08h pwdata=0x%08h prdata=0x%08h pready=%0b ptgt=0x%0h rsp_pending=%0b fifo_rsp_vld=%0b fifo_rsp_rdy=%0b reg0=0x%08h", $time,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.fifo_out_req_vld,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.fifo_out_req_rdy,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.psel,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.penable,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.pwrite,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.paddr,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.pwdata,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.prdata,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.pready,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.ptgt_id,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.rsp_pending,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.fifo_in_rsp_vld,
                u_dut.u_tniu0.u_sts_tniu_noc.u_sts_tniu_apb_noc.fifo_in_rsp_rdy,
                u_dut.u_tniu0.u_sts_tniu_noc.u_regbank_sts_tniu.debug_en_debug_en);
        end
        ...
        if (enable_trace && rstn_src && (u_dut.u_tniu0.u_sts_tniu_noc.rsp_tniu_sys_vld ||
                                         u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.read_resp_vld ||
                                         u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.stall_buffer_vld ||
                                         u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.trans_cnt != 0)) begin
            $display("[%0t] TNIU0_RSP_AFIFO trans_cnt=%0d read_vld=%0b read_rdy=%0b read_last=%0b stall_vld=%0b stall_rdy=%0b rsp_sys_vld=%0b rsp_sys_rdy=%0b rsp_sys_last=%0b out_vld=%0b out_rdy=%0b out_last=%0b", $time,
                u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.trans_cnt,
                u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.read_resp_vld,
                u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.read_resp_rdy,
                u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.read_resp_last,
                u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.stall_buffer_vld,
                u_dut.u_tniu0.u_sts_tniu_noc.u_tniu_noc_afifo_slv.stall_buffer_rdy,
                u_dut.u_tniu0.u_sts_tniu_noc.rsp_tniu_sys_vld,
                u_dut.u_tniu0.u_sts_tniu_noc.rsp_tniu_sys_rdy,
                u_dut.u_tniu0.u_sts_tniu_noc.rsp_tniu_sys_pld.rsp.last,
                u_dut.tniu0_rsp_vld,
                u_dut.tniu0_rsp_rdy,
                u_dut.tniu0_rsp_pld.rsp.last);
        end
        ...
        if (enable_trace && rstn_src && u_dut.u_iniu.u_sts_iniu_sys.rsp_vld_temp) begin
            $display("[%0t] INIU_SYS rsp_temp vld=%0b rdy=%0b opcode=%0b resp=%0b last=%0b", $time,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_vld_temp,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_rdy_temp,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_pld_temp.cmn.opcode,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_pld_temp.rsp.resp,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_pld_temp.rsp.last);
        end
        if (enable_trace && rstn_src && (u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.bundle_b_vld ||
                                         s_bvalid)) begin
            $display("[%0t] WR_CH rsp_vld=%0b rsp_rdy=%0b bundle_b_vld=%0b bundle_b_rdy=%0b s_bvalid=%0b s_bready=%0b bid=%0d bresp=%0d", $time,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_b_vld,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_b_rdy,
                s_bvalid,
                s_bready,
                s_bid,
                s_bresp);
        end
        if (enable_trace && rstn_src && u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_vld) begin
            $display("[%0t] WR_CH in_rsp vld=%0b rdy=%0b txn_id=%0d last=%0b up_b_vld=%0b up_b_rdy=%0b", $time,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_pld.cmn.txn_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_pld.rsp.last,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_b_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_b_rdy);
        end
        if (enable_trace && rstn_src && (u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.alloc_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_rsp_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_b_vld)) begin
            $display("[%0t] WR_MAP alloc_vld=%0b alloc_rdy=%0b alloc_id=%0d remap_id=%0d complete_idx=%0d complete_rdy=%0b retire_id=%0d b_vld=%0b b_rdy=%0b b_id=%0d",
                $time,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.alloc_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.alloc_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.alloc_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.wr_id_alloc,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.complete_idx,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.complete_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.check_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_b_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_b_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_b_pld.bid);
        end
        if (enable_trace && rstn_src && (u_dut.u_iniu.u_sts_iniu_sys.bundle_aw_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_aw_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_aw_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.bundle_w_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_w_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_w_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.merged_req_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.out_req_vld)) begin
            $display("[%0t] WR_PIPE s_aw_vld=%0b s_aw_rdy=%0b s_aw_addr=0x%08h bundle_aw_vld=%0b bundle_aw_rdy=%0b bundle_aw_addr=0x%08h chnl_in_aw_vld=%0b chnl_in_aw_rdy=%0b chnl_in_aw_addr=0x%08h s_w_vld=%0b s_w_rdy=%0b s_w_data=0x%08h bundle_w_vld=%0b bundle_w_rdy=%0b bundle_w_data=0x%08h chnl_in_w_vld=%0b chnl_in_w_rdy=%0b chnl_in_w_data=0x%08h aw_seen=%0b aw_hold=%0b aw_vld=%0b aw_rdy=%0b aw_id=%0d w_seen=%0b w_hold=%0b w_vld=%0b w_rdy=%0b w_data=0x%08h merged_vld=%0b merged_rdy=%0b merged_data=0x%08h out_req_vld=%0b out_req_rdy=%0b out_txn=%0d out_data=0x%08h",
                ...
                s_awready,
                s_awaddr,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_aw_vld,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_aw_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_aw_pld.awaddr,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_aw_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_aw_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_aw_pld.awaddr,
                s_wvalid,
                s_wready,
                s_wdata,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_w_vld,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_w_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_w_pld.wdata,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_w_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_w_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.upstrm_w_pld.wdata,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.aw_stage_seen,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.aw_hold_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_aw_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_aw_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_aw_pld.awid,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.w_stage_seen,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.w_hold_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_w_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_w_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.fifo_out_w_pld.wdata,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.merged_req_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.merged_req_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.merged_req_pld.req.data,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.out_req_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.out_req_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.out_req_pld.cmn.txn_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.out_req_pld.req.data);
        end
            if (enable_trace && rstn_src && (u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.in_rsp_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.bundle_r_vld ||
                             s_rvalid)) begin
                $display("[%0t] RD_CH ar_fifo_vld=%0b ar_fifo_rdy=%0b ar_id=%0d alloc_vld=%0b alloc_rdy=%0b remap_id=%0d out_req_vld=%0b out_req_rdy=%0b out_txn=%0d in_rsp_vld=%0b in_rsp_rdy=%0b complete_idx=%0d r_vld=%0b r_rdy=%0b rid=%0d last=%0b",
                $time,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_pld.cmn.txn_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.alloc_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.alloc_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.rd_id_alloc,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_pld.cmn.txn_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.in_rsp_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.in_rsp_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.complete_idx,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_r_vld,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_r_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_r_pld.rid,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_r_pld.rlast);
            end
            if (enable_trace && rstn_src && (u_dut.u_iniu.u_sts_iniu_sys.bundle_ar_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_hold_vld)) begin
                ...
                $time,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_ar_vld,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_ar_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.bundle_ar_pld.araddr,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.mapped_ar_tgt_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_in_ar_pld.req.addr,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_in_ar_pld.cmn.tgt_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_pld.req.addr,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_pld.cmn.tgt_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_hold_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_hold_pld.req.addr,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_hold_pld.cmn.tgt_id);
            end
            if (enable_trace && rstn_src && (s_arvalid ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_stage_seen ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_in_ar_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_hold_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_vld)) begin
                ...
                s_arready,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_stage_seen,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_in_hold_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_in_ar_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_in_ar_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.fifo_out_ar_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.ar_hold_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.alloc_vld,
                ...
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_pld.cmn.tgt_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_rd_chnl.out_req_pld.req.addr);
            end
            if (enable_trace && rstn_src && (u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_req_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.rd_req_vld ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.out_req_vld)) begin
                ...
                $time,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_req_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_req_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.wr_req_pld.cmn.txn_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.rd_req_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.rd_req_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.rd_req_pld.cmn.txn_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.arb_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.arb_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.arb_pld.cmn.txn_id,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.out_req_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.out_req_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.out_req_pld.cmn.opcode,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.out_req_pld.cmn.txn_id);
            end
        if (enable_trace && rstn_src && (u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.trans_cnt != 0 ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_vld ||
                                         u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.stall_buffer_vld)) begin
            $display("[%0t] AFIFO_SRC trans_cnt=%0d req_hs=%0b req_last=%0b read_rsp_vld=%0b read_rsp_rdy=%0b read_rsp_last=%0b stall_vld=%0b stall_rdy=%0b rsp_m_vld=%0b rsp_m_rdy=%0b rsp_last=%0b",
                $time,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.trans_cnt,
                (u_dut.u_iniu.u_sts_iniu_sys.req_vld_temp && u_dut.u_iniu.u_sts_iniu_sys.req_rdy_temp),
                u_dut.u_iniu.u_sts_iniu_sys.req_last_temp,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_last,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.stall_buffer_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.stall_buffer_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_vld_temp,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_rdy_temp,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_last_temp);
        end
            if (enable_trace && rstn_src && (u_dut.u_iniu.tmp_rsp_wptr_async != '0 ||
                             u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.u_rsp_afifo_src.wptr_async_inner_SIZE_ONLY != '0 ||
                             u_dut.u_iniu.tmp_rsp_rptr_async != '0 ||
                             u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_vld ||
                             u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_rdy ||
                             u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_vld)) begin
                ...
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_vld,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_rdy,
                u_dut.u_iniu.u_sts_iniu_noc.rsp_m_last,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_pld[0],
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.u_rsp_afifo_src.s_handshake,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.u_rsp_afifo_src.winc,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.u_rsp_afifo_src.wptr_sync,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.u_rsp_afifo_src.wptr_async_inner_SIZE_ONLY,
                u_dut.u_iniu.tmp_rsp_wptr_async,
                u_dut.u_iniu.tmp_rsp_rptr_async,
                u_dut.u_iniu.tmp_rsp_rptr_sync,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_vld,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_rdy,
                u_dut.u_iniu.u_sts_iniu_sys.u_sts_iniu_afifo_src.read_resp_last,
                u_dut.u_iniu.u_sts_iniu_sys.rsp_vld_temp,
            ...
            if (enable_trace && rstn_src && (u_dut.u_iniu.tmp_req_wptr_async != '0 ||
                             u_dut.u_iniu.tmp_req_rptr_async != '0 ||
                             u_dut.u_iniu.tmp_req_rptr_sync != '0 ||
                             u_dut.u_iniu.u_sts_iniu_sys.req_vld_temp ||
                             u_dut.u_iniu.u_sts_iniu_noc.req_s_vld)) begin
                ...
                $time,
                u_dut.u_iniu.u_sts_iniu_sys.req_vld_temp,
                u_dut.u_iniu.u_sts_iniu_sys.req_rdy_temp,
                u_dut.u_iniu.u_sts_iniu_sys.req_last_temp,
                u_dut.u_iniu.tmp_req_wptr_async,
                u_dut.u_iniu.tmp_req_rptr_async,
                u_dut.u_iniu.tmp_req_rptr_sync,
                u_dut.u_iniu.u_sts_iniu_noc.req_s_vld,
                u_dut.u_iniu.u_sts_iniu_noc.req_s_rdy,
                u_dut.u_iniu.u_sts_iniu_noc.req_s_last_afifo);
            end
    end

    always @(posedge clk_dst) begin
        if (enable_trace && rstn_dst && (u_dut.iniu_rsp_vld ||
                                         u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_vld)) begin
            $display("[%0t] INIU_NOC_DST rsp_in_vld=%0b rsp_in_rdy=%0b afifo_in_vld=%0b afifo_in_rdy=%0b afifo_in_last=%0b wptr_raw=0x%0h wptr_out=0x%0h",
                ...
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_vld,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_rdy,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.rsp_ext_m_last,
                u_dut.u_iniu.u_sts_iniu_noc.u_sts_iniu_afifo_dst.u_rsp_afifo_src.wptr_async_inner_SIZE_ONLY,
                u_dut.u_iniu.tmp_rsp_wptr_async);
        end
            if (enable_trace && rstn_dst && (u_dut.u_tniu0.u_sts_tniu_sys.rsp_apb_tniu_vld ||
                             u_dut.u_tniu0.u_sts_tniu_sys.u_tniu_sys_afifo_mst.rsp_m_vld ||
                             u_dut.u_tniu0.u_sts_tniu_sys.u_sts_tniu_apb_sys.out_rsp_vld)) begin
                $display("[%0t] TNIU0_SYS_RSP apb_vld=%0b apb_rdy=%0b apb_last=%0b afifo_rsp_vld=%0b afifo_rsp_rdy=%0b afifo_rsp_last=%0b", $time,
                u_dut.u_tniu0.u_sts_tniu_sys.u_sts_tniu_apb_sys.out_rsp_vld,
                u_dut.u_tniu0.u_sts_tniu_sys.u_sts_tniu_apb_sys.out_rsp_rdy,
                u_dut.u_tniu0.u_sts_tniu_sys.u_sts_tniu_apb_sys.out_rsp_pld.rsp.last,
                u_dut.u_tniu0.u_sts_tniu_sys.rsp_apb_tniu_vld,
                u_dut.u_tniu0.u_sts_tniu_sys.rsp_apb_tniu_rdy,
                u_dut.u_tniu0.u_sts_tniu_sys.rsp_apb_tniu_pld.rsp.last);
            end
    end
    ...
    task automatic set_order_test_stall(
        input int slow_slot,
        input int slow_cycles
    );
        begin
            set_apb_stall_cycles(0);
            u_dut.u_sys00.stall_cycles_cfg = (slow_slot == 0) ? slow_cycles : 0;
            u_dut.u_sys10.stall_cycles_cfg = (slow_slot == 1) ? slow_cycles : 0;
            u_dut.u_sys20.stall_cycles_cfg = (slow_slot == 2) ? slow_cycles : 0;
        end
    endtask

    task automatic issue_axi_read_req(
        input logic [31:0] addr,
        input logic [7:0]  id
    );
        int cycle;
        begin
            ...
            if (!(s_arvalid && s_arready)) begin
                s_arvalid = 1'b0;
                $fatal(1, "READ issue timeout addr=0x%08h id=%0d", addr, id);
            end
    ...
    task automatic collect_axi_read_rsp(
        output logic [AXI_RID_WIDTH-1:0]  rsp_id,
        output logic [AXI_DATA_WIDTH-1:0] rsp_data,
        ...
        begin
            ...
            $fatal(1, "READ response collection timeout");
        end
    endtask

    task automatic issue_axi_write_req(
        input  logic [31:0] addr,
        input  logic [31:0] data,
        input  logic [7:0]  id,
        output logic [$clog2(STS_INIU_OT_TOTAL)-1:0] alloc_idx
    );
        bit aw_done;
        bit w_done;
        int cycle;
        begin
            ...
            while (!aw_done || !w_done) begin
                @(posedge clk_src);
                if (!aw_done && s_awready) begin
                    aw_done = 1'b1;
                end
                if (!w_done && s_wready) begin
                    w_done = 1'b1;
                end
            end
            ...
            for (cycle = 0; cycle < SRC_TIMEOUT_CYCLES; cycle++) begin
                @(posedge clk_src);
                if (u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.alloc_vld &&
                    u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.alloc_rdy &&
                    (u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.alloc_id == id)) begin
                    alloc_idx = u_dut.u_iniu.u_sts_iniu_sys.u_sts_axi_iniu_sys_side.u_iniu_wr_chnl.wr_id_alloc;
                    return;
                end
            end

            $fatal(1, "WRITE alloc timeout addr=0x%08h id=%0d", addr, id);
        end
    endtask

    task automatic collect_axi_b_rsp(
        output logic [AXI_BID_WIDTH-1:0] rsp_id,
        output logic [1:0]               rsp_resp
    );
        int cycle;
        begin
            ...
            $fatal(1, "WRITE response collection timeout");
        end
    endtask

    task automatic run_tc038_axi_id_ordering_random();
        logic [31:0] base_addr [0:2];
        logic [31:0] same_rd_addr [0:2];
        logic [31:0] same_rd_data [0:2];
        logic [7:0]  same_rd_id;
        logic [7:0]  same_wr_id;
        logic [7:0]  diff_rd_slow_id;
        logic [7:0]  diff_rd_fast_id;
        logic [7:0]  diff_wr_slow_id;
        logic [7:0]  diff_wr_fast_id;
        logic [31:0] diff_rd_slow_data;
        logic [31:0] diff_rd_fast_data;
        logic [31:0] diff_wr_slow_data;
        logic [31:0] diff_wr_fast_data;
        logic [AXI_RID_WIDTH-1:0]  rsp_rid;
        logic [AXI_DATA_WIDTH-1:0] rsp_rdata;
        logic [1:0]                rsp_rresp;
        logic                      rsp_rlast;
        logic [AXI_BID_WIDTH-1:0]  rsp_bid;
        logic [1:0]                rsp_bresp;
        logic [$clog2(STS_INIU_OT_TOTAL)-1:0] wr_alloc_idx [0:2];
        int round;
        int slow_slot;
        int mid_slot;
        int fast_slot;
        bit diff_rd_reorder_seen;
        bit diff_wr_reorder_seen;
        begin
            base_addr[0] = 32'h0000_2000;
            base_addr[1] = 32'h0000_6000;
            base_addr[2] = 32'h0000_A000;
            diff_rd_reorder_seen = 1'b0;
            diff_wr_reorder_seen = 1'b0;

            for (round = 0; round < 8; round++) begin
                slow_slot = $urandom_range(0, 2);
                mid_slot  = (slow_slot + 1 + $urandom_range(0, 1)) % 3;
                fast_slot = 3 - slow_slot - mid_slot;

                same_rd_addr[0] = base_addr[slow_slot];
                same_rd_addr[1] = base_addr[mid_slot];
                same_rd_addr[2] = base_addr[fast_slot];
                same_rd_data[0] = 32'h1100_0000 | (round << 8) | slow_slot;
                same_rd_data[1] = 32'h2200_0000 | (round << 8) | mid_slot;
                same_rd_data[2] = 32'h3300_0000 | (round << 8) | fast_slot;
                same_rd_id      = 8'h40 + round;
                same_wr_id      = 8'h60 + round;
                diff_rd_slow_id = 8'h80 + (round << 1);
                diff_rd_fast_id = diff_rd_slow_id + 1'b1;
                diff_wr_slow_id = 8'hA0 + (round << 1);
                diff_wr_fast_id = diff_wr_slow_id + 1'b1;
                diff_rd_slow_data = 32'h4400_0000 | round;
                diff_rd_fast_data = 32'h5500_0000 | round;
                diff_wr_slow_data = 32'h6600_0000 | round;
                diff_wr_fast_data = 32'h7700_0000 | round;

                set_apb_stall_cycles(0);
                do_axi_write(same_rd_addr[0], same_rd_data[0], 8'h01 + round, 2'b00);
                do_axi_write(same_rd_addr[1], same_rd_data[1], 8'h11 + round, 2'b00);
                do_axi_write(same_rd_addr[2], same_rd_data[2], 8'h21 + round, 2'b00);

                set_order_test_stall(slow_slot, 6 + (round % 3));
                issue_axi_read_req(same_rd_addr[0], same_rd_id);
                issue_axi_read_req(same_rd_addr[1], same_rd_id);
                issue_axi_read_req(same_rd_addr[2], same_rd_id);
                for (int rsp_idx = 0; rsp_idx < 3; rsp_idx++) begin
                    collect_axi_read_rsp(rsp_rid, rsp_rdata, rsp_rresp, rsp_rlast);
                    if (rsp_rid !== same_rd_id) begin
                        $fatal(1, "tc038 same-id read rid mismatch round=%0d exp=%0d act=%0d", round, same_rd_id, rsp_rid);
                    end
                    if (rsp_rresp !== 2'b00 || !rsp_rlast) begin
                        $fatal(1, "tc038 same-id read resp invalid round=%0d idx=%0d resp=%0d last=%0b", round, rsp_idx, rsp_rresp, rsp_rlast);
                    end
                    if (rsp_rdata !== same_rd_data[rsp_idx]) begin
                        $fatal(1, "tc038 same-id read order broken round=%0d idx=%0d exp_data=0x%08h act_data=0x%08h", round, rsp_idx, same_rd_data[rsp_idx], rsp_rdata);
                    end
                end

                issue_axi_write_req(same_rd_addr[0], 32'h8800_0000 | round, same_wr_id, wr_alloc_idx[0]);
                issue_axi_write_req(same_rd_addr[1], 32'h9900_0000 | round, same_wr_id, wr_alloc_idx[1]);
                issue_axi_write_req(same_rd_addr[2], 32'hAA00_0000 | round, same_wr_id, wr_alloc_idx[2]);
                for (int rsp_idx = 0; rsp_idx < 3; rsp_idx++) begin
                    collect_axi_b_rsp(rsp_bid, rsp_bresp);
                    if (rsp_bid !== same_wr_id || rsp_bresp !== 2'b00) begin
                        $fatal(1, "tc038 same-id write response invalid round=%0d idx=%0d bid=%0d bresp=%0d", round, rsp_idx, rsp_bid, rsp_bresp);
                    end
                end

                set_apb_stall_cycles(0);
                do_axi_write(base_addr[slow_slot], diff_rd_slow_data, 8'hC0 + round, 2'b00);
                do_axi_write(base_addr[fast_slot], diff_rd_fast_data, 8'hD0 + round, 2'b00);

                set_order_test_stall(slow_slot, 8 + (round % 2));
                issue_axi_read_req(base_addr[slow_slot], diff_rd_slow_id);
                issue_axi_read_req(base_addr[fast_slot], diff_rd_fast_id);

                collect_axi_read_rsp(rsp_rid, rsp_rdata, rsp_rresp, rsp_rlast);
                if (rsp_rid == diff_rd_fast_id) begin
                    diff_rd_reorder_seen = 1'b1;
                    if (rsp_rdata !== diff_rd_fast_data) begin
                        $fatal(1, "tc038 diff-id read first fast data mismatch round=%0d exp=0x%08h act=0x%08h", round, diff_rd_fast_data, rsp_rdata);
                    end
                end else if (rsp_rid == diff_rd_slow_id) begin
                    if (rsp_rdata !== diff_rd_slow_data) begin
                        $fatal(1, "tc038 diff-id read first slow data mismatch round=%0d exp=0x%08h act=0x%08h", round, diff_rd_slow_data, rsp_rdata);
                    end
                end else begin
                    $fatal(1, "tc038 diff-id read unexpected first rid round=%0d rid=%0d", round, rsp_rid);
                end

                collect_axi_read_rsp(rsp_rid, rsp_rdata, rsp_rresp, rsp_rlast);
                if (rsp_rid == diff_rd_fast_id) begin
                    if (rsp_rdata !== diff_rd_fast_data) begin
                        $fatal(1, "tc038 diff-id read second fast data mismatch round=%0d exp=0x%08h act=0x%08h", round, diff_rd_fast_data, rsp_rdata);
                    end
                end else if (rsp_rid == diff_rd_slow_id) begin
                    if (rsp_rdata !== diff_rd_slow_data) begin
                        $fatal(1, "tc038 diff-id read second slow data mismatch round=%0d exp=0x%08h act=0x%08h", round, diff_rd_slow_data, rsp_rdata);
                    end
                end else begin
                    $fatal(1, "tc038 diff-id read unexpected second rid round=%0d rid=%0d", round, rsp_rid);
                end

                issue_axi_write_req(base_addr[slow_slot], diff_wr_slow_data, diff_wr_slow_id, wr_alloc_idx[0]);
                issue_axi_write_req(base_addr[fast_slot], diff_wr_fast_data, diff_wr_fast_id, wr_alloc_idx[1]);

                collect_axi_b_rsp(rsp_bid, rsp_bresp);
                if (rsp_bid == diff_wr_fast_id) begin
                    diff_wr_reorder_seen = 1'b1;
                end else if (rsp_bid != diff_wr_slow_id) begin
                    $fatal(1, "tc038 diff-id write unexpected first bid round=%0d bid=%0d", round, rsp_bid);
                end
                if (rsp_bresp !== 2'b00) begin
                    $fatal(1, "tc038 diff-id write first bresp invalid round=%0d bresp=%0d", round, rsp_bresp);
                end

                collect_axi_b_rsp(rsp_bid, rsp_bresp);
                if ((rsp_bid != diff_wr_fast_id) && (rsp_bid != diff_wr_slow_id)) begin
                    $fatal(1, "tc038 diff-id write unexpected second bid round=%0d bid=%0d", round, rsp_bid);
                end
                if (rsp_bresp !== 2'b00) begin
                    $fatal(1, "tc038 diff-id write second bresp invalid round=%0d bresp=%0d", round, rsp_bresp);
                end
            ...
            if (!diff_rd_reorder_seen) begin
                $fatal(1, "tc038 did not observe different-id read reordering across randomized rounds");
            end
            if (!diff_wr_reorder_seen) begin
                $fatal(1, "tc038 did not observe different-id write reordering across randomized rounds");
            end
        end
    endtask
    ...
    initial begin
        ...
        end else if (testcase == "tc038_axi_id_ordering_random") begin
            run_tc038_axi_id_ordering_random();
        end else begin
