...
#(
    ...
    input  lwnoc_lp_req_signal_t                    s_niu_lp_hub_rx_req             ,
    output lwnoc_lp_req_signal_t                    s_niu_lp_hub_tx_req             ,
...
//===========================================================================
    ...
    assign v_stage_1_hub_rx_req[1]  = s_niu_lp_hub_rx_req;
    ...
    assign s_niu_lp_hub_tx_req      = v_stage_1_hub_tx_req[1];
