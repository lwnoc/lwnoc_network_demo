...
(
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            tx_req_cdc <= lwnoc_lp_req_signal_t'{
                stg1_req_or : rx_req_sync.deny_or ? 1'b1 : rx_req_sync.stg1_req_and,
                stg1_req_and: rx_req_sync.deny_or ? 1'b1 : rx_req_sync.stg1_req_and,
                stg2_req_or : rx_req_sync.deny_or ? 1'b1 : rx_req_sync.stg2_req_and,
                stg2_req_and: rx_req_sync.deny_or ? 1'b1 : rx_req_sync.stg2_req_and,
                state       : rx_req_sync.deny_or ? LP_LEVEL0_NOP : rx_req_sync.state,
