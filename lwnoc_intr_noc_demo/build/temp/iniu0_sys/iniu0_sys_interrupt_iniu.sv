module iniu0_sys_interrupt_iniu
...
//===========================================================================
    ...
    generate
        for(genvar i = 0; i < INTERRUPT_NUM; i=i+1) begin : gen_interrupt_iniu_event_recorder
            iniu0_sys_interrupt_iniu_event_recorder #(
                .INTERRUPT_ID   (i                      )
    ...
    // APB reg bank
    //===========================================================================
    iniu0_sys_interrupt_iniu_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
