//[UHDL]Content Start [md5:8686b54956f61fef2eafb50cde1181b6]
module tniu1 (
	input           clk_sys_clk                                          ,
	...
	input  [9:0]    tniu1_top_timeout_val_porting_timeout_val            ,
	input  [8:0]           tniu1_top_lp_hub_porting_lp_hub_rx_req               ,
	output [8:0]          tniu1_top_lp_hub_porting_lp_hub_tx_req               ,
	input  [7:0]    tniu1_sys_tniu_tgt_id_porting_tniu_tgt_id            ,
	output [4095:0] tniu1_sys_v_interrupt_porting_v_interrupt            ,
	output [127:0]  tniu1_sys_v_merge_interrupt_porting_v_merge_interrupt,
	input  [31:0]   tniu1_sys_apb_porting_p_addr                         ,
	input           tniu1_sys_apb_porting_p_enable                       ,
	output [31:0]   tniu1_sys_apb_porting_p_rdata                        ,
	output          tniu1_sys_apb_porting_p_ready                        ,
	input           tniu1_sys_apb_porting_p_sel                          ,
	output          tniu1_sys_apb_porting_p_slverr                       ,
	input  [31:0]   tniu1_sys_apb_porting_p_wdata                        ,
	input           tniu1_sys_apb_porting_p_write                        ,
	input  [9:0]    tniu1_sys_timeout_val_porting_timeout_val            ,
	input           tniu1_ring_local_tx_porting_local_tx_local_tx_last   ,
	input  [39:0]   tniu1_ring_local_tx_porting_local_tx_local_tx_payload,
	input  [3:0]    tniu1_ring_local_tx_porting_local_tx_local_tx_qos    ,
	output          tniu1_ring_local_tx_porting_local_tx_local_tx_ready  ,
	input  [7:0]    tniu1_ring_local_tx_porting_local_tx_local_tx_srcid  ,
	input  [7:0]    tniu1_ring_local_tx_porting_local_tx_local_tx_tgtid  ,
	input           tniu1_ring_local_tx_porting_local_tx_local_tx_valid  );
	...
	intr_tniu_top_interrupt_tniu_aync_top_side tniu_top (
		...
		.timeout_val(tniu1_top_timeout_val_porting_timeout_val),
		.lp_hub_rx_req(tniu1_top_lp_hub_porting_lp_hub_rx_req),
		.lp_hub_tx_req(tniu1_top_lp_hub_porting_lp_hub_tx_req),
	...
	intr_tniu_sys_interrupt_tniu_aync_sys_side tniu_sys (
		...
		.tniu_tgt_id(tniu1_sys_tniu_tgt_id_porting_tniu_tgt_id),
		.v_interrupt(tniu1_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(tniu1_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(tniu1_sys_apb_porting_p_addr),
		.p_sel(tniu1_sys_apb_porting_p_sel),
		.p_enable(tniu1_sys_apb_porting_p_enable),
		.p_write(tniu1_sys_apb_porting_p_write),
		.p_wdata(tniu1_sys_apb_porting_p_wdata),
		.p_ready(tniu1_sys_apb_porting_p_ready),
		.p_rdata(tniu1_sys_apb_porting_p_rdata),
		.p_slverr(tniu1_sys_apb_porting_p_slverr),
		.wptr_async(tniu_top_TO_tniu_sys_SIG_wptr_async),
		.rptr_async(tniu_sys_TO_tniu_top_SIG_rptr_async),
		.rptr_sync(tniu_sys_TO_tniu_top_SIG_rptr_sync),
		.pld_sync(tniu_top_TO_tniu_sys_SIG_pld_sync),
		.timeout_val(tniu1_sys_timeout_val_porting_timeout_val),
	...
	tniu1_ring ring_wrap (
		...
		.local_tx_local_tx_last(tniu1_ring_local_tx_porting_local_tx_local_tx_last),
		.local_tx_local_tx_payload(tniu1_ring_local_tx_porting_local_tx_local_tx_payload),
		.local_tx_local_tx_qos(tniu1_ring_local_tx_porting_local_tx_local_tx_qos),
		.local_tx_local_tx_ready(tniu1_ring_local_tx_porting_local_tx_local_tx_ready),
		.local_tx_local_tx_srcid(tniu1_ring_local_tx_porting_local_tx_local_tx_srcid),
		.local_tx_local_tx_tgtid(tniu1_ring_local_tx_porting_local_tx_local_tx_tgtid),
		.local_tx_local_tx_valid(tniu1_ring_local_tx_porting_local_tx_local_tx_valid),
...
//[UHDL]Content End [md5:8686b54956f61fef2eafb50cde1181b6]
