//[UHDL]Content Start [md5:8b639aa2f44a9d28369ca3fc184043d7]
module iniu1 (
	input           clk_sys_clk                                          ,
	...
	input  [4095:0] iniu1_sys_v_interrupt_porting_v_interrupt            ,
	input  [7:0]    iniu1_sys_iniu_src_id_porting_iniu_src_id            ,
	input  [31:0]   iniu1_sys_apb_porting_p_addr                         ,
	input           iniu1_sys_apb_porting_p_enable                       ,
	output [31:0]   iniu1_sys_apb_porting_p_rdata                        ,
	output          iniu1_sys_apb_porting_p_ready                        ,
	input           iniu1_sys_apb_porting_p_sel                          ,
	output          iniu1_sys_apb_porting_p_slverr                       ,
	input  [31:0]   iniu1_sys_apb_porting_p_wdata                        ,
	input           iniu1_sys_apb_porting_p_write                        ,
	input  [9:0]    iniu1_sys_timeout_val_porting_timeout_val            ,
	input  [8:0]           iniu1_sys_lp_hub_porting_lp_hub_rx_req               ,
	output [8:0]          iniu1_sys_lp_hub_porting_lp_hub_tx_req               ,
	output          iniu1_ring_local_rx_porting_local_rx_local_rx_last   ,
	output [39:0]   iniu1_ring_local_rx_porting_local_rx_local_rx_payload,
	output [3:0]    iniu1_ring_local_rx_porting_local_rx_local_rx_qos    ,
	input           iniu1_ring_local_rx_porting_local_rx_local_rx_ready  ,
	output [7:0]    iniu1_ring_local_rx_porting_local_rx_local_rx_srcid  ,
	output [7:0]    iniu1_ring_local_rx_porting_local_rx_local_rx_tgtid  ,
	output          iniu1_ring_local_rx_porting_local_rx_local_rx_valid  );
	...
	intr_iniu_sys_interrupt_iniu_aync_sys_side iniu_sys (
		...
		.iniu_src_id(iniu1_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(iniu1_sys_apb_porting_p_addr),
		.p_sel(iniu1_sys_apb_porting_p_sel),
		.p_enable(iniu1_sys_apb_porting_p_enable),
		.p_write(iniu1_sys_apb_porting_p_write),
		.p_wdata(iniu1_sys_apb_porting_p_wdata),
		.p_ready(iniu1_sys_apb_porting_p_ready),
		.p_rdata(iniu1_sys_apb_porting_p_rdata),
		.p_slverr(iniu1_sys_apb_porting_p_slverr),
		...
		.timeout_val(iniu1_sys_timeout_val_porting_timeout_val),
	...
	iniu1_ring ring_wrap (
		...
		.local_rx_local_rx_last(iniu1_ring_local_rx_porting_local_rx_local_rx_last),
		.local_rx_local_rx_payload(iniu1_ring_local_rx_porting_local_rx_local_rx_payload),
		.local_rx_local_rx_qos(iniu1_ring_local_rx_porting_local_rx_local_rx_qos),
		.local_rx_local_rx_ready(iniu1_ring_local_rx_porting_local_rx_local_rx_ready),
		.local_rx_local_rx_srcid(iniu1_ring_local_rx_porting_local_rx_local_rx_srcid),
		.local_rx_local_rx_tgtid(iniu1_ring_local_rx_porting_local_rx_local_rx_tgtid),
		.local_rx_local_rx_valid(iniu1_ring_local_rx_porting_local_rx_local_rx_valid));

endmodule
//[UHDL]Content End [md5:8b639aa2f44a9d28369ca3fc184043d7]
