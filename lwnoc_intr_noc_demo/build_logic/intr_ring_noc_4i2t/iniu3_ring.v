//[UHDL]Content Start [md5:97fa994b04de33980e0af2cbe0c59186]
module iniu3_ring (
	input         clk                       ,
	input         rst_n                     ,
	...
	//module inst.
	intr_ring_sta_interrupt_req_ring_station #(
		.NODE_ID    (3),
		.NODE_COUNT (6),
		.HAS_INIU   (1'b1),
		.HAS_TNIU   (1'b0)) ring_sta (
	...
	intr_ring_lnk_interrupt_req_ring_link link_cw (
		.clk(clk),
		.rst_n(rst_n),
	...
	intr_ring_lnk_interrupt_req_ring_link link_ccw (
		.clk(clk),
		.rst_n(rst_n),
...
//[UHDL]Content End [md5:97fa994b04de33980e0af2cbe0c59186]
