module pcie_eth_ss_iniu_interrupt_iniu
...
//===========================================================================
    ...
    generate
        for(genvar i = 0; i < INTERRUPT_NUM; i=i+1) begin : gen_interrupt_iniu_event_recorder
            pcie_eth_ss_iniu_interrupt_iniu_event_recorder #(
                .INTERRUPT_ID   (i                      )
    ...
    pcie_eth_ss_iniu_interrupt_iniu_arb #(
    ...
    // APB reg bank
    //===========================================================================
    pcie_eth_ss_iniu_interrupt_iniu_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
        ...
        .parity_err     (regbank_parity_err      )
    );

    //===========================================================================
    // lut
    //===========================================================================
    pcie_eth_ss_iniu_interrupt_iniu_lut #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    logic           ecc_rdy;
    ecc_pkg         ecc_pld;
    logic [33:0]    ecc_data_in;
    logic [40:0]    ecc_encode_data;
    ...
    fcip_ecc_enc #(
        .DATA_WIDTH     (34                     )
    ) u_interrupt_iniu_ecc_enc (
        .data           (ecc_data_in            ),
        .encode_data    (ecc_encode_data        )
    );

    // Keep phase-1 interface compatibility: payload carries 6 check bits only.
    assign ecc_pld.ecc = ecc_encode_data[6:1];
