module lwnoc_station_buffer #(
    parameter  integer unsigned  VC_BUF_DEPTH     = `INTR_NETWORK_STATION_VC_BUF_DEPTH,
    parameter  integer unsigned  VC_AFULL_LEVEL   = `INTR_NETWORK_STATION_VC_AFULL_LEVEL,
    parameter  integer unsigned  PLD_WIDTH        = `INTR_NETWORK_STATION_PLD_WIDTH,
