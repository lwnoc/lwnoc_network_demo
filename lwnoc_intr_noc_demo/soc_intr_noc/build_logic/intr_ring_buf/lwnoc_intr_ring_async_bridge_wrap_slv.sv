module lwnoc_intr_ring_async_bridge_wrap_slv #(
    ...
    // FUSA ECC error outputs (nring mst-side decode)
    ...
    logic               nring_sb_err_w, nring_db_err_w;
    ...
    lwnoc_intr_ring_async_bridge_mst #(
        ...
        .sb_err        (nring_sb_err_w              ),
        .db_err        (nring_db_err_w              )
    );

    assign nring_sb_err = nring_sb_err_w;
    assign nring_db_err = nring_db_err_w;
