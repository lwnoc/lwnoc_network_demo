//[UHDL]Content Start [md5:f4c2fe649ff27b154199fa38a15a45c8]
module ufs_ss_iniu_node_top_wrap (
	input         clk                                                                 ,
	input         rst_n                                                               ,
	...
	output        ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(ufs_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:f4c2fe649ff27b154199fa38a15a45c8]
