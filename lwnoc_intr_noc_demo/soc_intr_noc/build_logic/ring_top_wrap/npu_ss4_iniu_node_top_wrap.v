//[UHDL]Content Start [md5:eebb14c53a871e6be34223002f7c5286]
module npu_ss4_iniu_node_top_wrap (
	input         clk                                                                  ,
	input         rst_n                                                                ,
	...
	output        npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_43_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(npu_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:eebb14c53a871e6be34223002f7c5286]
