//[UHDL]Content Start [md5:1193bd4aa3d60142ad1f9b55de142c3f]
module aon_ss_iniu_node_top_wrap (
	input         clk                                                                 ,
	input         rst_n                                                               ,
	...
	output        aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(aon_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:1193bd4aa3d60142ad1f9b55de142c3f]
