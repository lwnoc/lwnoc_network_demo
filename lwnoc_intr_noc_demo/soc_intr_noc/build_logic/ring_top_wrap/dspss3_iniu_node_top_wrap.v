//[UHDL]Content Start [md5:3abc1abd25d85289af75861a6da1da53]
module dspss3_iniu_node_top_wrap (
	input         clk                                                                 ,
	input         rst_n                                                               ,
	...
	output        dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_27_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(dspss3_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:3abc1abd25d85289af75861a6da1da53]
