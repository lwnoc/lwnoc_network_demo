module dspss3_iniu_interrupt_iniu
...
`ifndef VERILATOR
    generate
        for(genvar i = 0; i < INTERRUPT_NUM; i=i+1) begin : gen_interrupt_iniu_event_recorder
            dspss3_iniu_interrupt_iniu_event_recorder #(
                .INTERRUPT_ID   (i                      )
...
`endif
    ...
    dspss3_iniu_interrupt_iniu_arb #(
    ...
    // APB reg bank
    //===========================================================================
    dspss3_iniu_interrupt_iniu_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    // lut
    //===========================================================================
    dspss3_iniu_interrupt_iniu_lut #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
