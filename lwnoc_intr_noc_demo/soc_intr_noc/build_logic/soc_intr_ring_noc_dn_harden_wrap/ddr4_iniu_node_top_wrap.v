//[UHDL]Content Start [md5:836bd7cf9ccf2361b112961a2e006bf6]
module ddr4_iniu_node_top_wrap (
	input         clk                                                               ,
	input         rst_n                                                             ,
	...
	output        ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_49_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(ddr4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:836bd7cf9ccf2361b112961a2e006bf6]
