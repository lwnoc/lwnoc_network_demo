//[UHDL]Content Start [md5:957be2e2dca2f41bc0dd300435fb902d]
module debug_ss_iniu_noc_side (
	...
	input  [4:0]  debug_ss_iniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id  ,
	output        debug_ss_iniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit);
	...
	soc_intr_xbar_routing_lut_w5_c1 xbar_routing_lut (
		.src_id(node_id),
		.xbar_ch0_tgt_id(debug_ss_iniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id),
		.xbar_ch0_sel_bit(debug_ss_iniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit));
	interrupt_iniu_async_top_side iniu_top (
		...
		.req_threshold());
	debug_ss_iniu_noc_side_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:957be2e2dca2f41bc0dd300435fb902d]
