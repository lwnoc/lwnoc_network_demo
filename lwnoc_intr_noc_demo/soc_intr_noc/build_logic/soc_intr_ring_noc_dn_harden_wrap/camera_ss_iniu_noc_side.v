//[UHDL]Content Start [md5:480c9de9cd4b43ad8bd5be65ec1a8c23]
module camera_ss_iniu_noc_side (
	input         clk_top_func                                                     ,
	...
	input  [4:0]  camera_ss_iniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id  ,
	output        camera_ss_iniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit);
	...
	soc_intr_xbar_routing_lut_w5_c1 xbar_routing_lut (
		.src_id(node_id),
		.xbar_ch0_tgt_id(camera_ss_iniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id),
		.xbar_ch0_sel_bit(camera_ss_iniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit));
	interrupt_iniu_async_top_side iniu_top (
		...
		.req_threshold());
	camera_ss_iniu_noc_side_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:480c9de9cd4b43ad8bd5be65ec1a8c23]
