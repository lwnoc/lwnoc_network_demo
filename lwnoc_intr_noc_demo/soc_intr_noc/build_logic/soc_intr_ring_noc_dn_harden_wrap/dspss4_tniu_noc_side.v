//[UHDL]Content Start [md5:389cf23ae3caa960966b2dc6e1667200]
module dspss4_tniu_noc_side (
	input         clk_top_func                                                  ,
	...
	input  [4:0]  dspss4_tniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id  ,
	output        dspss4_tniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit);
	...
	soc_intr_xbar_routing_lut_w5_c1 xbar_routing_lut (
		.src_id(node_id),
		.xbar_ch0_tgt_id(dspss4_tniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id),
		.xbar_ch0_sel_bit(dspss4_tniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit));
	interrupt_tniu_async_top_side tniu_top (
		...
		.req_threshold());
	dspss4_tniu_noc_side_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:389cf23ae3caa960966b2dc6e1667200]
