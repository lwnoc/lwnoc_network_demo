//[UHDL]Content Start [md5:deb87318d8b70a67b945d00361a78bd9]
module vpu_ss_iniu_node_top_wrap (
	input         clk                                                                 ,
	input         rst_n                                                               ,
	...
	output        vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_18_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(vpu_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:deb87318d8b70a67b945d00361a78bd9]
