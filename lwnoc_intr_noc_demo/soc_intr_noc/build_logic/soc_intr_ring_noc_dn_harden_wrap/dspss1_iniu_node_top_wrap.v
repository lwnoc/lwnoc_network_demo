//[UHDL]Content Start [md5:234400bdf76e7bbd998e2de1c2f47b1f]
module dspss1_iniu_node_top_wrap (
	input         clk                                                                 ,
	input         rst_n                                                               ,
	...
	output        dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(dspss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:234400bdf76e7bbd998e2de1c2f47b1f]
