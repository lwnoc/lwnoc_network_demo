module intr_iniu_top_interrupt_iniu_async_top_side

    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import intr_iniu_top_interrupt_iniu_pkg::*;
#(
    parameter integer unsigned ASYNC_FIFO_DEPTH  = `intr_iniu_top_INTR_INIU_TOP_ASYNC_FIFO_DEPTH,
    parameter logic            FUSA_ECC_EN       = `intr_iniu_top_INTR_INIU_FUSA_ECC_EN,
