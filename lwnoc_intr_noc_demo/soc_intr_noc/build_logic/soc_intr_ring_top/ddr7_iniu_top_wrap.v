//[UHDL]Content Start [md5:8338ae8271ca01611a4d29a3fa7db10e]
module ddr7_iniu_top_wrap (
	input         clk_top_func                                  ,
	...
	interrupt_iniu_async_top_side iniu_top (
		...
		.req_threshold());
	ddr7_iniu_top_wrap_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:8338ae8271ca01611a4d29a3fa7db10e]
