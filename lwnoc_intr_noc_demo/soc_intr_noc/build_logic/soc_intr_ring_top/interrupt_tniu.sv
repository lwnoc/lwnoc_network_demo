module interrupt_tniu
    import interrupt_tniu_pkg::*;
#(
    ...
    interrupt_tniu_generate_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    //===========================================================================
    Regbank_regbank_tniu_internal_intr u_apb_internal_reg_bank(
        .clk            (clk                    ),
        .rst_n          (rst_n                  ),
    ...
    interrupt_tniu_event_conflict_check #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    generate
        for(genvar i=0; i<INTERRUPT_NUM/32; i=i+1) begin : GEN_INTR_MERGE
            ...
            interrupt_tniu_event_merge u_interrupt_tniu_event_merge(
                .clk            (clk                        ),
                .rst_n          (rst_n                      ),
        ...
        for(genvar i=0; i<INTERRUPT_NUM; i=i+1) begin : GEN_INTR_NORMAL
            if(i<INTERNAL_INTR_NUM) begin : GEN_INTERNAL_EN
                interrupt_tniu_event_repeater u_interrupt_tniu_event_repeater(
                    .clk            (clk                        ),
                    .rst_n          (rst_n                      ),
