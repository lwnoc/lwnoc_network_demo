//[UHDL]Content Start [md5:3362578394694c2320d0ef7ce5cc0195]
module ddr2_iniu_top_wrap (
	input         clk_top_func                                  ,
	...
	interrupt_iniu_async_top_side iniu_top (
		...
		.req_threshold());
	ddr2_iniu_top_wrap_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:3362578394694c2320d0ef7ce5cc0195]
