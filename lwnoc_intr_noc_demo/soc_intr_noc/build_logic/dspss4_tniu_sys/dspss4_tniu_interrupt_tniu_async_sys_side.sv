module dspss4_tniu_interrupt_tniu_async_sys_side
...
//===========================================================================
    ...
    generate
        if(INTERRUPT_NUM==4096)begin
            dspss4_tniu_spram_4096x20 u_sp_4096_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            dspss4_tniu_spram_2048x20 u_sp_2048_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            dspss4_tniu_spram_1024x20 u_sp_1024_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            dspss4_tniu_spram_512x20 u_sp_512_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            dspss4_tniu_spram_256x20 u_sp_256_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
            ...
            dspss4_tniu_spram_128x20 u_sp_128_20 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (mem_dout       ),
