module ucie_ss_iniu_interrupt_iniu
...
//===========================================================================
    ...
    generate
        for(genvar i = 0; i < INTERRUPT_NUM; i=i+1) begin : gen_interrupt_iniu_event_recorder
            ucie_ss_iniu_interrupt_iniu_event_recorder #(
                .INTERRUPT_ID   (i                      )
    ...
    ucie_ss_iniu_interrupt_iniu_arb #(
    ...
    // APB reg bank
    //===========================================================================
    ucie_ss_iniu_interrupt_iniu_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    // lut
    //===========================================================================
    ucie_ss_iniu_interrupt_iniu_lut #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
