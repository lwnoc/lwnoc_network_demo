//[UHDL]Content Start [md5:add46de65a509b59a87f39ff3ce199be]
module camera_ss_tniu_top_wrap (
	input         clk_top_func                                  ,
	...
	interrupt_tniu_async_top_side tniu_top (
		...
		.req_threshold());
	camera_ss_tniu_top_wrap_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:add46de65a509b59a87f39ff3ce199be]
