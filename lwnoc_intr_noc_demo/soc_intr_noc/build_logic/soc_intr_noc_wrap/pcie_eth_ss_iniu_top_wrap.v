//[UHDL]Content Start [md5:1e0e919c2198b1b2cd6993a468196e93]
module pcie_eth_ss_iniu_top_wrap (
	input         clk_top_func                                  ,
	...
	interrupt_iniu_async_top_side iniu_top (
		...
		.req_threshold());
	pcie_eth_ss_iniu_top_wrap_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:1e0e919c2198b1b2cd6993a468196e93]
