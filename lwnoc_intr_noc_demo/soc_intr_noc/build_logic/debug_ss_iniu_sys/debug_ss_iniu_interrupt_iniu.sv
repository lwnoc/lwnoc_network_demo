module debug_ss_iniu_interrupt_iniu
...
//===========================================================================
    ...
    generate
        for(genvar i = 0; i < INTERRUPT_NUM; i=i+1) begin : gen_interrupt_iniu_event_recorder
            debug_ss_iniu_interrupt_iniu_event_recorder #(
                .INTERRUPT_ID   (i                      )
    ...
    debug_ss_iniu_interrupt_iniu_arb #(
    ...
    // APB reg bank
    //===========================================================================
    debug_ss_iniu_interrupt_iniu_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    // lut
    //===========================================================================
    debug_ss_iniu_interrupt_iniu_lut #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
