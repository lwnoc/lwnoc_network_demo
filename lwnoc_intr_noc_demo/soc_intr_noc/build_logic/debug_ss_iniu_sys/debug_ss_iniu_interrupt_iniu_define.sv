...
`endif
`ifndef debug_ss_iniu_INTR_INIU_TIME_OUT_WIDTH
    `define debug_ss_iniu_INTR_INIU_TIME_OUT_WIDTH            10
`endif
`ifndef debug_ss_iniu_INTR_INIU_SYS_ASYNC_FIFO_DEPTH
    `define debug_ss_iniu_INTR_INIU_SYS_ASYNC_FIFO_DEPTH      16
`endif
`ifndef debug_ss_iniu_INTR_INIU_TOP_ASYNC_FIFO_DEPTH
    `define debug_ss_iniu_INTR_INIU_TOP_ASYNC_FIFO_DEPTH      10
`endif
`ifndef debug_ss_iniu_INTR_INIU_FUSA_ECC_EN
    `define debug_ss_iniu_INTR_INIU_FUSA_ECC_EN               1'b0
`endif
`ifndef debug_ss_iniu_INTR_INIU_ERR_INT_CNT_WIDTH
    `define debug_ss_iniu_INTR_INIU_ERR_INT_CNT_WIDTH         16
`endif
