//[UHDL]Content Start [md5:b51f3dd6c8dde1d8bf70d7500026367a]
module gpu_ss1_iniu_node_top_wrap (
	input         clk                                                                  ,
	input         rst_n                                                                ,
	...
	output        gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_5_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(gpu_ss1_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:b51f3dd6c8dde1d8bf70d7500026367a]
