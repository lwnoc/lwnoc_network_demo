//[UHDL]Content Start [md5:b67637672272b92d73f6e0b4896710fe]
module peri_ss_tniu_node_top_wrap (
	input         clk                                                           ,
	input         rst_n                                                         ,
	...
	input  [9:0]  peri_ss_tniu_node_top_wrap_top_timeout_val_porting_timeout_val);
	...
	intr_tniu_top_interrupt_tniu_async_top_side tniu_top (
		...
		.timeout_val(peri_ss_tniu_node_top_wrap_top_timeout_val_porting_timeout_val),
		...
		.req_threshold());
	peri_ss_tniu_node_top_wrap_ring ring_wrap (
		.clk(clk),
		.rst_n(rst_n),
...
//[UHDL]Content End [md5:b67637672272b92d73f6e0b4896710fe]
