...
module aon_ss_tniu_node (
	...
	output [4095:0] aon_ss_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                     ,
	output [127:0]  aon_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                         ,
	input  [31:0]   aon_ss_tniu_node_sys_apb_porting_p_addr                                                                                                  ,
	input           aon_ss_tniu_node_sys_apb_porting_p_enable                                                                                                ,
	output [31:0]   aon_ss_tniu_node_sys_apb_porting_p_rdata                                                                                                 ,
	output          aon_ss_tniu_node_sys_apb_porting_p_ready                                                                                                 ,
	input           aon_ss_tniu_node_sys_apb_porting_p_sel                                                                                                   ,
	output          aon_ss_tniu_node_sys_apb_porting_p_slverr                                                                                                ,
	input  [31:0]   aon_ss_tniu_node_sys_apb_porting_p_wdata                                                                                                 ,
	input           aon_ss_tniu_node_sys_apb_porting_p_write                                                                                                 ,
	input  [9:0]    aon_ss_tniu_node_sys_timeout_val_porting_timeout_val                                                                                     ,
	...
	//module inst.
	aon_ss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.tniu_tgt_id(),
		.v_interrupt(aon_ss_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(aon_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(aon_ss_tniu_node_sys_apb_porting_p_addr),
		.p_sel(aon_ss_tniu_node_sys_apb_porting_p_sel),
		.p_enable(aon_ss_tniu_node_sys_apb_porting_p_enable),
		.p_write(aon_ss_tniu_node_sys_apb_porting_p_write),
		.p_wdata(aon_ss_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(aon_ss_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(aon_ss_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(aon_ss_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(aon_ss_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	aon_ss_tniu_node_top_wrap tniu_top_wrap (
