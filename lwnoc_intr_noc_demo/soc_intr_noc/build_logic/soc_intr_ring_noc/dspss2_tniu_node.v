//[UHDL]Content Start [md5:afe298fe539f5e997458133f77ffe3b5]
module dspss2_tniu_node (
	input           clk_sys_clk                                                                                                                              ,
	...
	output [4095:0] dspss2_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                     ,
	output [127:0]  dspss2_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                         ,
	input  [31:0]   dspss2_tniu_node_sys_apb_porting_p_addr                                                                                                  ,
	input           dspss2_tniu_node_sys_apb_porting_p_enable                                                                                                ,
	output [31:0]   dspss2_tniu_node_sys_apb_porting_p_rdata                                                                                                 ,
	output          dspss2_tniu_node_sys_apb_porting_p_ready                                                                                                 ,
	input           dspss2_tniu_node_sys_apb_porting_p_sel                                                                                                   ,
	output          dspss2_tniu_node_sys_apb_porting_p_slverr                                                                                                ,
	input  [31:0]   dspss2_tniu_node_sys_apb_porting_p_wdata                                                                                                 ,
	input           dspss2_tniu_node_sys_apb_porting_p_write                                                                                                 ,
	input  [9:0]    dspss2_tniu_node_sys_timeout_val_porting_timeout_val                                                                                     ,
	...
	//module inst.
	dspss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.tniu_tgt_id(),
		.v_interrupt(dspss2_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(dspss2_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(dspss2_tniu_node_sys_apb_porting_p_addr),
		.p_sel(dspss2_tniu_node_sys_apb_porting_p_sel),
		.p_enable(dspss2_tniu_node_sys_apb_porting_p_enable),
		.p_write(dspss2_tniu_node_sys_apb_porting_p_write),
		.p_wdata(dspss2_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(dspss2_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(dspss2_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dspss2_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dspss2_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	dspss2_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:afe298fe539f5e997458133f77ffe3b5]
