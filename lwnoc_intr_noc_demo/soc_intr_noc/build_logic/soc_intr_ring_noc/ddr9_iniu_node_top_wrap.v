//[UHDL]Content Start [md5:505dc2ab6aca37d8de1bb83184760f7e]
module ddr9_iniu_node_top_wrap (
	input         clk                                                               ,
	input         rst_n                                                             ,
	...
	output        ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(ddr9_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:505dc2ab6aca37d8de1bb83184760f7e]
