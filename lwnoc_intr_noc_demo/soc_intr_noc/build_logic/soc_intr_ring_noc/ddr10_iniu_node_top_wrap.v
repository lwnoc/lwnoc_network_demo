...
module ddr10_iniu_node_top_wrap (
	...
	output        ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(ddr10_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
