//[UHDL]Content Start [md5:0d9f13b23f3ec37609daa66ce61644a3]
module ucie_ss1_tniu_node (
	input           clk_sys_clk                                                                                                                                    ,
	...
	output [4095:0] ucie_ss1_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                         ,
	output [127:0]  ucie_ss1_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                             ,
	input  [31:0]   ucie_ss1_tniu_node_sys_apb_porting_p_addr                                                                                                      ,
	input           ucie_ss1_tniu_node_sys_apb_porting_p_enable                                                                                                    ,
	output [31:0]   ucie_ss1_tniu_node_sys_apb_porting_p_rdata                                                                                                     ,
	output          ucie_ss1_tniu_node_sys_apb_porting_p_ready                                                                                                     ,
	input           ucie_ss1_tniu_node_sys_apb_porting_p_sel                                                                                                       ,
	output          ucie_ss1_tniu_node_sys_apb_porting_p_slverr                                                                                                    ,
	input  [31:0]   ucie_ss1_tniu_node_sys_apb_porting_p_wdata                                                                                                     ,
	input           ucie_ss1_tniu_node_sys_apb_porting_p_write                                                                                                     ,
	input  [9:0]    ucie_ss1_tniu_node_sys_timeout_val_porting_timeout_val                                                                                         ,
	...
	//module inst.
	ucie_ss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.tniu_tgt_id(),
		.v_interrupt(ucie_ss1_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(ucie_ss1_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(ucie_ss1_tniu_node_sys_apb_porting_p_addr),
		.p_sel(ucie_ss1_tniu_node_sys_apb_porting_p_sel),
		.p_enable(ucie_ss1_tniu_node_sys_apb_porting_p_enable),
		.p_write(ucie_ss1_tniu_node_sys_apb_porting_p_write),
		.p_wdata(ucie_ss1_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(ucie_ss1_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(ucie_ss1_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(ucie_ss1_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(ucie_ss1_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	ucie_ss1_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:0d9f13b23f3ec37609daa66ce61644a3]
