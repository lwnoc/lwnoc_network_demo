//[UHDL]Content Start [md5:42ca40a566b391131d6fed326713a1af]
module mcu_ss_iniu_node (
	input           clk_sys_clk                                                                                                                                       ,
	...
	input  [4095:0] mcu_ss_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                              ,
	input  [31:0]   mcu_ss_iniu_node_sys_apb_porting_p_addr                                                                                                           ,
	input           mcu_ss_iniu_node_sys_apb_porting_p_enable                                                                                                         ,
	output [31:0]   mcu_ss_iniu_node_sys_apb_porting_p_rdata                                                                                                          ,
	output          mcu_ss_iniu_node_sys_apb_porting_p_ready                                                                                                          ,
	input           mcu_ss_iniu_node_sys_apb_porting_p_sel                                                                                                            ,
	output          mcu_ss_iniu_node_sys_apb_porting_p_slverr                                                                                                         ,
	input  [31:0]   mcu_ss_iniu_node_sys_apb_porting_p_wdata                                                                                                          ,
	input           mcu_ss_iniu_node_sys_apb_porting_p_write                                                                                                          ,
	input  [9:0]    mcu_ss_iniu_node_sys_timeout_val_porting_timeout_val                                                                                              ,
	...
	//module inst.
	mcu_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(mcu_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(mcu_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(mcu_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(mcu_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(mcu_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(mcu_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(mcu_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(mcu_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(mcu_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(mcu_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	mcu_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:42ca40a566b391131d6fed326713a1af]
