//[UHDL]Content Start [md5:e7a7e6a402d087590d0c489c793fd9e4]
module display_ss_iniu_node (
	...
	input  [4095:0] display_ss_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                                      ,
	input  [31:0]   display_ss_iniu_node_sys_apb_porting_p_addr                                                                                                                   ,
	input           display_ss_iniu_node_sys_apb_porting_p_enable                                                                                                                 ,
	output [31:0]   display_ss_iniu_node_sys_apb_porting_p_rdata                                                                                                                  ,
	output          display_ss_iniu_node_sys_apb_porting_p_ready                                                                                                                  ,
	input           display_ss_iniu_node_sys_apb_porting_p_sel                                                                                                                    ,
	output          display_ss_iniu_node_sys_apb_porting_p_slverr                                                                                                                 ,
	input  [31:0]   display_ss_iniu_node_sys_apb_porting_p_wdata                                                                                                                  ,
	input           display_ss_iniu_node_sys_apb_porting_p_write                                                                                                                  ,
	input  [9:0]    display_ss_iniu_node_sys_timeout_val_porting_timeout_val                                                                                                      ,
	...
	//module inst.
	display_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(display_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(display_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(display_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(display_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(display_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(display_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(display_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(display_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(display_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(display_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	display_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:e7a7e6a402d087590d0c489c793fd9e4]
