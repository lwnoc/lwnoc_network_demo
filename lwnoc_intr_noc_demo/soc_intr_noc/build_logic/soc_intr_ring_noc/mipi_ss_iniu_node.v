//[UHDL]Content Start [md5:6038912d66d8236fed174fe90f8bb123]
module mipi_ss_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] mipi_ss_iniu_node_sys_v_interrupt_porting_v_interrupt      ,
	input  [7:0]    mipi_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id      ,
	input  [31:0]   mipi_ss_iniu_node_sys_apb_porting_p_addr                   ,
	input           mipi_ss_iniu_node_sys_apb_porting_p_enable                 ,
	output [31:0]   mipi_ss_iniu_node_sys_apb_porting_p_rdata                  ,
	output          mipi_ss_iniu_node_sys_apb_porting_p_ready                  ,
	input           mipi_ss_iniu_node_sys_apb_porting_p_sel                    ,
	output          mipi_ss_iniu_node_sys_apb_porting_p_slverr                 ,
	input  [31:0]   mipi_ss_iniu_node_sys_apb_porting_p_wdata                  ,
	input           mipi_ss_iniu_node_sys_apb_porting_p_write                  ,
	input  [9:0]    mipi_ss_iniu_node_sys_timeout_val_porting_timeout_val      ,
	...
	mipi_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(mipi_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(mipi_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(mipi_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(mipi_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(mipi_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(mipi_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(mipi_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(mipi_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(mipi_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(mipi_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(mipi_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	mipi_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:6038912d66d8236fed174fe90f8bb123]
