//[UHDL]Content Start [md5:f70c16f3b05361c74451cb412deac3a8]
module ddr8_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] ddr8_iniu_node_sys_v_interrupt_porting_v_interrupt         ,
	input  [7:0]    ddr8_iniu_node_sys_iniu_src_id_porting_iniu_src_id         ,
	input  [31:0]   ddr8_iniu_node_sys_apb_porting_p_addr                      ,
	input           ddr8_iniu_node_sys_apb_porting_p_enable                    ,
	output [31:0]   ddr8_iniu_node_sys_apb_porting_p_rdata                     ,
	output          ddr8_iniu_node_sys_apb_porting_p_ready                     ,
	input           ddr8_iniu_node_sys_apb_porting_p_sel                       ,
	output          ddr8_iniu_node_sys_apb_porting_p_slverr                    ,
	input  [31:0]   ddr8_iniu_node_sys_apb_porting_p_wdata                     ,
	input           ddr8_iniu_node_sys_apb_porting_p_write                     ,
	input  [9:0]    ddr8_iniu_node_sys_timeout_val_porting_timeout_val         ,
	...
	ddr_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(ddr8_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(ddr8_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(ddr8_iniu_node_sys_apb_porting_p_addr),
		.p_sel(ddr8_iniu_node_sys_apb_porting_p_sel),
		.p_enable(ddr8_iniu_node_sys_apb_porting_p_enable),
		.p_write(ddr8_iniu_node_sys_apb_porting_p_write),
		.p_wdata(ddr8_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(ddr8_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(ddr8_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(ddr8_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(ddr8_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	ddr8_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:f70c16f3b05361c74451cb412deac3a8]
