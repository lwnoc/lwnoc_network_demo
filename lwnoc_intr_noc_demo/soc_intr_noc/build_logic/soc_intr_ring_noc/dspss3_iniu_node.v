//[UHDL]Content Start [md5:f8f35276af0644777826fdf248abed00]
module dspss3_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] dspss3_iniu_node_sys_v_interrupt_porting_v_interrupt       ,
	input  [7:0]    dspss3_iniu_node_sys_iniu_src_id_porting_iniu_src_id       ,
	input  [31:0]   dspss3_iniu_node_sys_apb_porting_p_addr                    ,
	input           dspss3_iniu_node_sys_apb_porting_p_enable                  ,
	output [31:0]   dspss3_iniu_node_sys_apb_porting_p_rdata                   ,
	output          dspss3_iniu_node_sys_apb_porting_p_ready                   ,
	input           dspss3_iniu_node_sys_apb_porting_p_sel                     ,
	output          dspss3_iniu_node_sys_apb_porting_p_slverr                  ,
	input  [31:0]   dspss3_iniu_node_sys_apb_porting_p_wdata                   ,
	input           dspss3_iniu_node_sys_apb_porting_p_write                   ,
	input  [9:0]    dspss3_iniu_node_sys_timeout_val_porting_timeout_val       ,
	...
	dspss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(dspss3_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(dspss3_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(dspss3_iniu_node_sys_apb_porting_p_addr),
		.p_sel(dspss3_iniu_node_sys_apb_porting_p_sel),
		.p_enable(dspss3_iniu_node_sys_apb_porting_p_enable),
		.p_write(dspss3_iniu_node_sys_apb_porting_p_write),
		.p_wdata(dspss3_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(dspss3_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(dspss3_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dspss3_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dspss3_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	dspss3_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:f8f35276af0644777826fdf248abed00]
