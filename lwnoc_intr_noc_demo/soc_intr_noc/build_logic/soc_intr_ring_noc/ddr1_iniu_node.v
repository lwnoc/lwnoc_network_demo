//[UHDL]Content Start [md5:7c7680a0f6a8cc5aeb2b1455b43d4350]
module ddr1_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] ddr1_iniu_node_sys_v_interrupt_porting_v_interrupt         ,
	input  [7:0]    ddr1_iniu_node_sys_iniu_src_id_porting_iniu_src_id         ,
	input  [31:0]   ddr1_iniu_node_sys_apb_porting_p_addr                      ,
	input           ddr1_iniu_node_sys_apb_porting_p_enable                    ,
	output [31:0]   ddr1_iniu_node_sys_apb_porting_p_rdata                     ,
	output          ddr1_iniu_node_sys_apb_porting_p_ready                     ,
	input           ddr1_iniu_node_sys_apb_porting_p_sel                       ,
	output          ddr1_iniu_node_sys_apb_porting_p_slverr                    ,
	input  [31:0]   ddr1_iniu_node_sys_apb_porting_p_wdata                     ,
	input           ddr1_iniu_node_sys_apb_porting_p_write                     ,
	input  [9:0]    ddr1_iniu_node_sys_timeout_val_porting_timeout_val         ,
	...
	ddr_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(ddr1_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(ddr1_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(ddr1_iniu_node_sys_apb_porting_p_addr),
		.p_sel(ddr1_iniu_node_sys_apb_porting_p_sel),
		.p_enable(ddr1_iniu_node_sys_apb_porting_p_enable),
		.p_write(ddr1_iniu_node_sys_apb_porting_p_write),
		.p_wdata(ddr1_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(ddr1_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(ddr1_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(ddr1_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(ddr1_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	ddr1_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:7c7680a0f6a8cc5aeb2b1455b43d4350]
