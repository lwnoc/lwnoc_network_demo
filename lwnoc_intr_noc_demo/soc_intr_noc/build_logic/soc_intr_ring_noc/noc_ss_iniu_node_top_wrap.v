//[UHDL]Content Start [md5:bcf6ffe4cd32419b5c3e60500d5d0091]
module noc_ss_iniu_node_top_wrap (
	input         clk                                                                 ,
	input         rst_n                                                               ,
	...
	output        noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_33_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(noc_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:bcf6ffe4cd32419b5c3e60500d5d0091]
