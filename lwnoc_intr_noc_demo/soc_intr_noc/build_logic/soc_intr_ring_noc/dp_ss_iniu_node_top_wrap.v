...
module dp_ss_iniu_node_top_wrap (
	...
	output        dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(dp_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
