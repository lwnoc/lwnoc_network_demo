//[UHDL]Content Start [md5:805ab5acfab5fbe8510016e3beaed976]
module audio_ss_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] audio_ss_iniu_node_sys_v_interrupt_porting_v_interrupt     ,
	input  [7:0]    audio_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id     ,
	input  [31:0]   audio_ss_iniu_node_sys_apb_porting_p_addr                  ,
	input           audio_ss_iniu_node_sys_apb_porting_p_enable                ,
	output [31:0]   audio_ss_iniu_node_sys_apb_porting_p_rdata                 ,
	output          audio_ss_iniu_node_sys_apb_porting_p_ready                 ,
	input           audio_ss_iniu_node_sys_apb_porting_p_sel                   ,
	output          audio_ss_iniu_node_sys_apb_porting_p_slverr                ,
	input  [31:0]   audio_ss_iniu_node_sys_apb_porting_p_wdata                 ,
	input           audio_ss_iniu_node_sys_apb_porting_p_write                 ,
	input  [9:0]    audio_ss_iniu_node_sys_timeout_val_porting_timeout_val     ,
	...
	//module inst.
	audio_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(audio_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(audio_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(audio_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(audio_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(audio_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(audio_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(audio_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(audio_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(audio_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(audio_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(audio_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	audio_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:805ab5acfab5fbe8510016e3beaed976]
