//[UHDL]Content Start [md5:bf78c177217724bbfd3e5a517b35ebea]
module camera_ss_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] camera_ss_iniu_node_sys_v_interrupt_porting_v_interrupt    ,
	input  [7:0]    camera_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id    ,
	input  [31:0]   camera_ss_iniu_node_sys_apb_porting_p_addr                 ,
	input           camera_ss_iniu_node_sys_apb_porting_p_enable               ,
	output [31:0]   camera_ss_iniu_node_sys_apb_porting_p_rdata                ,
	output          camera_ss_iniu_node_sys_apb_porting_p_ready                ,
	input           camera_ss_iniu_node_sys_apb_porting_p_sel                  ,
	output          camera_ss_iniu_node_sys_apb_porting_p_slverr               ,
	input  [31:0]   camera_ss_iniu_node_sys_apb_porting_p_wdata                ,
	input           camera_ss_iniu_node_sys_apb_porting_p_write                ,
	input  [9:0]    camera_ss_iniu_node_sys_timeout_val_porting_timeout_val    ,
	...
	//module inst.
	camera_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(camera_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(camera_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(camera_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(camera_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(camera_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(camera_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(camera_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(camera_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(camera_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(camera_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(camera_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	camera_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:bf78c177217724bbfd3e5a517b35ebea]
