//[UHDL]Content Start [md5:3b32c82ea5517ed79a7ab0b8f7713d6e]
module pcie_eth_ss_iniu_node (
	...
	input  [4095:0] pcie_eth_ss_iniu_node_sys_v_interrupt_porting_v_interrupt  ,
	input  [7:0]    pcie_eth_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id  ,
	input  [31:0]   pcie_eth_ss_iniu_node_sys_apb_porting_p_addr               ,
	input           pcie_eth_ss_iniu_node_sys_apb_porting_p_enable             ,
	output [31:0]   pcie_eth_ss_iniu_node_sys_apb_porting_p_rdata              ,
	output          pcie_eth_ss_iniu_node_sys_apb_porting_p_ready              ,
	input           pcie_eth_ss_iniu_node_sys_apb_porting_p_sel                ,
	output          pcie_eth_ss_iniu_node_sys_apb_porting_p_slverr             ,
	input  [31:0]   pcie_eth_ss_iniu_node_sys_apb_porting_p_wdata              ,
	input           pcie_eth_ss_iniu_node_sys_apb_porting_p_write              ,
	input  [9:0]    pcie_eth_ss_iniu_node_sys_timeout_val_porting_timeout_val  ,
	...
	//module inst.
	pcie_eth_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(pcie_eth_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(pcie_eth_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(pcie_eth_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(pcie_eth_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(pcie_eth_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(pcie_eth_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(pcie_eth_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(pcie_eth_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(pcie_eth_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(pcie_eth_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(pcie_eth_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	pcie_eth_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:3b32c82ea5517ed79a7ab0b8f7713d6e]
