//[UHDL]Content Start [md5:59d7961b0cb0672a9b37b5238bd7dd41]
module dspss0_tniu_node (
	input           clk_sys_clk                                                                                                                              ,
	...
	output [4095:0] dspss0_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                     ,
	output [127:0]  dspss0_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                         ,
	input  [31:0]   dspss0_tniu_node_sys_apb_porting_p_addr                                                                                                  ,
	input           dspss0_tniu_node_sys_apb_porting_p_enable                                                                                                ,
	output [31:0]   dspss0_tniu_node_sys_apb_porting_p_rdata                                                                                                 ,
	output          dspss0_tniu_node_sys_apb_porting_p_ready                                                                                                 ,
	input           dspss0_tniu_node_sys_apb_porting_p_sel                                                                                                   ,
	output          dspss0_tniu_node_sys_apb_porting_p_slverr                                                                                                ,
	input  [31:0]   dspss0_tniu_node_sys_apb_porting_p_wdata                                                                                                 ,
	input           dspss0_tniu_node_sys_apb_porting_p_write                                                                                                 ,
	input  [9:0]    dspss0_tniu_node_sys_timeout_val_porting_timeout_val                                                                                     ,
	...
	dspss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		...
		.tniu_tgt_id(),
		.v_interrupt(dspss0_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(dspss0_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(dspss0_tniu_node_sys_apb_porting_p_addr),
		.p_sel(dspss0_tniu_node_sys_apb_porting_p_sel),
		.p_enable(dspss0_tniu_node_sys_apb_porting_p_enable),
		.p_write(dspss0_tniu_node_sys_apb_porting_p_write),
		.p_wdata(dspss0_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(dspss0_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(dspss0_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dspss0_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dspss0_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	dspss0_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:59d7961b0cb0672a9b37b5238bd7dd41]
