//[UHDL]Content Start [md5:496d954eb5190cfc7e5c28a82a0cdfd5]
module debug_ss_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] debug_ss_iniu_node_sys_v_interrupt_porting_v_interrupt     ,
	input  [7:0]    debug_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id     ,
	input  [31:0]   debug_ss_iniu_node_sys_apb_porting_p_addr                  ,
	input           debug_ss_iniu_node_sys_apb_porting_p_enable                ,
	output [31:0]   debug_ss_iniu_node_sys_apb_porting_p_rdata                 ,
	output          debug_ss_iniu_node_sys_apb_porting_p_ready                 ,
	input           debug_ss_iniu_node_sys_apb_porting_p_sel                   ,
	output          debug_ss_iniu_node_sys_apb_porting_p_slverr                ,
	input  [31:0]   debug_ss_iniu_node_sys_apb_porting_p_wdata                 ,
	input           debug_ss_iniu_node_sys_apb_porting_p_write                 ,
	input  [9:0]    debug_ss_iniu_node_sys_timeout_val_porting_timeout_val     ,
	...
	//module inst.
	debug_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(debug_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(debug_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(debug_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(debug_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(debug_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(debug_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(debug_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(debug_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(debug_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(debug_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(debug_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	debug_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:496d954eb5190cfc7e5c28a82a0cdfd5]
