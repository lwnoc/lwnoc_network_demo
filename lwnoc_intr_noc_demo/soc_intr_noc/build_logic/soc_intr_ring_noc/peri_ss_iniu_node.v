//[UHDL]Content Start [md5:ac4e880f629392c77dd87867753fa555]
module peri_ss_iniu_node (
	...
	input  [4095:0] peri_ss_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                                ,
	input  [31:0]   peri_ss_iniu_node_sys_apb_porting_p_addr                                                                                                             ,
	input           peri_ss_iniu_node_sys_apb_porting_p_enable                                                                                                           ,
	output [31:0]   peri_ss_iniu_node_sys_apb_porting_p_rdata                                                                                                            ,
	output          peri_ss_iniu_node_sys_apb_porting_p_ready                                                                                                            ,
	input           peri_ss_iniu_node_sys_apb_porting_p_sel                                                                                                              ,
	output          peri_ss_iniu_node_sys_apb_porting_p_slverr                                                                                                           ,
	input  [31:0]   peri_ss_iniu_node_sys_apb_porting_p_wdata                                                                                                            ,
	input           peri_ss_iniu_node_sys_apb_porting_p_write                                                                                                            ,
	input  [9:0]    peri_ss_iniu_node_sys_timeout_val_porting_timeout_val                                                                                                ,
	...
	//module inst.
	peri_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(peri_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(peri_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(peri_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(peri_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(peri_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(peri_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(peri_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(peri_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(peri_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(peri_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	peri_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:ac4e880f629392c77dd87867753fa555]
