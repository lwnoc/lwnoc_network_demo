//[UHDL]Content Start [md5:3bf94e5fd0aab76e739c59604b4f0a60]
module display_ss_tniu_node (
	input           clk_sys_clk                                                                                                                                          ,
	...
	output          tniu_lut_sb_err_tniu_lut_sb_err                                                                                                                      ,
	output          tniu_lut_db_err_tniu_lut_db_err                                                                                                                      ,
	output [4095:0] display_ss_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                             ,
	output [127:0]  display_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                                 ,
	input  [31:0]   display_ss_tniu_node_sys_apb_porting_p_addr                                                                                                          ,
	input           display_ss_tniu_node_sys_apb_porting_p_enable                                                                                                        ,
	output [31:0]   display_ss_tniu_node_sys_apb_porting_p_rdata                                                                                                         ,
	output          display_ss_tniu_node_sys_apb_porting_p_ready                                                                                                         ,
	input           display_ss_tniu_node_sys_apb_porting_p_sel                                                                                                           ,
	output          display_ss_tniu_node_sys_apb_porting_p_slverr                                                                                                        ,
	input  [31:0]   display_ss_tniu_node_sys_apb_porting_p_wdata                                                                                                         ,
	input           display_ss_tniu_node_sys_apb_porting_p_write                                                                                                         ,
	input  [9:0]    display_ss_tniu_node_sys_timeout_val_porting_timeout_val                                                                                             ,
	...
	//module inst.
	display_ss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.tniu_tgt_id(),
		.v_interrupt(display_ss_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(display_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(display_ss_tniu_node_sys_apb_porting_p_addr),
		.p_sel(display_ss_tniu_node_sys_apb_porting_p_sel),
		.p_enable(display_ss_tniu_node_sys_apb_porting_p_enable),
		.p_write(display_ss_tniu_node_sys_apb_porting_p_write),
		.p_wdata(display_ss_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(display_ss_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(display_ss_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(display_ss_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(display_ss_tniu_node_sys_timeout_val_porting_timeout_val),
		...
		.tniu_lut_sb_err(tniu_lut_sb_err_tniu_lut_sb_err),
		.tniu_lut_db_err(tniu_lut_db_err_tniu_lut_db_err));
	display_ss_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:3bf94e5fd0aab76e739c59604b4f0a60]
