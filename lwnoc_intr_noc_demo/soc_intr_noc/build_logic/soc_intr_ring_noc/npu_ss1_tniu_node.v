//[UHDL]Content Start [md5:fef2e735514ffa304732677150993756]
module npu_ss1_tniu_node (
	input           clk_sys_clk                                                                                                                                 ,
	...
	output [4095:0] npu_ss1_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                       ,
	output [127:0]  npu_ss1_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                           ,
	input  [31:0]   npu_ss1_tniu_node_sys_apb_porting_p_addr                                                                                                    ,
	input           npu_ss1_tniu_node_sys_apb_porting_p_enable                                                                                                  ,
	output [31:0]   npu_ss1_tniu_node_sys_apb_porting_p_rdata                                                                                                   ,
	output          npu_ss1_tniu_node_sys_apb_porting_p_ready                                                                                                   ,
	input           npu_ss1_tniu_node_sys_apb_porting_p_sel                                                                                                     ,
	output          npu_ss1_tniu_node_sys_apb_porting_p_slverr                                                                                                  ,
	input  [31:0]   npu_ss1_tniu_node_sys_apb_porting_p_wdata                                                                                                   ,
	input           npu_ss1_tniu_node_sys_apb_porting_p_write                                                                                                   ,
	input  [9:0]    npu_ss1_tniu_node_sys_timeout_val_porting_timeout_val                                                                                       ,
	...
	npu_ss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		...
		.tniu_tgt_id(),
		.v_interrupt(npu_ss1_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(npu_ss1_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(npu_ss1_tniu_node_sys_apb_porting_p_addr),
		.p_sel(npu_ss1_tniu_node_sys_apb_porting_p_sel),
		.p_enable(npu_ss1_tniu_node_sys_apb_porting_p_enable),
		.p_write(npu_ss1_tniu_node_sys_apb_porting_p_write),
		.p_wdata(npu_ss1_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(npu_ss1_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(npu_ss1_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(npu_ss1_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(npu_ss1_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	npu_ss1_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:fef2e735514ffa304732677150993756]
