//[UHDL]Content Start [md5:1f3e320c311caa730a43b3a48962e4a9]
module npu_ss2_iniu_node (
	...
	input  [4095:0] npu_ss2_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                                ,
	input  [31:0]   npu_ss2_iniu_node_sys_apb_porting_p_addr                                                                                                             ,
	input           npu_ss2_iniu_node_sys_apb_porting_p_enable                                                                                                           ,
	output [31:0]   npu_ss2_iniu_node_sys_apb_porting_p_rdata                                                                                                            ,
	output          npu_ss2_iniu_node_sys_apb_porting_p_ready                                                                                                            ,
	input           npu_ss2_iniu_node_sys_apb_porting_p_sel                                                                                                              ,
	output          npu_ss2_iniu_node_sys_apb_porting_p_slverr                                                                                                           ,
	input  [31:0]   npu_ss2_iniu_node_sys_apb_porting_p_wdata                                                                                                            ,
	input           npu_ss2_iniu_node_sys_apb_porting_p_write                                                                                                            ,
	input  [9:0]    npu_ss2_iniu_node_sys_timeout_val_porting_timeout_val                                                                                                ,
	...
	npu_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(npu_ss2_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(npu_ss2_iniu_node_sys_apb_porting_p_addr),
		.p_sel(npu_ss2_iniu_node_sys_apb_porting_p_sel),
		.p_enable(npu_ss2_iniu_node_sys_apb_porting_p_enable),
		.p_write(npu_ss2_iniu_node_sys_apb_porting_p_write),
		.p_wdata(npu_ss2_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(npu_ss2_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(npu_ss2_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(npu_ss2_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(npu_ss2_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	npu_ss2_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:1f3e320c311caa730a43b3a48962e4a9]
