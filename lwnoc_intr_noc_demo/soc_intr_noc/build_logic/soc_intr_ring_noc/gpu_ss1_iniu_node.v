//[UHDL]Content Start [md5:4f73c027fc69a1becd7b767145baf882]
module gpu_ss1_iniu_node (
	...
	input  [4095:0] gpu_ss1_iniu_node_sys_v_interrupt_porting_v_interrupt      ,
	input  [7:0]    gpu_ss1_iniu_node_sys_iniu_src_id_porting_iniu_src_id      ,
	input  [31:0]   gpu_ss1_iniu_node_sys_apb_porting_p_addr                   ,
	input           gpu_ss1_iniu_node_sys_apb_porting_p_enable                 ,
	output [31:0]   gpu_ss1_iniu_node_sys_apb_porting_p_rdata                  ,
	output          gpu_ss1_iniu_node_sys_apb_porting_p_ready                  ,
	input           gpu_ss1_iniu_node_sys_apb_porting_p_sel                    ,
	output          gpu_ss1_iniu_node_sys_apb_porting_p_slverr                 ,
	input  [31:0]   gpu_ss1_iniu_node_sys_apb_porting_p_wdata                  ,
	input           gpu_ss1_iniu_node_sys_apb_porting_p_write                  ,
	input  [9:0]    gpu_ss1_iniu_node_sys_timeout_val_porting_timeout_val      ,
	...
	//module inst.
	gpu_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(gpu_ss1_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(gpu_ss1_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(gpu_ss1_iniu_node_sys_apb_porting_p_addr),
		.p_sel(gpu_ss1_iniu_node_sys_apb_porting_p_sel),
		.p_enable(gpu_ss1_iniu_node_sys_apb_porting_p_enable),
		.p_write(gpu_ss1_iniu_node_sys_apb_porting_p_write),
		.p_wdata(gpu_ss1_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(gpu_ss1_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(gpu_ss1_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(gpu_ss1_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(gpu_ss1_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	gpu_ss1_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:4f73c027fc69a1becd7b767145baf882]
