//[UHDL]Content Start [md5:d9fcb6f81f66c986bc260c2333174ca7]
module dsp_ss1_tniu_node (
	input           clk_sys_clk                                                                                                                                 ,
	...
	output [4095:0] dsp_ss1_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                       ,
	output [127:0]  dsp_ss1_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                           ,
	input  [31:0]   dsp_ss1_tniu_node_sys_apb_porting_p_addr                                                                                                    ,
	input           dsp_ss1_tniu_node_sys_apb_porting_p_enable                                                                                                  ,
	output [31:0]   dsp_ss1_tniu_node_sys_apb_porting_p_rdata                                                                                                   ,
	output          dsp_ss1_tniu_node_sys_apb_porting_p_ready                                                                                                   ,
	input           dsp_ss1_tniu_node_sys_apb_porting_p_sel                                                                                                     ,
	output          dsp_ss1_tniu_node_sys_apb_porting_p_slverr                                                                                                  ,
	input  [31:0]   dsp_ss1_tniu_node_sys_apb_porting_p_wdata                                                                                                   ,
	input           dsp_ss1_tniu_node_sys_apb_porting_p_write                                                                                                   ,
	input  [9:0]    dsp_ss1_tniu_node_sys_timeout_val_porting_timeout_val                                                                                       ,
	...
	dsp_ss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		...
		.tniu_tgt_id(),
		.v_interrupt(dsp_ss1_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(dsp_ss1_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(dsp_ss1_tniu_node_sys_apb_porting_p_addr),
		.p_sel(dsp_ss1_tniu_node_sys_apb_porting_p_sel),
		.p_enable(dsp_ss1_tniu_node_sys_apb_porting_p_enable),
		.p_write(dsp_ss1_tniu_node_sys_apb_porting_p_write),
		.p_wdata(dsp_ss1_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(dsp_ss1_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(dsp_ss1_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dsp_ss1_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dsp_ss1_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	dsp_ss1_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:d9fcb6f81f66c986bc260c2333174ca7]
