//[UHDL]Content Start [md5:6939de93a85211ddad676f5f0f45bf0c]
module noc_ss_iniu_node (
	input           clk_sys_clk                                                                                                                                       ,
	...
	input  [4095:0] noc_ss_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                              ,
	input  [31:0]   noc_ss_iniu_node_sys_apb_porting_p_addr                                                                                                           ,
	input           noc_ss_iniu_node_sys_apb_porting_p_enable                                                                                                         ,
	output [31:0]   noc_ss_iniu_node_sys_apb_porting_p_rdata                                                                                                          ,
	output          noc_ss_iniu_node_sys_apb_porting_p_ready                                                                                                          ,
	input           noc_ss_iniu_node_sys_apb_porting_p_sel                                                                                                            ,
	output          noc_ss_iniu_node_sys_apb_porting_p_slverr                                                                                                         ,
	input  [31:0]   noc_ss_iniu_node_sys_apb_porting_p_wdata                                                                                                          ,
	input           noc_ss_iniu_node_sys_apb_porting_p_write                                                                                                          ,
	input  [9:0]    noc_ss_iniu_node_sys_timeout_val_porting_timeout_val                                                                                              ,
	...
	//module inst.
	noc_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(noc_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(noc_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(noc_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(noc_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(noc_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(noc_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(noc_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(noc_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(noc_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(noc_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	noc_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:6939de93a85211ddad676f5f0f45bf0c]
