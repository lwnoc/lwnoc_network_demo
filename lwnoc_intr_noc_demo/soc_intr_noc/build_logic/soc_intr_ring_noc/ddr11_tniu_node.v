//[UHDL]Content Start [md5:7075549ea4aeac71a460ae01c7e7ba6d]
module ddr11_tniu_node (
	input           clk_sys_clk                                                                                                                           ,
	...
	output [4095:0] ddr11_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                   ,
	output [127:0]  ddr11_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                       ,
	input  [31:0]   ddr11_tniu_node_sys_apb_porting_p_addr                                                                                                ,
	input           ddr11_tniu_node_sys_apb_porting_p_enable                                                                                              ,
	output [31:0]   ddr11_tniu_node_sys_apb_porting_p_rdata                                                                                               ,
	output          ddr11_tniu_node_sys_apb_porting_p_ready                                                                                               ,
	input           ddr11_tniu_node_sys_apb_porting_p_sel                                                                                                 ,
	output          ddr11_tniu_node_sys_apb_porting_p_slverr                                                                                              ,
	input  [31:0]   ddr11_tniu_node_sys_apb_porting_p_wdata                                                                                               ,
	input           ddr11_tniu_node_sys_apb_porting_p_write                                                                                               ,
	input  [9:0]    ddr11_tniu_node_sys_timeout_val_porting_timeout_val                                                                                   ,
	...
	ddr_tniu_interrupt_tniu_async_sys_side tniu_sys (
		...
		.tniu_tgt_id(),
		.v_interrupt(ddr11_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(ddr11_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(ddr11_tniu_node_sys_apb_porting_p_addr),
		.p_sel(ddr11_tniu_node_sys_apb_porting_p_sel),
		.p_enable(ddr11_tniu_node_sys_apb_porting_p_enable),
		.p_write(ddr11_tniu_node_sys_apb_porting_p_write),
		.p_wdata(ddr11_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(ddr11_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(ddr11_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(ddr11_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(ddr11_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	ddr11_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:7075549ea4aeac71a460ae01c7e7ba6d]
