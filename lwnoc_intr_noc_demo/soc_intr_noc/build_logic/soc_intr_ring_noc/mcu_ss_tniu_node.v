//[UHDL]Content Start [md5:830f6e2d604d704e8f5cfaa15638d36c]
module mcu_ss_tniu_node (
	input           clk_sys_clk                                                                                                                              ,
	...
	output [4095:0] mcu_ss_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                     ,
	output [127:0]  mcu_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                         ,
	input  [31:0]   mcu_ss_tniu_node_sys_apb_porting_p_addr                                                                                                  ,
	input           mcu_ss_tniu_node_sys_apb_porting_p_enable                                                                                                ,
	output [31:0]   mcu_ss_tniu_node_sys_apb_porting_p_rdata                                                                                                 ,
	output          mcu_ss_tniu_node_sys_apb_porting_p_ready                                                                                                 ,
	input           mcu_ss_tniu_node_sys_apb_porting_p_sel                                                                                                   ,
	output          mcu_ss_tniu_node_sys_apb_porting_p_slverr                                                                                                ,
	input  [31:0]   mcu_ss_tniu_node_sys_apb_porting_p_wdata                                                                                                 ,
	input           mcu_ss_tniu_node_sys_apb_porting_p_write                                                                                                 ,
	input  [9:0]    mcu_ss_tniu_node_sys_timeout_val_porting_timeout_val                                                                                     ,
	...
	//module inst.
	mcu_ss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.tniu_tgt_id(),
		.v_interrupt(mcu_ss_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(mcu_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(mcu_ss_tniu_node_sys_apb_porting_p_addr),
		.p_sel(mcu_ss_tniu_node_sys_apb_porting_p_sel),
		.p_enable(mcu_ss_tniu_node_sys_apb_porting_p_enable),
		.p_write(mcu_ss_tniu_node_sys_apb_porting_p_write),
		.p_wdata(mcu_ss_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(mcu_ss_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(mcu_ss_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(mcu_ss_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(mcu_ss_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	mcu_ss_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:830f6e2d604d704e8f5cfaa15638d36c]
