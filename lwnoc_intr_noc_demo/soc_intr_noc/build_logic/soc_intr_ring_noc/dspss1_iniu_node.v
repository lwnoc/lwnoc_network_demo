//[UHDL]Content Start [md5:0462672ab9446c7f9e010e36d5cd1e75]
module dspss1_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] dspss1_iniu_node_sys_v_interrupt_porting_v_interrupt       ,
	input  [7:0]    dspss1_iniu_node_sys_iniu_src_id_porting_iniu_src_id       ,
	input  [31:0]   dspss1_iniu_node_sys_apb_porting_p_addr                    ,
	input           dspss1_iniu_node_sys_apb_porting_p_enable                  ,
	output [31:0]   dspss1_iniu_node_sys_apb_porting_p_rdata                   ,
	output          dspss1_iniu_node_sys_apb_porting_p_ready                   ,
	input           dspss1_iniu_node_sys_apb_porting_p_sel                     ,
	output          dspss1_iniu_node_sys_apb_porting_p_slverr                  ,
	input  [31:0]   dspss1_iniu_node_sys_apb_porting_p_wdata                   ,
	input           dspss1_iniu_node_sys_apb_porting_p_write                   ,
	input  [9:0]    dspss1_iniu_node_sys_timeout_val_porting_timeout_val       ,
	...
	//module inst.
	dspss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(dspss1_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(dspss1_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(dspss1_iniu_node_sys_apb_porting_p_addr),
		.p_sel(dspss1_iniu_node_sys_apb_porting_p_sel),
		.p_enable(dspss1_iniu_node_sys_apb_porting_p_enable),
		.p_write(dspss1_iniu_node_sys_apb_porting_p_write),
		.p_wdata(dspss1_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(dspss1_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(dspss1_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dspss1_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dspss1_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	dspss1_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:0462672ab9446c7f9e010e36d5cd1e75]
