//[UHDL]Content Start [md5:32c6382070063fa5a2afb4394f918656]
module gpu_ss0_iniu_node (
	...
	input  [4095:0] gpu_ss0_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                                ,
	input  [31:0]   gpu_ss0_iniu_node_sys_apb_porting_p_addr                                                                                                             ,
	input           gpu_ss0_iniu_node_sys_apb_porting_p_enable                                                                                                           ,
	output [31:0]   gpu_ss0_iniu_node_sys_apb_porting_p_rdata                                                                                                            ,
	output          gpu_ss0_iniu_node_sys_apb_porting_p_ready                                                                                                            ,
	input           gpu_ss0_iniu_node_sys_apb_porting_p_sel                                                                                                              ,
	output          gpu_ss0_iniu_node_sys_apb_porting_p_slverr                                                                                                           ,
	input  [31:0]   gpu_ss0_iniu_node_sys_apb_porting_p_wdata                                                                                                            ,
	input           gpu_ss0_iniu_node_sys_apb_porting_p_write                                                                                                            ,
	input  [9:0]    gpu_ss0_iniu_node_sys_timeout_val_porting_timeout_val                                                                                                ,
	...
	gpu_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(gpu_ss0_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(gpu_ss0_iniu_node_sys_apb_porting_p_addr),
		.p_sel(gpu_ss0_iniu_node_sys_apb_porting_p_sel),
		.p_enable(gpu_ss0_iniu_node_sys_apb_porting_p_enable),
		.p_write(gpu_ss0_iniu_node_sys_apb_porting_p_write),
		.p_wdata(gpu_ss0_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(gpu_ss0_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(gpu_ss0_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(gpu_ss0_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(gpu_ss0_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	gpu_ss0_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:32c6382070063fa5a2afb4394f918656]
