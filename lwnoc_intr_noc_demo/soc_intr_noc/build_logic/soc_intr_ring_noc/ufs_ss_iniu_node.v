//[UHDL]Content Start [md5:6745094552bae6d3bbd09a21cd173471]
module ufs_ss_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] ufs_ss_iniu_node_sys_v_interrupt_porting_v_interrupt       ,
	input  [7:0]    ufs_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id       ,
	input  [31:0]   ufs_ss_iniu_node_sys_apb_porting_p_addr                    ,
	input           ufs_ss_iniu_node_sys_apb_porting_p_enable                  ,
	output [31:0]   ufs_ss_iniu_node_sys_apb_porting_p_rdata                   ,
	output          ufs_ss_iniu_node_sys_apb_porting_p_ready                   ,
	input           ufs_ss_iniu_node_sys_apb_porting_p_sel                     ,
	output          ufs_ss_iniu_node_sys_apb_porting_p_slverr                  ,
	input  [31:0]   ufs_ss_iniu_node_sys_apb_porting_p_wdata                   ,
	input           ufs_ss_iniu_node_sys_apb_porting_p_write                   ,
	input  [9:0]    ufs_ss_iniu_node_sys_timeout_val_porting_timeout_val       ,
	...
	//module inst.
	ufs_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(ufs_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(ufs_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(ufs_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(ufs_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(ufs_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(ufs_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(ufs_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(ufs_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(ufs_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(ufs_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(ufs_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	ufs_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:6745094552bae6d3bbd09a21cd173471]
