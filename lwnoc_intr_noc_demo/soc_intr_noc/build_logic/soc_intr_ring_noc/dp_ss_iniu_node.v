//[UHDL]Content Start [md5:3f7f498f4fe2925dd56d60a252f497b7]
module dp_ss_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] dp_ss_iniu_node_sys_v_interrupt_porting_v_interrupt        ,
	input  [7:0]    dp_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id        ,
	input  [31:0]   dp_ss_iniu_node_sys_apb_porting_p_addr                     ,
	input           dp_ss_iniu_node_sys_apb_porting_p_enable                   ,
	output [31:0]   dp_ss_iniu_node_sys_apb_porting_p_rdata                    ,
	output          dp_ss_iniu_node_sys_apb_porting_p_ready                    ,
	input           dp_ss_iniu_node_sys_apb_porting_p_sel                      ,
	output          dp_ss_iniu_node_sys_apb_porting_p_slverr                   ,
	input  [31:0]   dp_ss_iniu_node_sys_apb_porting_p_wdata                    ,
	input           dp_ss_iniu_node_sys_apb_porting_p_write                    ,
	input  [9:0]    dp_ss_iniu_node_sys_timeout_val_porting_timeout_val        ,
	...
	//module inst.
	dp_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(dp_ss_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(dp_ss_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(dp_ss_iniu_node_sys_apb_porting_p_addr),
		.p_sel(dp_ss_iniu_node_sys_apb_porting_p_sel),
		.p_enable(dp_ss_iniu_node_sys_apb_porting_p_enable),
		.p_write(dp_ss_iniu_node_sys_apb_porting_p_write),
		.p_wdata(dp_ss_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(dp_ss_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(dp_ss_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dp_ss_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dp_ss_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	dp_ss_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:3f7f498f4fe2925dd56d60a252f497b7]
