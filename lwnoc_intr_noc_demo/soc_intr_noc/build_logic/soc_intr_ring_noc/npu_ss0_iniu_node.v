//[UHDL]Content Start [md5:b99deb2de0aeeaa2db19ce90edf1cf2e]
module npu_ss0_iniu_node (
	...
	input  [4095:0] npu_ss0_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                                ,
	input  [31:0]   npu_ss0_iniu_node_sys_apb_porting_p_addr                                                                                                             ,
	input           npu_ss0_iniu_node_sys_apb_porting_p_enable                                                                                                           ,
	output [31:0]   npu_ss0_iniu_node_sys_apb_porting_p_rdata                                                                                                            ,
	output          npu_ss0_iniu_node_sys_apb_porting_p_ready                                                                                                            ,
	input           npu_ss0_iniu_node_sys_apb_porting_p_sel                                                                                                              ,
	output          npu_ss0_iniu_node_sys_apb_porting_p_slverr                                                                                                           ,
	input  [31:0]   npu_ss0_iniu_node_sys_apb_porting_p_wdata                                                                                                            ,
	input           npu_ss0_iniu_node_sys_apb_porting_p_write                                                                                                            ,
	input  [9:0]    npu_ss0_iniu_node_sys_timeout_val_porting_timeout_val                                                                                                ,
	...
	//module inst.
	npu_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.v_interrupt(npu_ss0_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(npu_ss0_iniu_node_sys_apb_porting_p_addr),
		.p_sel(npu_ss0_iniu_node_sys_apb_porting_p_sel),
		.p_enable(npu_ss0_iniu_node_sys_apb_porting_p_enable),
		.p_write(npu_ss0_iniu_node_sys_apb_porting_p_write),
		.p_wdata(npu_ss0_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(npu_ss0_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(npu_ss0_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(npu_ss0_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(npu_ss0_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	npu_ss0_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:b99deb2de0aeeaa2db19ce90edf1cf2e]
