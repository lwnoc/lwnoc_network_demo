//[UHDL]Content Start [md5:9d236f2b95ae3aab044d31167cfd8d32]
module dspss5_iniu_node (
	input           clk_sys_clk                                                ,
	...
	input  [4095:0] dspss5_iniu_node_sys_v_interrupt_porting_v_interrupt       ,
	input  [7:0]    dspss5_iniu_node_sys_iniu_src_id_porting_iniu_src_id       ,
	input  [31:0]   dspss5_iniu_node_sys_apb_porting_p_addr                    ,
	input           dspss5_iniu_node_sys_apb_porting_p_enable                  ,
	output [31:0]   dspss5_iniu_node_sys_apb_porting_p_rdata                   ,
	output          dspss5_iniu_node_sys_apb_porting_p_ready                   ,
	input           dspss5_iniu_node_sys_apb_porting_p_sel                     ,
	output          dspss5_iniu_node_sys_apb_porting_p_slverr                  ,
	input  [31:0]   dspss5_iniu_node_sys_apb_porting_p_wdata                   ,
	input           dspss5_iniu_node_sys_apb_porting_p_write                   ,
	input  [9:0]    dspss5_iniu_node_sys_timeout_val_porting_timeout_val       ,
	...
	dspss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(dspss5_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(dspss5_iniu_node_sys_iniu_src_id_porting_iniu_src_id),
		.p_addr(dspss5_iniu_node_sys_apb_porting_p_addr),
		.p_sel(dspss5_iniu_node_sys_apb_porting_p_sel),
		.p_enable(dspss5_iniu_node_sys_apb_porting_p_enable),
		.p_write(dspss5_iniu_node_sys_apb_porting_p_write),
		.p_wdata(dspss5_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(dspss5_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(dspss5_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dspss5_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dspss5_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	dspss5_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:9d236f2b95ae3aab044d31167cfd8d32]
