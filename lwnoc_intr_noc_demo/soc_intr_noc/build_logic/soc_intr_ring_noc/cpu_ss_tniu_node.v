//[UHDL]Content Start [md5:823c39d6765d0b77223ae3fda3640e03]
module cpu_ss_tniu_node (
	input           clk_sys_clk                                                                                                                              ,
	...
	output [4095:0] cpu_ss_tniu_node_sys_v_interrupt_porting_v_interrupt                                                                                     ,
	output [127:0]  cpu_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt                                                                         ,
	input  [31:0]   cpu_ss_tniu_node_sys_apb_porting_p_addr                                                                                                  ,
	input           cpu_ss_tniu_node_sys_apb_porting_p_enable                                                                                                ,
	output [31:0]   cpu_ss_tniu_node_sys_apb_porting_p_rdata                                                                                                 ,
	output          cpu_ss_tniu_node_sys_apb_porting_p_ready                                                                                                 ,
	input           cpu_ss_tniu_node_sys_apb_porting_p_sel                                                                                                   ,
	output          cpu_ss_tniu_node_sys_apb_porting_p_slverr                                                                                                ,
	input  [31:0]   cpu_ss_tniu_node_sys_apb_porting_p_wdata                                                                                                 ,
	input           cpu_ss_tniu_node_sys_apb_porting_p_write                                                                                                 ,
	input  [9:0]    cpu_ss_tniu_node_sys_timeout_val_porting_timeout_val                                                                                     ,
	...
	//module inst.
	cpu_ss_tniu_interrupt_tniu_async_sys_side tniu_sys (
		.clk(clk_sys_clk),
		.rst_n(rst_sys_n_rst_n),
		.tniu_tgt_id(),
		.v_interrupt(cpu_ss_tniu_node_sys_v_interrupt_porting_v_interrupt),
		.v_merge_interrupt(cpu_ss_tniu_node_sys_v_merge_interrupt_porting_v_merge_interrupt),
		.p_addr(cpu_ss_tniu_node_sys_apb_porting_p_addr),
		.p_sel(cpu_ss_tniu_node_sys_apb_porting_p_sel),
		.p_enable(cpu_ss_tniu_node_sys_apb_porting_p_enable),
		.p_write(cpu_ss_tniu_node_sys_apb_porting_p_write),
		.p_wdata(cpu_ss_tniu_node_sys_apb_porting_p_wdata),
		.p_ready(cpu_ss_tniu_node_sys_apb_porting_p_ready),
		.p_rdata(cpu_ss_tniu_node_sys_apb_porting_p_rdata),
		.p_slverr(cpu_ss_tniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(cpu_ss_tniu_node_sys_timeout_val_porting_timeout_val),
	...
	cpu_ss_tniu_node_top_wrap tniu_top_wrap (
...
//[UHDL]Content End [md5:823c39d6765d0b77223ae3fda3640e03]
