//[UHDL]Content Start [md5:f57ece3d85b6f99c2964c307fb4cffd6]
module dsp_ss3_iniu_node (
	...
	input  [4095:0] dsp_ss3_iniu_node_sys_v_interrupt_porting_v_interrupt                                                                                                ,
	input  [31:0]   dsp_ss3_iniu_node_sys_apb_porting_p_addr                                                                                                             ,
	input           dsp_ss3_iniu_node_sys_apb_porting_p_enable                                                                                                           ,
	output [31:0]   dsp_ss3_iniu_node_sys_apb_porting_p_rdata                                                                                                            ,
	output          dsp_ss3_iniu_node_sys_apb_porting_p_ready                                                                                                            ,
	input           dsp_ss3_iniu_node_sys_apb_porting_p_sel                                                                                                              ,
	output          dsp_ss3_iniu_node_sys_apb_porting_p_slverr                                                                                                           ,
	input  [31:0]   dsp_ss3_iniu_node_sys_apb_porting_p_wdata                                                                                                            ,
	input           dsp_ss3_iniu_node_sys_apb_porting_p_write                                                                                                            ,
	input  [9:0]    dsp_ss3_iniu_node_sys_timeout_val_porting_timeout_val                                                                                                ,
	...
	dsp_ss_iniu_interrupt_iniu_async_sys_side iniu_sys (
		...
		.v_interrupt(dsp_ss3_iniu_node_sys_v_interrupt_porting_v_interrupt),
		.iniu_src_id(),
		.p_addr(dsp_ss3_iniu_node_sys_apb_porting_p_addr),
		.p_sel(dsp_ss3_iniu_node_sys_apb_porting_p_sel),
		.p_enable(dsp_ss3_iniu_node_sys_apb_porting_p_enable),
		.p_write(dsp_ss3_iniu_node_sys_apb_porting_p_write),
		.p_wdata(dsp_ss3_iniu_node_sys_apb_porting_p_wdata),
		.p_ready(dsp_ss3_iniu_node_sys_apb_porting_p_ready),
		.p_rdata(dsp_ss3_iniu_node_sys_apb_porting_p_rdata),
		.p_slverr(dsp_ss3_iniu_node_sys_apb_porting_p_slverr),
		...
		.timeout_val(dsp_ss3_iniu_node_sys_timeout_val_porting_timeout_val),
	...
	dsp_ss3_iniu_node_top_wrap iniu_top_wrap (
...
//[UHDL]Content End [md5:f57ece3d85b6f99c2964c307fb4cffd6]
