module peri_ss_tniu_interrupt_tniu
    import peri_ss_tniu_interrupt_tniu_pkg::*;
#(
    ...
    logic                                       ecc_error;
    logic [33                           :0]     ecc_data_dec_in;
    logic [40                           :0]     ecc_reencode_data;
    ...
    logic                                       generate_regbank_parity_err;
    logic                                       internal_regbank_parity_err;
    logic [31                           :0]     internal_intr_message_rdata_unused [31:0];
    logic [31                           :0]     internal_intr_parity_hw_check_err_unused;
    ...
    fcip_ecc_enc #(
        .DATA_WIDTH     (34                     )
    ) u_interrupt_tniu_ecc_reenc (
        .data           (ecc_data_dec_in        ),
        .encode_data    (ecc_reencode_data      )
    );

    // Keep phase-1 interface compatibility: payload carries 6 check bits only.
    assign ecc_expected = ecc_reencode_data[6:1];
    ...
    peri_ss_tniu_interrupt_tniu_xbar_internal #(
    ...
    assign regbank_parity_err = generate_regbank_parity_err | internal_regbank_parity_err;
    ...
    peri_ss_tniu_interrupt_tniu_generate_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
        ...
        .intr_set      (intr_set               ),
        .intr_clr      (intr_clr               ),
        .parity_err    (generate_regbank_parity_err)
    ...
    //===========================================================================
    peri_ss_tniu_interrupt_tniu_mem_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    //===========================================================================
    peri_ss_tniu_Regbank_regbank_tniu_internal_intr u_apb_internal_reg_bank(
        .clk            (clk                    ),
        .rst_n          (rst_n                  ),
        ...
        .internal_intr_message_0_internal_intr_message_rdat(internal_intr_message_rdata_unused[0]          ),
        .internal_intr_message_0_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[0]   ),
        ...
        .internal_intr_message_1_internal_intr_message_rdat(internal_intr_message_rdata_unused[1]          ),
        .internal_intr_message_1_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[1]   ),
        ...
        .internal_intr_message_2_internal_intr_message_rdat(internal_intr_message_rdata_unused[2]          ),
        .internal_intr_message_2_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[2]   ),
        ...
        .internal_intr_message_3_internal_intr_message_rdat(internal_intr_message_rdata_unused[3]          ),
        .internal_intr_message_3_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[3]   ),
        ...
        .internal_intr_message_4_internal_intr_message_rdat(internal_intr_message_rdata_unused[4]          ),
        .internal_intr_message_4_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[4]   ),

        .internal_intr_message_5_internal_intr_message_wdat(32'b0                       ),
        .internal_intr_message_5_internal_intr_message_wena(1'b0                        ),
        .internal_intr_message_5_internal_intr_message_rdat(internal_intr_message_rdata_unused[5]          ),
        .internal_intr_message_5_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[5]   ),
        .internal_intr_message_6_internal_intr_message_wdat(32'b0                       ),
        .internal_intr_message_6_internal_intr_message_wena(1'b0                        ),
        .internal_intr_message_6_internal_intr_message_rdat(internal_intr_message_rdata_unused[6]          ),
        .internal_intr_message_6_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[6]   ),
        .internal_intr_message_7_internal_intr_message_wdat(32'b0                       ),
        .internal_intr_message_7_internal_intr_message_wena(1'b0                        ),
        .internal_intr_message_7_internal_intr_message_rdat(internal_intr_message_rdata_unused[7]          ),
        .internal_intr_message_7_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[7]   ),
        .internal_intr_message_8_internal_intr_message_wdat(32'b0                       ),
        .internal_intr_message_8_internal_intr_message_wena(1'b0                        ),
        .internal_intr_message_8_internal_intr_message_rdat(internal_intr_message_rdata_unused[8]          ),
        .internal_intr_message_8_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[8]   ),
        .internal_intr_message_9_internal_intr_message_wdat(32'b0                       ),
        .internal_intr_message_9_internal_intr_message_wena(1'b0                        ),
        .internal_intr_message_9_internal_intr_message_rdat(internal_intr_message_rdata_unused[9]          ),
        .internal_intr_message_9_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[9]   ),
        .internal_intr_message_10_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_10_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_10_internal_intr_message_rdat(internal_intr_message_rdata_unused[10]        ),
        .internal_intr_message_10_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[10] ),
        .internal_intr_message_11_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_11_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_11_internal_intr_message_rdat(internal_intr_message_rdata_unused[11]        ),
        .internal_intr_message_11_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[11] ),
        .internal_intr_message_12_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_12_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_12_internal_intr_message_rdat(internal_intr_message_rdata_unused[12]        ),
        .internal_intr_message_12_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[12] ),
        .internal_intr_message_13_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_13_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_13_internal_intr_message_rdat(internal_intr_message_rdata_unused[13]        ),
        .internal_intr_message_13_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[13] ),
        .internal_intr_message_14_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_14_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_14_internal_intr_message_rdat(internal_intr_message_rdata_unused[14]        ),
        .internal_intr_message_14_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[14] ),
        .internal_intr_message_15_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_15_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_15_internal_intr_message_rdat(internal_intr_message_rdata_unused[15]        ),
        .internal_intr_message_15_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[15] ),
        .internal_intr_message_16_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_16_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_16_internal_intr_message_rdat(internal_intr_message_rdata_unused[16]        ),
        .internal_intr_message_16_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[16] ),
        .internal_intr_message_17_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_17_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_17_internal_intr_message_rdat(internal_intr_message_rdata_unused[17]        ),
        .internal_intr_message_17_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[17] ),
        .internal_intr_message_18_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_18_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_18_internal_intr_message_rdat(internal_intr_message_rdata_unused[18]        ),
        .internal_intr_message_18_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[18] ),
        .internal_intr_message_19_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_19_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_19_internal_intr_message_rdat(internal_intr_message_rdata_unused[19]        ),
        .internal_intr_message_19_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[19] ),
        .internal_intr_message_20_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_20_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_20_internal_intr_message_rdat(internal_intr_message_rdata_unused[20]        ),
        .internal_intr_message_20_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[20] ),
        .internal_intr_message_21_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_21_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_21_internal_intr_message_rdat(internal_intr_message_rdata_unused[21]        ),
        .internal_intr_message_21_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[21] ),
        .internal_intr_message_22_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_22_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_22_internal_intr_message_rdat(internal_intr_message_rdata_unused[22]        ),
        .internal_intr_message_22_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[22] ),
        .internal_intr_message_23_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_23_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_23_internal_intr_message_rdat(internal_intr_message_rdata_unused[23]        ),
        .internal_intr_message_23_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[23] ),
        .internal_intr_message_24_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_24_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_24_internal_intr_message_rdat(internal_intr_message_rdata_unused[24]        ),
        .internal_intr_message_24_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[24] ),
        .internal_intr_message_25_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_25_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_25_internal_intr_message_rdat(internal_intr_message_rdata_unused[25]        ),
        .internal_intr_message_25_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[25] ),
        .internal_intr_message_26_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_26_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_26_internal_intr_message_rdat(internal_intr_message_rdata_unused[26]        ),
        .internal_intr_message_26_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[26] ),
        .internal_intr_message_27_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_27_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_27_internal_intr_message_rdat(internal_intr_message_rdata_unused[27]        ),
        .internal_intr_message_27_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[27] ),
        .internal_intr_message_28_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_28_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_28_internal_intr_message_rdat(internal_intr_message_rdata_unused[28]        ),
        .internal_intr_message_28_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[28] ),
        .internal_intr_message_29_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_29_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_29_internal_intr_message_rdat(internal_intr_message_rdata_unused[29]        ),
        .internal_intr_message_29_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[29] ),
        .internal_intr_message_30_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_30_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_30_internal_intr_message_rdat(internal_intr_message_rdata_unused[30]        ),
        .internal_intr_message_30_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[30] ),
        .internal_intr_message_31_internal_intr_message_wdat(32'b0                      ),
        .internal_intr_message_31_internal_intr_message_wena(1'b0                       ),
        .internal_intr_message_31_internal_intr_message_rdat(internal_intr_message_rdata_unused[31]        ),
        .internal_intr_message_31_parity_hw_check_err       (internal_intr_parity_hw_check_err_unused[31] ),
        .parity_sw_check_err(internal_regbank_parity_err                                )
    );
    ...
    peri_ss_tniu_interrupt_tniu_event_conflict_check #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    //===========================================================================
    peri_ss_tniu_interrupt_tniu_context #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
    ...
    generate
        for(genvar i=0; i<INTERRUPT_NUM/32; i=i+1) begin : GEN_INTR_MERGE
            ...
            peri_ss_tniu_interrupt_tniu_event_merge u_interrupt_tniu_event_merge(
                .clk            (clk                        ),
                .rst_n          (rst_n                      ),
        ...
        for(genvar i=0; i<INTERRUPT_NUM; i=i+1) begin : GEN_INTR_NORMAL
            if(i<INTERNAL_INTR_NUM) begin : GEN_INTERNAL_EN
                peri_ss_tniu_interrupt_tniu_event_repeater u_interrupt_tniu_event_repeater(
                    .clk            (clk                        ),
                    .rst_n          (rst_n                      ),
