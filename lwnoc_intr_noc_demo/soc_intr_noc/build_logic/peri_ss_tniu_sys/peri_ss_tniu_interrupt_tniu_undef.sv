...
`endif
`ifdef peri_ss_tniu_INTR_TNIU_INTERRUPT_MAX_NUM
    `undef INTR_TNIU_INTERRUPT_MAX_NUM
`endif
`ifdef peri_ss_tniu_INTR_TNIU_TIME_OUT_WIDTH
    `undef INTR_TNIU_TIME_OUT_WIDTH
`endif
`ifdef peri_ss_tniu_INTR_TNIU_SYS_ASYNC_FIFO_DEPTH
    `undef INTR_TNIU_SYS_ASYNC_FIFO_DEPTH
`endif
`ifdef peri_ss_tniu_INTR_TNIU_TOP_ASYNC_FIFO_DEPTH
    `undef INTR_TNIU_TOP_ASYNC_FIFO_DEPTH
`endif
`ifdef peri_ss_tniu_INTR_TNIU_FUSA_ECC_EN
    `undef INTR_TNIU_FUSA_ECC_EN
`endif
`ifdef peri_ss_tniu_INTR_TNIU_ERR_INT_CNT_WIDTH
