module mipi_ss_iniu_interrupt_iniu_async_top_side

    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import mipi_ss_iniu_interrupt_iniu_pkg::*;
#(
    parameter integer unsigned ASYNC_FIFO_DEPTH  = `mipi_ss_iniu_INTR_INIU_TOP_ASYNC_FIFO_DEPTH,
    parameter logic            FUSA_ECC_EN       = `mipi_ss_iniu_INTR_INIU_FUSA_ECC_EN,
