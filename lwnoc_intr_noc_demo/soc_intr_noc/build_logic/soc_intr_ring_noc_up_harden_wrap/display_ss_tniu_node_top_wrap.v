//[UHDL]Content Start [md5:838bba8cfbce2e65d10361d5132f1e02]
module display_ss_tniu_node_top_wrap (
	input         clk                                                              ,
	input         rst_n                                                            ,
	...
	input  [9:0]  display_ss_tniu_node_top_wrap_top_timeout_val_porting_timeout_val);
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_7_node_id_width_8 node_id_gen_top (
		.node_id(node_id));
	intr_tniu_top_interrupt_tniu_async_top_side tniu_top (
		...
		.timeout_val(display_ss_tniu_node_top_wrap_top_timeout_val_porting_timeout_val),
...
//[UHDL]Content End [md5:838bba8cfbce2e65d10361d5132f1e02]
