//[UHDL]Content Start [md5:85459014a772d369299a15a0b0504ee5]
module ddr11_tniu_noc_side (
	input         clk_top_func                                                 ,
	...
	input  [4:0]  ddr11_tniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id  ,
	output        ddr11_tniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit);
	...
	soc_intr_xbar_routing_lut_w5_c1 xbar_routing_lut (
		.src_id(node_id),
		.xbar_ch0_tgt_id(ddr11_tniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id),
		.xbar_ch0_sel_bit(ddr11_tniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit));
	interrupt_tniu_async_top_side tniu_top (
		...
		.req_threshold());
	ddr11_tniu_noc_side_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:85459014a772d369299a15a0b0504ee5]
