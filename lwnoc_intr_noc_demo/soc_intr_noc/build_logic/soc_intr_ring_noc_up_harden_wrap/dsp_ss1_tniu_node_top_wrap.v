//[UHDL]Content Start [md5:54cf4479138332c4d025e9e78ad3fc49]
module dsp_ss1_tniu_node_top_wrap (
	input         clk                                                           ,
	input         rst_n                                                         ,
	...
	input  [9:0]  dsp_ss1_tniu_node_top_wrap_top_timeout_val_porting_timeout_val);
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_24_node_id_width_8 node_id_gen_top (
		.node_id(node_id));
	intr_tniu_top_interrupt_tniu_async_top_side tniu_top (
		...
		.timeout_val(dsp_ss1_tniu_node_top_wrap_top_timeout_val_porting_timeout_val),
...
//[UHDL]Content End [md5:54cf4479138332c4d025e9e78ad3fc49]
