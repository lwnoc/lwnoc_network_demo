//[UHDL]Content Start [md5:19ba9cdb48409aab6730f1e83f7cf540]
module ddr6_iniu_node_top_wrap (
	input         clk                                                               ,
	input         rst_n                                                             ,
	...
	output        ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(ddr6_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:19ba9cdb48409aab6730f1e83f7cf540]
