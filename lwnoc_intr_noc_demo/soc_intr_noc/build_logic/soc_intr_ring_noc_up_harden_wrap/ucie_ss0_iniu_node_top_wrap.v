//[UHDL]Content Start [md5:24d3b07a31886d16c04b3258370a03cd]
module ucie_ss0_iniu_node_top_wrap (
	input         clk                                                                   ,
	input         rst_n                                                                 ,
	...
	output        ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_1_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(ucie_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:24d3b07a31886d16c04b3258370a03cd]
