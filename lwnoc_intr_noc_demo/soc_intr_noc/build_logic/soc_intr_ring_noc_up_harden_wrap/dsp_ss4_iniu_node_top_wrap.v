//[UHDL]Content Start [md5:a58b035ab6eee10785a758698ffe5ce4]
module dsp_ss4_iniu_node_top_wrap (
	input         clk                                                                  ,
	input         rst_n                                                                ,
	...
	output        dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_17_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(dsp_ss4_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:a58b035ab6eee10785a758698ffe5ce4]
