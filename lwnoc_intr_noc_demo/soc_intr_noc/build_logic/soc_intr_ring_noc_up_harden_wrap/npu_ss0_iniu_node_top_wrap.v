//[UHDL]Content Start [md5:64001ba2b293b0a9c4ad2da44db8321b]
module npu_ss0_iniu_node_top_wrap (
	input         clk                                                                  ,
	input         rst_n                                                                ,
	...
	output        npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	endpoint_wrap (
		...
		.local_rx_valid(npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(npu_ss0_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:64001ba2b293b0a9c4ad2da44db8321b]
