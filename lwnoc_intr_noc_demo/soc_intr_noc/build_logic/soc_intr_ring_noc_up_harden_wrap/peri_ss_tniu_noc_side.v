//[UHDL]Content Start [md5:f80d26ac947d5c6600f21ed1b6b95c44]
module peri_ss_tniu_noc_side (
	input         clk_top_func                                                   ,
	...
	input  [4:0]  peri_ss_tniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id  ,
	output        peri_ss_tniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit);
	...
	soc_intr_xbar_routing_lut_w5_c1 xbar_routing_lut (
		.src_id(node_id),
		.xbar_ch0_tgt_id(peri_ss_tniu_xbar_lut_xbar_ch0_tgt_id_porting_xbar_ch0_tgt_id),
		.xbar_ch0_sel_bit(peri_ss_tniu_xbar_lut_xbar_ch0_sel_bit_porting_xbar_ch0_sel_bit));
	interrupt_tniu_async_top_side tniu_top (
		...
		.req_threshold());
	peri_ss_tniu_noc_side_ring ring_wrap (
		.clk(clk_top_func),
		.rst_n(rst_top_func_n),
...
//[UHDL]Content End [md5:f80d26ac947d5c6600f21ed1b6b95c44]
