//[UHDL]Content Start [md5:315f249b169385885382017933a3d5a8]
module audio_ss_iniu_node_top_wrap (
	...
	intr_iniu_top_interrupt_iniu_async_top_side iniu_top (
		...
		.req_threshold());
	audio_ss_iniu_node_top_wrap_ring ring_wrap (
		.clk(clk),
		.rst_n(rst_n),
...
//[UHDL]Content End [md5:315f249b169385885382017933a3d5a8]
