//[UHDL]Content Start [md5:96d202e60d585db3fbbebd0bc568b456]
module audio_ss_iniu_node_top_wrap (
	input         clk                                                                   ,
	input         rst_n                                                                 ,
	...
	output        audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last   ,
	output [39:0] audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload,
	output [3:0]  audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos    ,
	input         audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready  ,
	output [7:0]  audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid  ,
	output [7:0]  audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid  ,
	output        audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid  );
	...
	//module inst.
	SocIntrNodeIdGen_node_id_value_2_node_id_width_8 node_id_gen_top (
	...
	endpoint_wrap (
		...
		.local_rx_valid(audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_valid),
		.local_rx_ready(audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_ready),
		.local_rx_payload(audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_payload),
		.local_rx_srcid(audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_srcid),
		.local_rx_tgtid(audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_tgtid),
		.local_rx_qos(audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_qos),
		.local_rx_last(audio_ss_iniu_node_top_wrap_endpoint_local_rx_porting_local_rx_last),
...
//[UHDL]Content End [md5:96d202e60d585db3fbbebd0bc568b456]
