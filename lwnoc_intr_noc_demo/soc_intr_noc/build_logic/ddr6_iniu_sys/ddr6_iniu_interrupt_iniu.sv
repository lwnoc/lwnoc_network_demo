module ddr6_iniu_interrupt_iniu
...
`ifndef VERILATOR
    generate
        for(genvar i = 0; i < INTERRUPT_NUM; i=i+1) begin : gen_interrupt_iniu_event_recorder
            ddr6_iniu_interrupt_iniu_event_recorder #(
                .INTERRUPT_ID   (i                      )
...
`endif
    ...
    // APB reg bank
    //===========================================================================
    ddr6_iniu_interrupt_iniu_reg_bank #(
        .INTERRUPT_NUM  (INTERRUPT_NUM          )
