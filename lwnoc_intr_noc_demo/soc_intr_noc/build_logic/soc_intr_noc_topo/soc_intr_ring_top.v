//[UHDL]Content Start [md5:59b26905c33804af177829a557067cc3]
module soc_intr_ring_top (
	...
	wire        ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_last                ;
	wire [39:0] ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_payload             ;
	wire [3:0]  ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_qos                 ;
	wire [7:0]  ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_srcid               ;
	wire [7:0]  ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_tgtid               ;
	wire        ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_valid               ;
	...
	wire        ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_nring_in_if_nring_in_if_ready                 ;
	...
	wire        ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_pring_in_if_pring_in_if_ready                     ;
	wire        ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_last                    ;
	wire [39:0] ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_payload                 ;
	wire [3:0]  ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_qos                     ;
	wire [7:0]  ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_srcid                   ;
	wire [7:0]  ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_tgtid                   ;
	wire        ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_valid                   ;
	wire        ddr4_iniu_TO_ddr5_iniu_SIG_nring_in_if_nring_in_if_nring_in_if_ready                       ;
	wire        ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_last       ;
	wire [39:0] ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_payload    ;
	wire [3:0]  ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_qos        ;
	wire [7:0]  ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_srcid      ;
	wire [7:0]  ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_tgtid      ;
	wire        ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_valid      ;
	wire        ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_in_if_pring_in_if_pring_in_if_ready     ;
	wire        ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_last   ;
	wire [39:0] ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_payload;
	wire [3:0]  ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_qos    ;
	wire [7:0]  ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_srcid  ;
	wire [7:0]  ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_tgtid  ;
	wire        ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_valid  ;
	wire        ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_in_if_nring_in_if_nring_in_if_ready         ;
	...
	ucie_ss0_iniu ucie_ss0_iniu (
		...
		.pring_in_if_pring_in_if_pring_in_if_last(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_last),
		.pring_in_if_pring_in_if_pring_in_if_payload(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_payload),
		.pring_in_if_pring_in_if_pring_in_if_qos(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_qos),
		.pring_in_if_pring_in_if_pring_in_if_ready(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_in_if_pring_in_if_pring_in_if_ready),
		.pring_in_if_pring_in_if_pring_in_if_srcid(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_srcid),
		.pring_in_if_pring_in_if_pring_in_if_tgtid(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_tgtid),
		.pring_in_if_pring_in_if_pring_in_if_valid(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_valid),
		...
		.nring_out_if_nring_out_if_nring_out_if_last(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_last),
		.nring_out_if_nring_out_if_nring_out_if_payload(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_payload),
		.nring_out_if_nring_out_if_nring_out_if_qos(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_qos),
		.nring_out_if_nring_out_if_nring_out_if_ready(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_nring_in_if_nring_in_if_ready),
		.nring_out_if_nring_out_if_nring_out_if_srcid(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_srcid),
		.nring_out_if_nring_out_if_nring_out_if_tgtid(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_tgtid),
		.nring_out_if_nring_out_if_nring_out_if_valid(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_valid),
	...
	ddr5_iniu ddr5_iniu (
		...
		.pring_out_if_pring_out_if_pring_out_if_last(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_last),
		.pring_out_if_pring_out_if_pring_out_if_payload(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_payload),
		.pring_out_if_pring_out_if_pring_out_if_qos(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_qos),
		.pring_out_if_pring_out_if_pring_out_if_ready(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_pring_in_if_pring_in_if_ready),
		.pring_out_if_pring_out_if_pring_out_if_srcid(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_srcid),
		.pring_out_if_pring_out_if_pring_out_if_tgtid(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_tgtid),
		.pring_out_if_pring_out_if_pring_out_if_valid(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_valid),
		.nring_in_if_nring_in_if_nring_in_if_last(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_last),
		.nring_in_if_nring_in_if_nring_in_if_payload(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_payload),
		.nring_in_if_nring_in_if_nring_in_if_qos(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_qos),
		.nring_in_if_nring_in_if_nring_in_if_ready(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_in_if_nring_in_if_nring_in_if_ready),
		.nring_in_if_nring_in_if_nring_in_if_srcid(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_srcid),
		.nring_in_if_nring_in_if_nring_in_if_tgtid(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_tgtid),
		.nring_in_if_nring_in_if_nring_in_if_valid(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_valid),
	...
	ring_async_cut_dn_to_up ring_async_cut_dn_to_up (
		...
		.pring_in_if_pring_in_if_last(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_last),
		.pring_in_if_pring_in_if_payload(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_payload),
		.pring_in_if_pring_in_if_qos(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_qos),
		.pring_in_if_pring_in_if_ready(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_pring_in_if_pring_in_if_ready),
		.pring_in_if_pring_in_if_srcid(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_srcid),
		.pring_in_if_pring_in_if_tgtid(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_tgtid),
		.pring_in_if_pring_in_if_valid(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_out_if_pring_out_if_pring_out_if_valid),
		.pring_out_if_pring_out_if_last(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_last),
		.pring_out_if_pring_out_if_payload(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_payload),
		.pring_out_if_pring_out_if_qos(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_qos),
		.pring_out_if_pring_out_if_ready(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_pring_in_if_pring_in_if_pring_in_if_ready),
		.pring_out_if_pring_out_if_srcid(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_srcid),
		.pring_out_if_pring_out_if_tgtid(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_tgtid),
		.pring_out_if_pring_out_if_valid(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_pring_out_if_pring_out_if_valid),
		.nring_in_if_nring_in_if_last(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_last),
		.nring_in_if_nring_in_if_payload(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_payload),
		.nring_in_if_nring_in_if_qos(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_qos),
		.nring_in_if_nring_in_if_ready(ring_async_cut_dn_to_up_TO_ucie_ss0_iniu_SIG_nring_in_if_nring_in_if_ready),
		.nring_in_if_nring_in_if_srcid(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_srcid),
		.nring_in_if_nring_in_if_tgtid(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_tgtid),
		.nring_in_if_nring_in_if_valid(ucie_ss0_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_out_if_nring_out_if_nring_out_if_valid),
		.nring_out_if_nring_out_if_last(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_last),
		.nring_out_if_nring_out_if_payload(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_payload),
		.nring_out_if_nring_out_if_qos(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_qos),
		.nring_out_if_nring_out_if_ready(ddr5_iniu_TO_ring_async_cut_dn_to_up_SIG_nring_in_if_nring_in_if_nring_in_if_ready),
		.nring_out_if_nring_out_if_srcid(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_srcid),
		.nring_out_if_nring_out_if_tgtid(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_tgtid),
		.nring_out_if_nring_out_if_valid(ring_async_cut_dn_to_up_TO_ddr5_iniu_SIG_nring_out_if_nring_out_if_valid));

endmodule
//[UHDL]Content End [md5:59b26905c33804af177829a557067cc3]
