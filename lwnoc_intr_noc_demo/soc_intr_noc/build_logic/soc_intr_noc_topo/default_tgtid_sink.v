//[UHDL]Content Start [md5:99afb8bb8112c43f93c6fee9c292276b]
module default_tgtid_sink (
	input         clk                                                               ,
	input         rst_n                                                             ,
	...
	input         default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_last   ,
	input  [39:0] default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_payload,
	input  [3:0]  default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_qos    ,
	output        default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_ready  ,
	input  [7:0]  default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_srcid  ,
	input  [7:0]  default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_tgtid  ,
	input         default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_valid  );
	...
	//module inst.
	default_tgtid_sink_ring ring_wrap (
		.clk(clk),
		.rst_n(rst_n),
		...
		.local_tx_local_tx_last(default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_last),
		.local_tx_local_tx_payload(default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_payload),
		.local_tx_local_tx_qos(default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_qos),
		.local_tx_local_tx_ready(default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_ready),
		.local_tx_local_tx_srcid(default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_srcid),
		.local_tx_local_tx_tgtid(default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_tgtid),
		.local_tx_local_tx_valid(default_tgtid_sink_ring_local_tx_porting_local_tx_local_tx_valid),
...
//[UHDL]Content End [md5:99afb8bb8112c43f93c6fee9c292276b]
