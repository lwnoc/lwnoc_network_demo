...
`endif
`ifndef camera_ss_tniu_INTR_TNIU_INTERRUPT_MAX_NUM
    `define camera_ss_tniu_INTR_TNIU_INTERRUPT_MAX_NUM               4096
`endif
`ifndef camera_ss_tniu_INTR_TNIU_TIME_OUT_WIDTH
    `define camera_ss_tniu_INTR_TNIU_TIME_OUT_WIDTH                  10
`endif
`ifndef camera_ss_tniu_INTR_TNIU_SYS_ASYNC_FIFO_DEPTH
    `define camera_ss_tniu_INTR_TNIU_SYS_ASYNC_FIFO_DEPTH            16
`endif
`ifndef camera_ss_tniu_INTR_TNIU_TOP_ASYNC_FIFO_DEPTH
    `define camera_ss_tniu_INTR_TNIU_TOP_ASYNC_FIFO_DEPTH            10
`endif
`ifndef camera_ss_tniu_INTR_TNIU_FUSA_ECC_EN
    `define camera_ss_tniu_INTR_TNIU_FUSA_ECC_EN                     1'b0
`endif
`ifndef camera_ss_tniu_INTR_TNIU_ERR_INT_CNT_WIDTH
    `define camera_ss_tniu_INTR_TNIU_ERR_INT_CNT_WIDTH               16
`endif
