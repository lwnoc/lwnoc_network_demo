module dsp_ss_iniu_interrupt_iniu_async_sys_side

    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import dsp_ss_iniu_interrupt_iniu_pkg::*;
#(
    parameter integer unsigned  INTERRUPT_NUM       = `dsp_ss_iniu_INTR_INIU_INTERRUPT_MAX_NUM,
    localparam integer unsigned INTERRUPT_NUM_WIDTH = $clog2(INTERRUPT_NUM),
    parameter integer unsigned  TIME_OUT_WIDTH      = `dsp_ss_iniu_INTR_INIU_TIME_OUT_WIDTH,
    parameter integer unsigned  ASYNC_FIFO_DEPTH    = `dsp_ss_iniu_INTR_INIU_SYS_ASYNC_FIFO_DEPTH,
    parameter integer unsigned  ERR_INT_CNT_WIDTH   = `dsp_ss_iniu_INTR_INIU_ERR_INT_CNT_WIDTH,
...
//===========================================================================
    ...
    generate
        if(INTERRUPT_NUM==4096)begin
            dsp_ss_iniu_spram_4096x26 u_sp_4096_26 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
            ...
            dsp_ss_iniu_spram_2048x26 u_sp_2048_26 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (spram_rd_ecc   ),
            ...
            dsp_ss_iniu_spram_1024x26 u_sp_1024_26 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (spram_rd_ecc   ),
            ...
            dsp_ss_iniu_spram_512x26 u_sp_512_26 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (spram_rd_ecc   ),
            ...
            dsp_ss_iniu_spram_256x26 u_sp_256_26 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (spram_rd_ecc   ),
            ...
            dsp_ss_iniu_spram_128x26 u_sp_128_26 (
                .clk        (clk            ),
                .en         (mem_en         ),
                .addr       (mem_addr       ),
                .rd_data    (spram_rd_ecc   ),
