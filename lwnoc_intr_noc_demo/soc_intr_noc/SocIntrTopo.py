...
RING_PLAN = [
    # ── Domain A (up) ──
    (0, "cpu_ss", "iniu", "a"), (1, "cpu_ss", "tniu", "a"),
    (2, "npu_ss0", "iniu", "a"), (3, "npu_ss0", "tniu", "a"),
    (4, "npu_ss1", "iniu", "a"), (5, "npu_ss1", "tniu", "a"),
    (6, "npu_ss2", "iniu", "a"), (7, "npu_ss2", "tniu", "a"),
    (8, "gpu_ss1", "iniu", "a"),
    (9, "mipi_ss", "iniu", "a"),
    (10, "dp_ss", "iniu", "a"),
    (11, "display_ss", "iniu", "a"),
    (12, "vpu_ss", "iniu", "a"),
    (13, "aon_ss", "iniu", "a"), (14, "aon_ss", "tniu", "a"),
    (15, "dsp_ss5", "iniu", "a"), (16, "dsp_ss5", "tniu", "a"),
    (17, "dsp_ss4", "iniu", "a"), (18, "dsp_ss4", "tniu", "a"),
    (19, "dsp_ss3", "iniu", "a"), (20, "dsp_ss3", "tniu", "a"),
    (21, "dsp_ss2", "iniu", "a"), (22, "dsp_ss2", "tniu", "a"),
    (23, "dsp_ss1", "iniu", "a"), (24, "dsp_ss1", "tniu", "a"),
    (25, "dsp_ss0", "iniu", "a"), (26, "dsp_ss0", "tniu", "a"),
    (27, "ddr6", "iniu", "a"), (28, "ddr7", "iniu", "a"),
    (29, "ddr8", "iniu", "a"), (30, "ddr9", "iniu", "a"),
    (31, "ddr10", "iniu", "a"), (32, "ddr11", "iniu", "a"),
    (33, "noc_ss", "iniu", "a"),
    # ── Domain B (dn) ──
    (34, "npu_ss3", "iniu", "b"), (35, "npu_ss3", "tniu", "b"),
    (36, "peri_ss", "iniu", "b"),
    (37, "gpu_ss0", "iniu", "b"),
    (38, "camera_ss", "iniu", "b"),
    (39, "ufs_ss", "iniu", "b"),
    (40, "pcie_eth_ss", "iniu", "b"),
    (41, "mcu_ss", "iniu", "b"), (42, "mcu_ss", "tniu", "b"),
    (43, "npu_ss4", "iniu", "b"), (44, "npu_ss4", "tniu", "b"),
    (45, "ddr0", "iniu", "b"), (46, "ddr1", "iniu", "b"),
    (47, "ddr2", "iniu", "b"), (48, "ddr3", "iniu", "b"),
    (49, "ddr4", "iniu", "b"), (50, "ddr5", "iniu", "b"),
]
