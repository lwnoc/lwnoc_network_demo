...
// Resolved source top module: dti_tniu_async_sys_side
// Representative config: tcu_tniu_sys_config (TemplateIPConfig name=cpu_tniu_sys)
module dti_tniu_sys_side_stub (
    ...
    input  logic [9:0]   req_wptr_async  ,  // async FIFO write pointer
    output logic [9:0]   req_rptr_async  ,  // async FIFO read pointer (async)
    output logic [9:0]   req_rptr_sync   ,  // async FIFO read pointer (sync)
    ...
    output logic [9:0]   rsp_wptr_async  ,  // async FIFO write pointer
    input  logic [9:0]   rsp_rptr_async  ,  // async FIFO read pointer (async)
    input  logic [9:0]   rsp_rptr_sync   ,  // async FIFO read pointer (sync)
