...
// Representative config: display_ss_tniu_cfg (TemplateIPConfig name=display_ss_tniu_sys)
module intr_tniu_sys_side_stub (
    input  logic [0:0]    clk                      ,
    input  logic [0:0]    rst_n                    ,
    input  logic [7:0]    tniu_tgt_id              ,
    ...
    input  logic [9:0]    wptr_async               ,
    output logic [9:0]    rptr_async               ,
    output logic [9:0]    rptr_sync                ,
