module `_PREFIX_(dti_switch_3i1o_wrap) #(
    ...
    logic [2:0]        iniu_req_valid_bus;
    logic [2:0]        iniu_req_ready_bus;
    logic [2:0][89:0]  iniu_req_payload_bus;
    logic [2:0][5:0]   iniu_req_srcid_bus;
    logic [2:0][5:0]   iniu_req_tgtid_bus;
    logic [2:0]        iniu_req_qos_bus;
    logic [2:0]        iniu_req_last_bus;
    logic [2:0]        iniu_req_threshold_bus;
    logic [2:0]        iniu_rsp_valid_bus;
    logic [2:0][89:0]  iniu_rsp_payload_bus;
    logic [2:0][5:0]   iniu_rsp_srcid_bus;
    logic [2:0][5:0]   iniu_rsp_tgtid_bus;
    logic [2:0]        iniu_rsp_qos_bus;
    logic [2:0]        iniu_rsp_last_bus;
    logic [2:0]        iniu_rsp_threshold_bus;
    ...
    assign iniu_req_valid_bus = {iniu2_req_valid, iniu1_req_valid, iniu0_req_valid};
    ...
    assign iniu_req_qos_bus = {iniu2_req_qos, iniu1_req_qos, iniu0_req_qos};
    assign iniu_req_last_bus = {iniu2_req_last, iniu1_req_last, iniu0_req_last};
    assign {iniu2_req_ready, iniu1_req_ready, iniu0_req_ready} = iniu_req_ready_bus;
    assign {iniu2_req_threshold, iniu1_req_threshold, iniu0_req_threshold} = iniu_req_threshold_bus;
    ...
    assign iniu_rsp_threshold_bus = {iniu2_rsp_threshold, iniu1_rsp_threshold, iniu0_rsp_threshold};
    ...
    `_PREFIX_(dti_noc_switch) #(
        ...
        .INIU_DECMIN   ({DTI_INIU2_MIN, DTI_INIU1_MIN, DTI_INIU0_MIN}),
        .INIU_DECMAX   ({DTI_INIU2_MAX, DTI_INIU1_MAX, DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
