module mipi_ss_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import mipi_ss_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `mipi_ss_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `mipi_ss_TRANSACTION_MAX_NUM,
