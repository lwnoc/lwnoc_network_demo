//[UHDL]Content Start [md5:0d3f18cf45eaf7e1dd6fd4f0b443d80c]
module sys_tcu_tniu_node
	...
	output logic [2-1:0] pchnl_ctrl_pchnl_ctrl_pactive      ,
	output                                                  pchnl_ctrl_pchnl_ctrl_pdeny        ,
	input                                                   pchnl_ctrl_pchnl_ctrl_preq         ,
	input logic [2-1:0]  pchnl_ctrl_pchnl_ctrl_pstate       ,
	input                                                   top_req_top_req_req_last           ,
	input  [89:0]                                           top_req_top_req_req_payload        ,
	input                                                   top_req_top_req_req_qos            ,
	output                                                  top_req_top_req_req_ready          ,
	input  [5:0]                                            top_req_top_req_req_srcid          ,
	input  [5:0]                                            top_req_top_req_req_tgtid          ,
	output                                                  top_req_top_req_req_threshold      ,
	input                                                   top_req_top_req_req_valid          ,
...
//[UHDL]Content End [md5:0d3f18cf45eaf7e1dd6fd4f0b443d80c]
