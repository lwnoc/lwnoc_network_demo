...
module dti_sw1_dti_noc_switch_6to1_wrap #(
    parameter int unsigned TID_WIDTH       = `dti_sw1_DTI_NOC_SWITCH_6TO1_WRAP_TID_WIDTH       ,
    parameter int unsigned PAYLOAD_WIDTH   = `dti_sw1_DTI_NOC_SWITCH_6TO1_WRAP_PAYLOAD_WIDTH   ,
    parameter logic [1*32-1:0] TNIU_DECMIN = `dti_sw1_DTI_NOC_SWITCH_6TO1_WRAP_TNIU_DECMIN     ,
    parameter logic [1*32-1:0] TNIU_DECMAX = `dti_sw1_DTI_NOC_SWITCH_6TO1_WRAP_TNIU_DECMAX     ,
    parameter logic [6*32-1:0] INIU_DECMIN = `dti_sw1_DTI_NOC_SWITCH_6TO1_WRAP_INIU_DECMIN     ,
    parameter logic [6*32-1:0] INIU_DECMAX = `dti_sw1_DTI_NOC_SWITCH_6TO1_WRAP_INIU_DECMAX
)(
    input  logic clk                                          ,
    input  logic rst_n                                        ,
