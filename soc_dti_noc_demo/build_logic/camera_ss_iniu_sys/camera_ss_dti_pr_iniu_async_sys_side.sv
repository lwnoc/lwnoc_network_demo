module camera_ss_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import camera_ss_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `camera_ss_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `camera_ss_TRANSACTION_MAX_NUM,
