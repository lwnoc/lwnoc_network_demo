module dsp_ss3_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import dsp_ss3_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `dsp_ss3_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `dsp_ss3_TRANSACTION_MAX_NUM,
