module soc_dti_sw_gpu4_dti_switch_4i1o_wrap #(
    ...
    soc_dti_sw_gpu4_dti_noc_switch #(
        .NUM_INIU      (4),
        .NUM_TNIU      (1),
        .TID_WIDTH     (6),
        .PAYLOAD_WIDTH (90),
        ...
        .INIU_DECMIN   ({DTI_INIU3_MIN, DTI_INIU2_MIN, DTI_INIU1_MIN, DTI_INIU0_MIN}),
        .INIU_DECMAX   ({DTI_INIU3_MAX, DTI_INIU2_MAX, DTI_INIU1_MAX, DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
