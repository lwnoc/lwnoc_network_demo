...
`ifndef pcie_eth_INIU_ASYNC_FIFO_DEPTH
    `define pcie_eth_INIU_ASYNC_FIFO_DEPTH 16
`endif

`ifndef pcie_eth_INIU_TIME_OUT_WIDTH
    `define pcie_eth_INIU_TIME_OUT_WIDTH 10
`endif

`ifndef pcie_eth_INIU_ROUTE_BASE
    `define pcie_eth_INIU_ROUTE_BASE 0
`endif

`ifndef pcie_eth_INIU_ERR_INT_CNT_WIDTH
    `define pcie_eth_INIU_ERR_INT_CNT_WIDTH 16
`endif
