module pcie_eth_dti_pr_rob_state_entry
...
#(
    ...
    localparam int unsigned                   TRANS_NUM_WIDTH = $clog2(TRANSACTION_MAX_NUM + 1);
    localparam logic [TRANS_NUM_WIDTH-1:0]   TRANS_NUM_MAX   = TRANSACTION_MAX_NUM;
    ...
    logic                                     normal_dis   ;
    logic                                     req_dis      ;
    logic [TRANS_NUM_WIDTH-1:0]               trans_num    ;
    logic                                     entry_release;
    logic                                     trans_finish ;
    logic                                     trans_req    ;
    ...
    assign trans_num_overflow = (trans_num >= TRANS_NUM_MAX);
    //=================================================
    // TRAN FINISH FLAG
    //=================================================
