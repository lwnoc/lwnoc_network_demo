...
`ifndef dti_tniu_top_TNIU_ASYNC_FIFO_DEPTH
    `define dti_tniu_top_TNIU_ASYNC_FIFO_DEPTH 10
`endif

`ifndef dti_tniu_top_TNIU_ERR_INT_CNT_WIDTH
    `define dti_tniu_top_TNIU_ERR_INT_CNT_WIDTH 16
`endif
