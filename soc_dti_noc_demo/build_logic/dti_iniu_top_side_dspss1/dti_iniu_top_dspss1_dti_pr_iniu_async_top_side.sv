module dti_iniu_top_dspss1_dti_pr_iniu_async_top_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import dti_iniu_top_dspss1_dti_iniu_pack::*;
    #(
        parameter integer unsigned ASYNC_FIFO_DEPTH   = `dti_iniu_top_dspss1_INIU_ASYNC_FIFO_DEPTH,
        parameter integer unsigned ROUTE_BASE         = `dti_iniu_top_dspss1_INIU_ROUTE_BASE,
        ...
        parameter integer unsigned  ERR_INT_CNT_WIDTH = `dti_iniu_top_dspss1_INIU_ERR_INT_CNT_WIDTH
    )(
    input   logic                                              clk           ,
    input   logic                                              rst_n         ,
    // RSP_data channel
