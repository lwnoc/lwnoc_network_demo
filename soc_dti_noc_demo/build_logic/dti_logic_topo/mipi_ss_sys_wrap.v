//[UHDL]Content Start [md5:23660a71a1ebf36a71e8429a2d3e2a68]
module mipi_ss_sys_wrap (
	input          clk_sys_clk                                               ,
	...
	output         mipi_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         mipi_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	mipi_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(mipi_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(mipi_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:23660a71a1ebf36a71e8429a2d3e2a68]
