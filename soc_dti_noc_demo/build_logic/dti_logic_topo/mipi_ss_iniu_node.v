//[UHDL]Content Start [md5:b789e3e1caf6124b4d6a824387982be7]
module mipi_ss_iniu_node (
	...
	output        mipi_ss_sys_wrap_mipi_ss_sys_side_rsp_afifo_sb_err_porting_mipi_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        mipi_ss_sys_wrap_mipi_ss_sys_side_rsp_afifo_db_err_porting_mipi_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	mipi_ss_sys_wrap sys_wrap (
		...
		.mipi_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(mipi_ss_sys_wrap_mipi_ss_sys_side_rsp_afifo_sb_err_porting_mipi_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.mipi_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(mipi_ss_sys_wrap_mipi_ss_sys_side_rsp_afifo_db_err_porting_mipi_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	mipi_ss_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:b789e3e1caf6124b4d6a824387982be7]
