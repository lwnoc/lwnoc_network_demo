//[UHDL]Content Start [md5:e1e91b86860a7796e0fff95f0f80cee0]
module dspss1_iniu_node (
	...
	output        dspss1_sys_wrap_dspss1_sys_side_rsp_afifo_sb_err_porting_dspss1_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        dspss1_sys_wrap_dspss1_sys_side_rsp_afifo_db_err_porting_dspss1_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	dspss1_sys_wrap sys_wrap (
		...
		.dspss1_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(dspss1_sys_wrap_dspss1_sys_side_rsp_afifo_sb_err_porting_dspss1_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.dspss1_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(dspss1_sys_wrap_dspss1_sys_side_rsp_afifo_db_err_porting_dspss1_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	dspss1_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:e1e91b86860a7796e0fff95f0f80cee0]
