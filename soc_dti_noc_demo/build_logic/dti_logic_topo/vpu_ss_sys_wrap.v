//[UHDL]Content Start [md5:4f4a9c3ed4d9cc84d488b321f4cbd0da]
module vpu_ss_sys_wrap (
	input          clk_sys_clk                                              ,
	...
	output         vpu_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         vpu_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	vpu_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(vpu_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(vpu_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:4f4a9c3ed4d9cc84d488b321f4cbd0da]
