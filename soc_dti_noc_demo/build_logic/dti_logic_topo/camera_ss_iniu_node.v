//[UHDL]Content Start [md5:1a2c704c8e629b4193fd40be5aa64560]
module camera_ss_iniu_node (
	...
	output        camera_ss_sys_wrap_camera_ss_sys_side_rsp_afifo_sb_err_porting_camera_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        camera_ss_sys_wrap_camera_ss_sys_side_rsp_afifo_db_err_porting_camera_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	camera_ss_sys_wrap sys_wrap (
		...
		.camera_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(camera_ss_sys_wrap_camera_ss_sys_side_rsp_afifo_sb_err_porting_camera_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.camera_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(camera_ss_sys_wrap_camera_ss_sys_side_rsp_afifo_db_err_porting_camera_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	camera_ss_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:1a2c704c8e629b4193fd40be5aa64560]
