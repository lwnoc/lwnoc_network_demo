//[UHDL]Content Start [md5:d12622ce2d6398bbdfcd0d2d994ac6bb]
module display_ss_sys_wrap (
	input          clk_sys_clk                                                  ,
	...
	output         display_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         display_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	display_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(display_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(display_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:d12622ce2d6398bbdfcd0d2d994ac6bb]
