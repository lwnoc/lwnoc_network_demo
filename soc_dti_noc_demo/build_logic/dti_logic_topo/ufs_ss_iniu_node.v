//[UHDL]Content Start [md5:57b48e48068758babae5a23d374fcd19]
module ufs_ss_iniu_node (
	...
	output        ufs_ss_sys_wrap_ufs_ss_sys_side_rsp_afifo_sb_err_porting_ufs_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        ufs_ss_sys_wrap_ufs_ss_sys_side_rsp_afifo_db_err_porting_ufs_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	ufs_ss_sys_wrap sys_wrap (
		...
		.ufs_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(ufs_ss_sys_wrap_ufs_ss_sys_side_rsp_afifo_sb_err_porting_ufs_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.ufs_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(ufs_ss_sys_wrap_ufs_ss_sys_side_rsp_afifo_db_err_porting_ufs_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	ufs_ss_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:57b48e48068758babae5a23d374fcd19]
