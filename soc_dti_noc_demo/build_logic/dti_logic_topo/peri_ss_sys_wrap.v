//[UHDL]Content Start [md5:686884bcc1b7d2f4e51ff075b2fb5688]
module peri_ss_sys_wrap (
	input          clk_sys_clk                                               ,
	...
	output         peri_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         peri_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	peri_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(peri_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(peri_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:686884bcc1b7d2f4e51ff075b2fb5688]
