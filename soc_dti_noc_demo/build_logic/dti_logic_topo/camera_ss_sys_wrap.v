//[UHDL]Content Start [md5:4d5e46a164568ae64846b50bc5f5b7e3]
module camera_ss_sys_wrap (
	input          clk_sys_clk                                                 ,
	...
	output         camera_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         camera_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	camera_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(camera_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(camera_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:4d5e46a164568ae64846b50bc5f5b7e3]
