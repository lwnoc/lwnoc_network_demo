//[UHDL]Content Start [md5:c55bb925e84d6d8face4f6e57c53de84]
module peri_ss_iniu_node (
	...
	output        peri_ss_sys_wrap_peri_ss_sys_side_rsp_afifo_sb_err_porting_peri_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        peri_ss_sys_wrap_peri_ss_sys_side_rsp_afifo_db_err_porting_peri_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	peri_ss_sys_wrap sys_wrap (
		...
		.peri_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(peri_ss_sys_wrap_peri_ss_sys_side_rsp_afifo_sb_err_porting_peri_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.peri_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(peri_ss_sys_wrap_peri_ss_sys_side_rsp_afifo_db_err_porting_peri_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	peri_ss_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:c55bb925e84d6d8face4f6e57c53de84]
