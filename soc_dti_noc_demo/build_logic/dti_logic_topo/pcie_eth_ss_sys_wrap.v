//[UHDL]Content Start [md5:3da55bed3afe9dbaae6d85bd8a5d30c1]
module pcie_eth_ss_sys_wrap (
	input          clk_sys_clk                                                   ,
	...
	output         pcie_eth_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         pcie_eth_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	pcie_eth_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(pcie_eth_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(pcie_eth_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:3da55bed3afe9dbaae6d85bd8a5d30c1]
