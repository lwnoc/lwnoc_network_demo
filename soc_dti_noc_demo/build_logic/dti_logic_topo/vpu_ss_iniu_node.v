//[UHDL]Content Start [md5:7c3e326c6dc839ffab7526dcc5e7a5c6]
module vpu_ss_iniu_node (
	...
	output        vpu_ss_sys_wrap_vpu_ss_sys_side_rsp_afifo_sb_err_porting_vpu_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        vpu_ss_sys_wrap_vpu_ss_sys_side_rsp_afifo_db_err_porting_vpu_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	vpu_ss_sys_wrap sys_wrap (
		...
		.vpu_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(vpu_ss_sys_wrap_vpu_ss_sys_side_rsp_afifo_sb_err_porting_vpu_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.vpu_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(vpu_ss_sys_wrap_vpu_ss_sys_side_rsp_afifo_db_err_porting_vpu_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	vpu_ss_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:7c3e326c6dc839ffab7526dcc5e7a5c6]
