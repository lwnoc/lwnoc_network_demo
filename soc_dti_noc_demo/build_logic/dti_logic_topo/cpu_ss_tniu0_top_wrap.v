//[UHDL]Content Start [md5:3416c3ae2eaf6ab7d86d0d3ae1841418]
module cpu_ss_tniu0_top_wrap (
	input          clk_noc                                                        ,
	input          rst_noc_n                                                      ,
	...
	output         cpu_ss_tniu0_top_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         cpu_ss_tniu0_top_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	dti_tniu_top_dti_tniu_async_top_side top_side (
		...
		.rsp_afifo_sb_err(cpu_ss_tniu0_top_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(cpu_ss_tniu0_top_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
		.lp_hub_rx_req(lp_top_rx_lp_hub_rx_req),
		.lp_hub_tx_req(lp_top_tx_lp_hub_tx_req));

endmodule
//[UHDL]Content End [md5:3416c3ae2eaf6ab7d86d0d3ae1841418]
