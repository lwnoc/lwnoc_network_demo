//[UHDL]Content Start [md5:f49a2ec1283808751a8eaa7d42b86603]
module cpu_ss_tniu1_node (
	...
	output        cpu_ss_tniu1_sys_wrap_cpu_ss_tniu1_sys_side_req_afifo_sb_err_porting_cpu_ss_tniu1_sys_side_req_afifo_sb_err_porting_req_afifo_sb_err,
	output        cpu_ss_tniu1_sys_wrap_cpu_ss_tniu1_sys_side_req_afifo_db_err_porting_cpu_ss_tniu1_sys_side_req_afifo_db_err_porting_req_afifo_db_err,
	...
	//module inst.
	cpu_ss_tniu1_sys_wrap sys_wrap (
		...
		.cpu_ss_tniu1_sys_side_req_afifo_sb_err_porting_req_afifo_sb_err(cpu_ss_tniu1_sys_wrap_cpu_ss_tniu1_sys_side_req_afifo_sb_err_porting_cpu_ss_tniu1_sys_side_req_afifo_sb_err_porting_req_afifo_sb_err),
		.cpu_ss_tniu1_sys_side_req_afifo_db_err_porting_req_afifo_db_err(cpu_ss_tniu1_sys_wrap_cpu_ss_tniu1_sys_side_req_afifo_db_err_porting_cpu_ss_tniu1_sys_side_req_afifo_db_err_porting_req_afifo_db_err));
	cpu_ss_tniu1_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(top_wrap_TO_sys_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(sys_wrap_TO_top_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:f49a2ec1283808751a8eaa7d42b86603]
