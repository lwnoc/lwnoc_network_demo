//[UHDL]Content Start [md5:8052b6d1777fd3eabeb5dc8e1a6a5dcb]
module dspss0_sys_wrap (
	input          clk_sys_clk                                              ,
	...
	output         dspss0_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         dspss0_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	dsp_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(dspss0_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(dspss0_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:8052b6d1777fd3eabeb5dc8e1a6a5dcb]
