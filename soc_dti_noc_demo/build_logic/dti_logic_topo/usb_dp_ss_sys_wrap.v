//[UHDL]Content Start [md5:ad54179d54fd177b169eed4cc5aaace8]
module usb_dp_ss_sys_wrap (
	input          clk_sys_clk                                                 ,
	...
	output         usb_dp_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output         usb_dp_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err);
	...
	//module inst.
	usb_dp_dti_pr_iniu_async_sys_side sys_side (
		.clk(clk_sys_clk),
		...
		.rsp_afifo_sb_err(usb_dp_ss_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.rsp_afifo_db_err(usb_dp_ss_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err),
...
//[UHDL]Content End [md5:ad54179d54fd177b169eed4cc5aaace8]
