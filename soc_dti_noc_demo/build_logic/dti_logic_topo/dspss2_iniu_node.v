//[UHDL]Content Start [md5:c0ec46dc1b8cfa03594c18a5e4f12b3d]
module dspss2_iniu_node (
	...
	output        dspss2_sys_wrap_dspss2_sys_side_rsp_afifo_sb_err_porting_dspss2_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        dspss2_sys_wrap_dspss2_sys_side_rsp_afifo_db_err_porting_dspss2_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	dspss2_sys_wrap sys_wrap (
		...
		.dspss2_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(dspss2_sys_wrap_dspss2_sys_side_rsp_afifo_sb_err_porting_dspss2_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.dspss2_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(dspss2_sys_wrap_dspss2_sys_side_rsp_afifo_db_err_porting_dspss2_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	dspss2_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:c0ec46dc1b8cfa03594c18a5e4f12b3d]
