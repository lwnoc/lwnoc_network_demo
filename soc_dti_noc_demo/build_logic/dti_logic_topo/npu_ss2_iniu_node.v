//[UHDL]Content Start [md5:ebd0a47cd0a3f2adac62519a69a4d93d]
module npu_ss2_iniu_node (
	...
	output        npu_ss2_sys_wrap_npu_ss2_sys_side_rsp_afifo_sb_err_porting_npu_ss2_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err,
	output        npu_ss2_sys_wrap_npu_ss2_sys_side_rsp_afifo_db_err_porting_npu_ss2_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err,
	...
	npu_ss2_sys_wrap sys_wrap (
		...
		.npu_ss2_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err(npu_ss2_sys_wrap_npu_ss2_sys_side_rsp_afifo_sb_err_porting_npu_ss2_sys_side_rsp_afifo_sb_err_porting_rsp_afifo_sb_err),
		.npu_ss2_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err(npu_ss2_sys_wrap_npu_ss2_sys_side_rsp_afifo_db_err_porting_npu_ss2_sys_side_rsp_afifo_db_err_porting_rsp_afifo_db_err));
	npu_ss2_top_wrap top_wrap (
		.clk_noc(clk_noc),
		.rst_noc_n(rst_noc_n),
		.async_fifo_req_pld_sync(sys_wrap_TO_top_wrap_SIG_async_fifo_req_pld_sync),
		.async_fifo_req_rptr_async(top_wrap_TO_sys_wrap_SIG_async_fifo_req_rptr_async),
...
//[UHDL]Content End [md5:ebd0a47cd0a3f2adac62519a69a4d93d]
