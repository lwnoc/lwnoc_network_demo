module cpu_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import cpu_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `cpu_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `cpu_TRANSACTION_MAX_NUM,
