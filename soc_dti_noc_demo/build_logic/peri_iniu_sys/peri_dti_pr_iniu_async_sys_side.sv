module peri_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import peri_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `peri_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `peri_TRANSACTION_MAX_NUM,
        parameter integer unsigned  ASYNC_FIFO_DEPTH    = `peri_INIU_ASYNC_FIFO_DEPTH,
        parameter integer unsigned  TIME_OUT_WIDTH      = `peri_INIU_TIME_OUT_WIDTH,
        ...
        parameter integer unsigned  ERR_INT_CNT_WIDTH   = `peri_INIU_ERR_INT_CNT_WIDTH,
