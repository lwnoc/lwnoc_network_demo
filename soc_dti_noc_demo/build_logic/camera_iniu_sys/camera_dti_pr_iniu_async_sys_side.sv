module camera_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import camera_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `camera_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `camera_TRANSACTION_MAX_NUM,
        parameter integer unsigned  ASYNC_FIFO_DEPTH    = `camera_INIU_ASYNC_FIFO_DEPTH,
        parameter integer unsigned  TIME_OUT_WIDTH      = `camera_INIU_TIME_OUT_WIDTH,
        ...
        parameter integer unsigned  ERR_INT_CNT_WIDTH   = `camera_INIU_ERR_INT_CNT_WIDTH,
