module cpu_tniu_dti_tniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import cpu_tniu_dti_tniu_pack::*;
#(
    parameter integer unsigned ASYNC_FIFO_DEPTH  = `cpu_tniu_TNIU_ASYNC_FIFO_DEPTH,
    parameter integer unsigned  ERR_INT_CNT_WIDTH   = `cpu_tniu_TNIU_ERR_INT_CNT_WIDTH,
    ...
    // FUSA ECC error outputs (REQ AFIFO mst-side decode, clk_sys domain)
    ...
    // CONV
    //=================================================
    cpu_tniu_gnpd_to_dti_conv u_gnpd_to_dti_conv (
    .req_valid             (req_valid     ),
    .req_ready             (req_ready     ),
