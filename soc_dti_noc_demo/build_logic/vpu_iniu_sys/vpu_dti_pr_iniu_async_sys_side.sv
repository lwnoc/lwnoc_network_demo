module vpu_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import vpu_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `vpu_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `vpu_TRANSACTION_MAX_NUM,
        parameter integer unsigned  ASYNC_FIFO_DEPTH    = `vpu_INIU_ASYNC_FIFO_DEPTH,
        parameter integer unsigned  TIME_OUT_WIDTH      = `vpu_INIU_TIME_OUT_WIDTH,
