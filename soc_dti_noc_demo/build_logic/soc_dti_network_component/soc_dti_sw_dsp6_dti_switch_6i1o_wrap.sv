module soc_dti_sw_dsp6_dti_switch_6i1o_wrap #(
    ...
    parameter int unsigned DTI_INIU2_MIN = 0,
    parameter int unsigned DTI_INIU2_MAX = 0,
    parameter int unsigned DTI_INIU3_MIN = 0,
    parameter int unsigned DTI_INIU3_MAX = 0,
    parameter int unsigned DTI_INIU4_MIN = 0,
    parameter int unsigned DTI_INIU4_MAX = 0,
    parameter int unsigned DTI_INIU5_MIN = 0,
    parameter int unsigned DTI_INIU5_MAX = 0,
    ...
    input   logic           iniu4_req_valid,
    output  logic           iniu4_req_ready,
    input   logic [89:0]    iniu4_req_payload,
    input   logic [5:0]     iniu4_req_srcid,
    input   logic [5:0]     iniu4_req_tgtid,
    input   logic           iniu4_req_qos,
    input   logic           iniu4_req_last,
    output  logic           iniu4_req_threshold,
    output  logic           iniu4_rsp_valid,
    input   logic           iniu4_rsp_ready,
    output  logic [89:0]    iniu4_rsp_payload,
    output  logic [5:0]     iniu4_rsp_srcid,
    output  logic [5:0]     iniu4_rsp_tgtid,
    output  logic           iniu4_rsp_qos,
    output  logic           iniu4_rsp_last,
    input   logic           iniu4_rsp_threshold,

    input   logic           iniu5_req_valid,
    output  logic           iniu5_req_ready,
    input   logic [89:0]    iniu5_req_payload,
    input   logic [5:0]     iniu5_req_srcid,
    input   logic [5:0]     iniu5_req_tgtid,
    input   logic           iniu5_req_qos,
    input   logic           iniu5_req_last,
    output  logic           iniu5_req_threshold,
    output  logic           iniu5_rsp_valid,
    input   logic           iniu5_rsp_ready,
    output  logic [89:0]    iniu5_rsp_payload,
    output  logic [5:0]     iniu5_rsp_srcid,
    output  logic [5:0]     iniu5_rsp_tgtid,
    output  logic           iniu5_rsp_qos,
    output  logic           iniu5_rsp_last,
    input   logic           iniu5_rsp_threshold,
    ...
    logic [5:0]        iniu_req_valid_bus;
    logic [5:0]        iniu_req_ready_bus;
    logic [5:0][89:0]  iniu_req_payload_bus;
    logic [5:0][5:0]   iniu_req_srcid_bus;
    logic [5:0][5:0]   iniu_req_tgtid_bus;
    logic [5:0]        iniu_req_qos_bus;
    logic [5:0]        iniu_req_last_bus;
    logic [5:0]        iniu_req_threshold_bus;
    logic [5:0]        iniu_rsp_valid_bus;
    logic [5:0][89:0]  iniu_rsp_payload_bus;
    logic [5:0][5:0]   iniu_rsp_srcid_bus;
    logic [5:0][5:0]   iniu_rsp_tgtid_bus;
    logic [5:0]        iniu_rsp_qos_bus;
    logic [5:0]        iniu_rsp_last_bus;
    logic [5:0]        iniu_rsp_threshold_bus;
    ...
    assign iniu_req_valid_bus = {iniu5_req_valid, iniu4_req_valid, iniu3_req_valid, iniu2_req_valid, iniu1_req_valid, iniu0_req_valid};
    assign iniu_req_payload_bus[0] = iniu0_req_payload;
    assign iniu_req_payload_bus[1] = iniu1_req_payload;
    assign iniu_req_payload_bus[2] = iniu2_req_payload;
    assign iniu_req_payload_bus[3] = iniu3_req_payload;
    assign iniu_req_payload_bus[4] = iniu4_req_payload;
    assign iniu_req_payload_bus[5] = iniu5_req_payload;
    ...
    assign iniu_req_srcid_bus[4] = iniu4_req_srcid;
    assign iniu_req_srcid_bus[5] = iniu5_req_srcid;
    ...
    assign iniu_req_tgtid_bus[4] = iniu4_req_tgtid;
    assign iniu_req_tgtid_bus[5] = iniu5_req_tgtid;
    assign iniu_req_qos_bus = {iniu5_req_qos, iniu4_req_qos, iniu3_req_qos, iniu2_req_qos, iniu1_req_qos, iniu0_req_qos};
    assign iniu_req_last_bus = {iniu5_req_last, iniu4_req_last, iniu3_req_last, iniu2_req_last, iniu1_req_last, iniu0_req_last};
    assign {iniu5_req_ready, iniu4_req_ready, iniu3_req_ready, iniu2_req_ready, iniu1_req_ready, iniu0_req_ready} = iniu_req_ready_bus;
    assign {iniu5_req_threshold, iniu4_req_threshold, iniu3_req_threshold, iniu2_req_threshold, iniu1_req_threshold, iniu0_req_threshold} = iniu_req_threshold_bus;

    assign iniu0_rsp_valid = iniu_rsp_valid_bus[0];
    assign iniu1_rsp_valid = iniu_rsp_valid_bus[1];
    assign iniu2_rsp_valid = iniu_rsp_valid_bus[2];
    assign iniu3_rsp_valid = iniu_rsp_valid_bus[3];
    assign iniu4_rsp_valid = iniu_rsp_valid_bus[4];
    assign iniu5_rsp_valid = iniu_rsp_valid_bus[5];
    assign iniu0_rsp_payload = iniu_rsp_payload_bus[0];
    assign iniu1_rsp_payload = iniu_rsp_payload_bus[1];
    assign iniu2_rsp_payload = iniu_rsp_payload_bus[2];
    assign iniu3_rsp_payload = iniu_rsp_payload_bus[3];
    assign iniu4_rsp_payload = iniu_rsp_payload_bus[4];
    assign iniu5_rsp_payload = iniu_rsp_payload_bus[5];
    ...
    assign iniu4_rsp_srcid = iniu_rsp_srcid_bus[4];
    assign iniu5_rsp_srcid = iniu_rsp_srcid_bus[5];
    ...
    assign iniu4_rsp_tgtid = iniu_rsp_tgtid_bus[4];
    assign iniu5_rsp_tgtid = iniu_rsp_tgtid_bus[5];
    ...
    assign iniu4_rsp_qos = iniu_rsp_qos_bus[4];
    assign iniu5_rsp_qos = iniu_rsp_qos_bus[5];
    ...
    assign iniu4_rsp_last = iniu_rsp_last_bus[4];
    assign iniu5_rsp_last = iniu_rsp_last_bus[5];
    assign iniu_rsp_threshold_bus = {iniu5_rsp_threshold, iniu4_rsp_threshold, iniu3_rsp_threshold, iniu2_rsp_threshold, iniu1_rsp_threshold, iniu0_rsp_threshold};
    ...
    soc_dti_sw_dsp6_dti_noc_switch #(
        .NUM_INIU      (6),
        .NUM_TNIU      (1),
        .TID_WIDTH     (6),
        .PAYLOAD_WIDTH (90),
        ...
        .INIU_DECMIN   ({DTI_INIU5_MIN, DTI_INIU4_MIN, DTI_INIU3_MIN, DTI_INIU2_MIN, DTI_INIU1_MIN, DTI_INIU0_MIN}),
        .INIU_DECMAX   ({DTI_INIU5_MAX, DTI_INIU4_MAX, DTI_INIU3_MAX, DTI_INIU2_MAX, DTI_INIU1_MAX, DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
