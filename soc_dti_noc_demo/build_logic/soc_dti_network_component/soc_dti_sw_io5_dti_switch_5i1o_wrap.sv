module soc_dti_sw_io5_dti_switch_5i1o_wrap #(
    ...
    logic [4:0]        iniu_req_valid_bus;
    logic [4:0]        iniu_req_ready_bus;
    logic [4:0][89:0]  iniu_req_payload_bus;
    logic [4:0][5:0]   iniu_req_srcid_bus;
    logic [4:0][5:0]   iniu_req_tgtid_bus;
    logic [4:0]        iniu_req_qos_bus;
    logic [4:0]        iniu_req_last_bus;
    logic [4:0]        iniu_req_threshold_bus;
    logic [4:0]        iniu_rsp_valid_bus;
    logic [4:0][89:0]  iniu_rsp_payload_bus;
    logic [4:0][5:0]   iniu_rsp_srcid_bus;
    logic [4:0][5:0]   iniu_rsp_tgtid_bus;
    logic [4:0]        iniu_rsp_qos_bus;
    logic [4:0]        iniu_rsp_last_bus;
    logic [4:0]        iniu_rsp_threshold_bus;
    ...
    assign iniu_req_valid_bus = {iniu4_req_valid, iniu3_req_valid, iniu2_req_valid, iniu1_req_valid, iniu0_req_valid};
    ...
    assign iniu_req_qos_bus = {iniu4_req_qos, iniu3_req_qos, iniu2_req_qos, iniu1_req_qos, iniu0_req_qos};
    assign iniu_req_last_bus = {iniu4_req_last, iniu3_req_last, iniu2_req_last, iniu1_req_last, iniu0_req_last};
    assign {iniu4_req_ready, iniu3_req_ready, iniu2_req_ready, iniu1_req_ready, iniu0_req_ready} = iniu_req_ready_bus;
    assign {iniu4_req_threshold, iniu3_req_threshold, iniu2_req_threshold, iniu1_req_threshold, iniu0_req_threshold} = iniu_req_threshold_bus;
    ...
    assign iniu_rsp_threshold_bus = {iniu4_rsp_threshold, iniu3_rsp_threshold, iniu2_rsp_threshold, iniu1_rsp_threshold, iniu0_rsp_threshold};
    ...
    soc_dti_sw_io5_dti_noc_switch #(
        ...
        .INIU_DECMIN   ({DTI_INIU4_MIN, DTI_INIU3_MIN, DTI_INIU2_MIN, DTI_INIU1_MIN, DTI_INIU0_MIN}),
        .INIU_DECMAX   ({DTI_INIU4_MAX, DTI_INIU3_MAX, DTI_INIU2_MAX, DTI_INIU1_MAX, DTI_INIU0_MAX})
    ) u_dti_noc_switch (
        .clk                (clk),
        .rst_n              (rst_n),
        ...
        .iniu_rsp_ready     ({iniu4_rsp_ready, iniu3_rsp_ready, iniu2_rsp_ready, iniu1_rsp_ready, iniu0_rsp_ready}),
