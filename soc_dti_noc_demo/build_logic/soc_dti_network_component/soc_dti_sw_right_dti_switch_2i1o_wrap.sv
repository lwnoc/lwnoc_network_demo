module soc_dti_sw_right_dti_switch_2i1o_wrap #(
    ...
    logic [1:0][5:0]   iniu_req_tgtid_bus;
    logic [1:0]        iniu_req_qos_bus;
    logic [1:0]        iniu_req_last_bus;
    logic [1:0]        iniu_req_threshold_bus;
    logic [1:0]        iniu_rsp_valid_bus;
    logic [1:0][89:0]  iniu_rsp_payload_bus;
    logic [1:0][5:0]   iniu_rsp_srcid_bus;
    logic [1:0][5:0]   iniu_rsp_tgtid_bus;
    logic [1:0]        iniu_rsp_qos_bus;
    logic [1:0]        iniu_rsp_last_bus;
    logic [1:0]        iniu_rsp_threshold_bus;
    ...
    assign iniu_req_qos_bus = {iniu1_req_qos, iniu0_req_qos};
    assign iniu_req_last_bus = {iniu1_req_last, iniu0_req_last};
    assign {iniu1_req_ready, iniu0_req_ready} = iniu_req_ready_bus;
    assign {iniu1_req_threshold, iniu0_req_threshold} = iniu_req_threshold_bus;
    ...
    assign iniu_rsp_threshold_bus = {iniu1_rsp_threshold, iniu0_rsp_threshold};
    ...
    soc_dti_sw_right_dti_noc_switch #(
        .NUM_INIU      (2),
        .NUM_TNIU      (1),
        .TID_WIDTH     (6),
        .PAYLOAD_WIDTH (90),
