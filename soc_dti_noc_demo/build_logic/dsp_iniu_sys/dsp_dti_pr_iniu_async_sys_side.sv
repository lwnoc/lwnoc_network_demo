module dsp_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import dsp_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `dsp_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `dsp_TRANSACTION_MAX_NUM,
        parameter integer unsigned  ASYNC_FIFO_DEPTH    = `dsp_INIU_ASYNC_FIFO_DEPTH,
        parameter integer unsigned  TIME_OUT_WIDTH      = `dsp_INIU_TIME_OUT_WIDTH,
        ...
        parameter integer unsigned  ERR_INT_CNT_WIDTH   = `dsp_INIU_ERR_INT_CNT_WIDTH,
