...
module dti_sw4_dti_noc_switch #(
    parameter int unsigned NUM_INIU      = `dti_sw4_DTI_NOC_SWITCH_NUM_INIU      ,
    parameter int unsigned NUM_TNIU      = `dti_sw4_DTI_NOC_SWITCH_NUM_TNIU      ,
    parameter int unsigned TID_WIDTH     = `dti_sw4_DTI_NOC_SWITCH_TID_WIDTH     ,
    parameter int unsigned PAYLOAD_WIDTH = `dti_sw4_DTI_NOC_SWITCH_PAYLOAD_WIDTH ,
    ...
    parameter logic [NUM_TNIU*32-1:0] TNIU_DECMIN  = `dti_sw4_DTI_NOC_SWITCH_TNIU_DECMIN ,
    parameter logic [NUM_TNIU*32-1:0] TNIU_DECMAX  = `dti_sw4_DTI_NOC_SWITCH_TNIU_DECMAX ,
    ...
    parameter logic [NUM_INIU*32-1:0] INIU_DECMIN  = `dti_sw4_DTI_NOC_SWITCH_INIU_DECMIN ,
    parameter logic [NUM_INIU*32-1:0] INIU_DECMAX  = `dti_sw4_DTI_NOC_SWITCH_INIU_DECMAX
)(
    input  logic clk                                                ,
    input  logic rst_n                                             ,
