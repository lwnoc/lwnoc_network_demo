// dti_noc_switch_5to1_wrap.sv — 5-to-1 per-INIU DTI switch wrapper.
// Wraps dti_noc_switch #5 with individually-named per-channel ports
// for UHDL Bundle connect compatibility (positional SmartAssign).

module dti_sw5_dti_noc_switch_5to1_wrap #(
    parameter int unsigned TID_WIDTH       = `dti_sw5_DTI_NOC_SWITCH_5TO1_WRAP_TID_WIDTH       ,
    parameter int unsigned PAYLOAD_WIDTH   = `dti_sw5_DTI_NOC_SWITCH_5TO1_WRAP_PAYLOAD_WIDTH   ,
    parameter logic [1*32-1:0] TNIU_DECMIN = `dti_sw5_DTI_NOC_SWITCH_5TO1_WRAP_TNIU_DECMIN     ,
    parameter logic [1*32-1:0] TNIU_DECMAX = `dti_sw5_DTI_NOC_SWITCH_5TO1_WRAP_TNIU_DECMAX     ,
    parameter logic [5*32-1:0] INIU_DECMIN = `dti_sw5_DTI_NOC_SWITCH_5TO1_WRAP_INIU_DECMIN     ,
    parameter logic [5*32-1:0] INIU_DECMAX = `dti_sw5_DTI_NOC_SWITCH_5TO1_WRAP_INIU_DECMAX
)(
    input  logic clk                                          ,
    input  logic rst_n                                        ,
    ...
    dti_sw5_dti_noc_switch #(
        ...
        .iniu_req_valid  ({iniu4_req_valid, iniu3_req_valid, iniu2_req_valid, iniu1_req_valid, iniu0_req_valid})              ,
        .iniu_req_payload  ({iniu4_req_payload, iniu3_req_payload, iniu2_req_payload, iniu1_req_payload, iniu0_req_payload})              ,
        .iniu_req_last  ({iniu4_req_last, iniu3_req_last, iniu2_req_last, iniu1_req_last, iniu0_req_last})              ,
        .iniu_req_srcid  ({iniu4_req_srcid, iniu3_req_srcid, iniu2_req_srcid, iniu1_req_srcid, iniu0_req_srcid})              ,
        .iniu_req_tgtid  ({iniu4_req_tgtid, iniu3_req_tgtid, iniu2_req_tgtid, iniu1_req_tgtid, iniu0_req_tgtid})              ,
        .iniu_req_qos  ({iniu4_req_qos, iniu3_req_qos, iniu2_req_qos, iniu1_req_qos, iniu0_req_qos})              ,
        .iniu_req_threshold  ({iniu4_req_threshold, iniu3_req_threshold, iniu2_req_threshold, iniu1_req_threshold, iniu0_req_threshold})              ,
        .iniu_req_ready  ({iniu4_req_ready, iniu3_req_ready, iniu2_req_ready, iniu1_req_ready, iniu0_req_ready})              ,

        .iniu_rsp_valid  ({iniu4_rsp_valid, iniu3_rsp_valid, iniu2_rsp_valid, iniu1_rsp_valid, iniu0_rsp_valid})              ,
        .iniu_rsp_payload  ({iniu4_rsp_payload, iniu3_rsp_payload, iniu2_rsp_payload, iniu1_rsp_payload, iniu0_rsp_payload})              ,
        .iniu_rsp_last  ({iniu4_rsp_last, iniu3_rsp_last, iniu2_rsp_last, iniu1_rsp_last, iniu0_rsp_last})              ,
        .iniu_rsp_srcid  ({iniu4_rsp_srcid, iniu3_rsp_srcid, iniu2_rsp_srcid, iniu1_rsp_srcid, iniu0_rsp_srcid})              ,
        .iniu_rsp_tgtid  ({iniu4_rsp_tgtid, iniu3_rsp_tgtid, iniu2_rsp_tgtid, iniu1_rsp_tgtid, iniu0_rsp_tgtid})              ,
        .iniu_rsp_qos  ({iniu4_rsp_qos, iniu3_rsp_qos, iniu2_rsp_qos, iniu1_rsp_qos, iniu0_rsp_qos})              ,
        .iniu_rsp_threshold  ({iniu4_rsp_threshold, iniu3_rsp_threshold, iniu2_rsp_threshold, iniu1_rsp_threshold, iniu0_rsp_threshold})              ,
