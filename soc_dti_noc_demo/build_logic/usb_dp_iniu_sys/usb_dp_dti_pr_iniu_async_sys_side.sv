module usb_dp_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import usb_dp_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `usb_dp_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `usb_dp_TRANSACTION_MAX_NUM,
        parameter integer unsigned  ASYNC_FIFO_DEPTH    = `usb_dp_INIU_ASYNC_FIFO_DEPTH,
        parameter integer unsigned  TIME_OUT_WIDTH      = `usb_dp_INIU_TIME_OUT_WIDTH,
        ...
        parameter integer unsigned  ERR_INT_CNT_WIDTH   = `usb_dp_INIU_ERR_INT_CNT_WIDTH,
