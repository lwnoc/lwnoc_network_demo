module gpu_dti_pr_iniu_async_sys_side
    import lwnoc_lp_define_package::*;
    import lwnoc_lp_struct_package::*;
    import gpu_dti_iniu_pack::*;
    #(
        parameter integer unsigned TBU_NUM              = `gpu_TBU_NUM,
        parameter integer unsigned TRANSACTION_MAX_NUM  = `gpu_TRANSACTION_MAX_NUM,
        parameter integer unsigned  ASYNC_FIFO_DEPTH    = `gpu_INIU_ASYNC_FIFO_DEPTH,
        parameter integer unsigned  TIME_OUT_WIDTH      = `gpu_INIU_TIME_OUT_WIDTH,
        ...
        parameter integer unsigned  ERR_INT_CNT_WIDTH   = `gpu_INIU_ERR_INT_CNT_WIDTH,
